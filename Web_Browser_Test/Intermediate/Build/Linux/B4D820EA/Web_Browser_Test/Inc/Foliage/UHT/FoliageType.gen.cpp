...
template<> FOLIAGE_API UScriptStruct* StaticStruct<FFoliageDensityFalloff>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Foliage_Public_FoliageType_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFoliageType, UFoliageType::StaticClass, TEXT("UFoliageType"), &Z_Registration_Info_UClass_UFoliageType, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFoliageType), 3238273289U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Foliage_Public_FoliageType_h_2743921457(TEXT("/Script/Foliage"),
