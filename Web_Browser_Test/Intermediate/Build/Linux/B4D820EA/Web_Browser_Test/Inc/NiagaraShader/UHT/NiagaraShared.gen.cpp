...
template<> NIAGARASHADER_API UScriptStruct* StaticStruct<FNiagaraDataInterfaceGPUParamInfo>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraDataInterfaceGPUParamInfo_Statics::NewProp_GeneratedFunctions_Inner = { "GeneratedFunctions", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FNiagaraDataInterfaceGeneratedFunction, METADATA_PARAMS(nullptr, 0) }; // 2971039450
#if WITH_METADATA
...
class UScriptStruct* FNiagaraShaderScriptExternalConstant::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraShaderScriptExternalConstant.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraShaderScriptExternalConstant, Z_Construct_UPackage__Script_NiagaraShader(), TEXT("NiagaraShaderScriptExternalConstant"));
	}
...
class UScriptStruct* FNiagaraShaderScriptParametersMetadata::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraShaderScriptParametersMetadata.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraShaderScriptParametersMetadata, Z_Construct_UPackage__Script_NiagaraShader(), TEXT("NiagaraShaderScriptParametersMetadata"));
	}
...
template<> NIAGARASHADER_API UScriptStruct* StaticStruct<FNiagaraShaderScriptParametersMetadata>()
{
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraShader_Public_NiagaraShared_h_2561647693(TEXT("/Script/NiagaraShader"),
		nullptr, 0,
