...
template<> NIAGARASHADER_API UScriptStruct* StaticStruct<FSimulationStageMetaData>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bOverrideElementCount_MetaData[];
#endif
		static void NewProp_bOverrideElementCount_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bOverrideElementCount;
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FSimulationStageMetaData_Statics::NewProp_IterationSource = { "IterationSource", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FSimulationStageMetaData, IterationSource), METADATA_PARAMS(Z_Construct_UScriptStruct_FSimulationStageMetaData_Statics::NewProp_IterationSource_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSimulationStageMetaData_Statics::NewProp_IterationSource_MetaData)) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSimulationStageMetaData_Statics::NewProp_bOverrideElementCount_MetaData[] = {
		{ "Comment", "/** When enabled the simulation stage uses element count provided by user to dispatch work. */" },
		{ "ModuleRelativePath", "Public/NiagaraScriptBase.h" },
		{ "ToolTip", "When enabled the simulation stage uses element count provided by user to dispatch work." },
	};
#endif
	void Z_Construct_UScriptStruct_FSimulationStageMetaData_Statics::NewProp_bOverrideElementCount_SetBit(void* Obj)
	{
		((FSimulationStageMetaData*)Obj)->bOverrideElementCount = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSimulationStageMetaData_Statics::NewProp_bOverrideElementCount = { "bOverrideElementCount", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(uint8), sizeof(FSimulationStageMetaData), &Z_Construct_UScriptStruct_FSimulationStageMetaData_Statics::NewProp_bOverrideElementCount_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSimulationStageMetaData_Statics::NewProp_bOverrideElementCount_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSimulationStageMetaData_Statics::NewProp_bOverrideElementCount_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FSimulationStageMetaData_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSimulationStageMetaData_Statics::NewProp_bOverrideElementCount,
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraShader_Public_NiagaraScriptBase_h_Statics::ScriptStructInfo[] = {
		{ FSimulationStageMetaData::StaticStruct, Z_Construct_UScriptStruct_FSimulationStageMetaData_Statics::NewStructOps, TEXT("SimulationStageMetaData"), &Z_Registration_Info_UScriptStruct_SimulationStageMetaData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSimulationStageMetaData), 454446494U) },
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraShader_Public_NiagaraScriptBase_h_2340279099(TEXT("/Script/NiagaraShader"),
