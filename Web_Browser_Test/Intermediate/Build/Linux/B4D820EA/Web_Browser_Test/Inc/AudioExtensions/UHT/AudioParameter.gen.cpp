...
template<> AUDIOEXTENSIONS_API UScriptStruct* StaticStruct<FAudioParameter>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioExtensions_Public_AudioParameter_h_Statics::EnumInfo[] = {
		{ EAudioParameterType_StaticEnum, TEXT("EAudioParameterType"), &Z_Registration_Info_UEnum_EAudioParameterType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3458969896U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioExtensions_Public_AudioParameter_h_Statics::ScriptStructInfo[] = {
		{ FAudioParameter::StaticStruct, Z_Construct_UScriptStruct_FAudioParameter_Statics::NewStructOps, TEXT("AudioParameter"), &Z_Registration_Info_UScriptStruct_AudioParameter, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAudioParameter), 2799444918U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioExtensions_Public_AudioParameter_h_3253261951(TEXT("/Script/AudioExtensions"),
		nullptr, 0,
