...
class UScriptStruct* FMediaSourceCacheSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MediaSourceCacheSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMediaSourceCacheSettings, Z_Construct_UPackage__Script_MediaAssets(), TEXT("MediaSourceCacheSettings"));
	}
...
template<> MEDIAASSETS_API UScriptStruct* StaticStruct<FMediaSourceCacheSettings>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MediaAssets_Public_MediaSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMediaSource, UMediaSource::StaticClass, TEXT("UMediaSource"), &Z_Registration_Info_UClass_UMediaSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMediaSource), 1761694803U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MediaAssets_Public_MediaSource_h_2524187014(TEXT("/Script/MediaAssets"),
