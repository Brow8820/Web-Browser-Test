...
template<> CUSTOMMESHCOMPONENT_API UScriptStruct* StaticStruct<FCustomMeshTriangle>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CustomMeshComponent_Source_CustomMeshComponent_Classes_CustomMeshComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCustomMeshComponent, UCustomMeshComponent::StaticClass, TEXT("UCustomMeshComponent"), &Z_Registration_Info_UClass_UCustomMeshComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCustomMeshComponent), 3404068458U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CustomMeshComponent_Source_CustomMeshComponent_Classes_CustomMeshComponent_h_1127046019(TEXT("/Script/CustomMeshComponent"),
