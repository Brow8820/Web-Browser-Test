...
class UScriptStruct* FManagedArrayCollection::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ManagedArrayCollection.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FManagedArrayCollection, Z_Construct_UPackage__Script_Chaos(), TEXT("ManagedArrayCollection"));
	}
