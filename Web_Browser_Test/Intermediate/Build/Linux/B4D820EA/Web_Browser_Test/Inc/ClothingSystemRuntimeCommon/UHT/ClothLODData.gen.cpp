...
template<> CLOTHINGSYSTEMRUNTIMECOMMON_API UScriptStruct* StaticStruct<FClothLODDataCommon>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_ClothingSystemRuntimeCommon_Public_ClothLODData_h_Statics::ScriptStructInfo[] = {
		{ FClothLODDataCommon::StaticStruct, Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewStructOps, TEXT("ClothLODDataCommon"), &Z_Registration_Info_UScriptStruct_ClothLODDataCommon, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FClothLODDataCommon), 826651398U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_ClothingSystemRuntimeCommon_Public_ClothLODData_h_3978548584(TEXT("/Script/ClothingSystemRuntimeCommon"),
		nullptr, 0,
