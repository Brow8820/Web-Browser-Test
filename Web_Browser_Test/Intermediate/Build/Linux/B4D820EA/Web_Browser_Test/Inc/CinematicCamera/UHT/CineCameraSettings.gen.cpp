...
class UScriptStruct* FPlateCropSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PlateCropSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPlateCropSettings, Z_Construct_UPackage__Script_CinematicCamera(), TEXT("PlateCropSettings"));
	}
...
class UScriptStruct* FNamedPlateCropPreset::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NamedPlateCropPreset.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNamedPlateCropPreset, Z_Construct_UPackage__Script_CinematicCamera(), TEXT("NamedPlateCropPreset"));
	}
