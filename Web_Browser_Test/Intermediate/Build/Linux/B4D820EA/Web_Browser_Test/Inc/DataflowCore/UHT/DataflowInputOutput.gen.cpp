...
#include "Core/Public/Dataflow/DataflowInputOutput.h"
...
class UScriptStruct* FDataflowInput::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DataflowInput.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDataflowInput, Z_Construct_UPackage__Script_DataflowCore(), TEXT("DataflowInput"));
	}
...
class UScriptStruct* FDataflowOutput::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DataflowOutput.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDataflowOutput, Z_Construct_UPackage__Script_DataflowCore(), TEXT("DataflowOutput"));
	}
