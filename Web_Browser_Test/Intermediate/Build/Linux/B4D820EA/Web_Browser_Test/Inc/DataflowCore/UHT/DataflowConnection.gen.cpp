...
#include "Core/Public/Dataflow/DataflowConnection.h"
...
class UScriptStruct* FDataflowConnection::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DataflowConnection.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDataflowConnection, Z_Construct_UPackage__Script_DataflowCore(), TEXT("DataflowConnection"));
	}
