...
template<> AIMODULE_API UScriptStruct* StaticStruct<FBlackboardEntry>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_BlackboardData_h_Statics::ScriptStructInfo[] = {
		{ FBlackboardEntry::StaticStruct, Z_Construct_UScriptStruct_FBlackboardEntry_Statics::NewStructOps, TEXT("BlackboardEntry"), &Z_Registration_Info_UScriptStruct_BlackboardEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBlackboardEntry), 2778211744U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_BlackboardData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBlackboardData, UBlackboardData::StaticClass, TEXT("UBlackboardData"), &Z_Registration_Info_UClass_UBlackboardData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBlackboardData), 1453465377U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_BlackboardData_h_898377372(TEXT("/Script/AIModule"),
