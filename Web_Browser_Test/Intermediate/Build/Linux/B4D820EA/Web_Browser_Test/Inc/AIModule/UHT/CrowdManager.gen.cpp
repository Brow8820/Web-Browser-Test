...
template<> AIMODULE_API UScriptStruct* StaticStruct<FCrowdAvoidanceSamplingPattern>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Navigation_CrowdManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCrowdManager, UCrowdManager::StaticClass, TEXT("UCrowdManager"), &Z_Registration_Info_UClass_UCrowdManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCrowdManager), 2092195209U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Navigation_CrowdManager_h_2677665764(TEXT("/Script/AIModule"),
