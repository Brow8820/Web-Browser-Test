...
template<> AIMODULE_API UScriptStruct* StaticStruct<FBlackboardKeySelector>()
{
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FBlackboardKeySelector_Statics::NewProp_SelectedKeyID = { "SelectedKeyID", nullptr, (EPropertyFlags)0x0020080000002805, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FBlackboardKeySelector, SelectedKeyID), nullptr, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlackboardKeySelector_Statics::NewProp_SelectedKeyID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlackboardKeySelector_Statics::NewProp_SelectedKeyID_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_BehaviorTreeTypes_h_Statics::ScriptStructInfo[] = {
		{ FBlackboardKeySelector::StaticStruct, Z_Construct_UScriptStruct_FBlackboardKeySelector_Statics::NewStructOps, TEXT("BlackboardKeySelector"), &Z_Registration_Info_UScriptStruct_BlackboardKeySelector, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBlackboardKeySelector), 3025891527U) },
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_BehaviorTreeTypes_h_1343141075(TEXT("/Script/AIModule"),
