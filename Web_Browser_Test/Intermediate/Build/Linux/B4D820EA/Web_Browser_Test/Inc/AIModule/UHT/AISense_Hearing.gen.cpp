...
template<> AIMODULE_API UScriptStruct* StaticStruct<FAINoiseEvent>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AISense_Hearing_h_Statics::ScriptStructInfo[] = {
		{ FAINoiseEvent::StaticStruct, Z_Construct_UScriptStruct_FAINoiseEvent_Statics::NewStructOps, TEXT("AINoiseEvent"), &Z_Registration_Info_UScriptStruct_AINoiseEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAINoiseEvent), 478081909U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AISense_Hearing_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAISense_Hearing, UAISense_Hearing::StaticClass, TEXT("UAISense_Hearing"), &Z_Registration_Info_UClass_UAISense_Hearing, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAISense_Hearing), 814166637U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AISense_Hearing_h_379906012(TEXT("/Script/AIModule"),
