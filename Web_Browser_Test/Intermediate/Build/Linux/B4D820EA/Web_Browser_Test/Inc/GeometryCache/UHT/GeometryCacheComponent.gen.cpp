...
template<> GEOMETRYCACHE_API UScriptStruct* StaticStruct<FTrackRenderData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCache_Classes_GeometryCacheComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGeometryCacheComponent, UGeometryCacheComponent::StaticClass, TEXT("UGeometryCacheComponent"), &Z_Registration_Info_UClass_UGeometryCacheComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGeometryCacheComponent), 204144791U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCache_Classes_GeometryCacheComponent_h_1707798360(TEXT("/Script/GeometryCache"),
