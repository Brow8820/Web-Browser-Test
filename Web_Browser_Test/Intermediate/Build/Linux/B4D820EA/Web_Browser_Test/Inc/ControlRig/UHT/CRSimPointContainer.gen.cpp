...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FCRSimPointContainer>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Points_Inner = { "Points", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FCRSimPoint, METADATA_PARAMS(nullptr, 0) }; // 1775132219
#if WITH_METADATA
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_PreviousStep_Inner = { "PreviousStep", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FCRSimPoint, METADATA_PARAMS(nullptr, 0) }; // 1775132219
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Math_Simulation_CRSimPointContainer_h_Statics::ScriptStructInfo[] = {
		{ FCRSimPointContainer::StaticStruct, Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewStructOps, TEXT("CRSimPointContainer"), &Z_Registration_Info_UScriptStruct_CRSimPointContainer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCRSimPointContainer), 536530120U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Math_Simulation_CRSimPointContainer_h_2280543823(TEXT("/Script/ControlRig"),
		nullptr, 0,
