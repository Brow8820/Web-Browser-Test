...
class UScriptStruct* FRigUnit_ModifyTransforms::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_ModifyTransforms.OuterSingleton)
	{
		...
		Arguments_FRigUnit_ModifyTransforms_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_ModifyTransforms_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
