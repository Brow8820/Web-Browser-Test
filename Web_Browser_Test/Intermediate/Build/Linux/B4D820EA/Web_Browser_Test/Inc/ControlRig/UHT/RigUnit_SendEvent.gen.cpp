...
class UScriptStruct* FRigUnit_SendEvent::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SendEvent.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SendEvent_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SendEvent_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
