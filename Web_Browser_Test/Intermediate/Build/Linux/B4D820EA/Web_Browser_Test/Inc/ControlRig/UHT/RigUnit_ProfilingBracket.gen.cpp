...
class UScriptStruct* FRigUnit_StartProfilingTimer::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_StartProfilingTimer.OuterSingleton)
	{
		...
		Arguments_FRigUnit_StartProfilingTimer_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_StartProfilingTimer_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_EndProfilingTimer::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_EndProfilingTimer.OuterSingleton)
	{
		...
		Arguments_FRigUnit_EndProfilingTimer_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_EndProfilingTimer_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_EndProfilingTimer::Execute(const FRigUnitContext & Context)
{
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Debug_RigUnit_ProfilingBracket_h_1906442971(TEXT("/Script/ControlRig"),
		nullptr, 0,
