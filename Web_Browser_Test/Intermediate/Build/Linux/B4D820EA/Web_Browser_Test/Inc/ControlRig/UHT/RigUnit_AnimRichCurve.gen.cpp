...
class UScriptStruct* FRigUnit_AnimRichCurve::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_AnimRichCurve.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_AnimRichCurve_Execute;
		Arguments_FRigUnit_AnimRichCurve_Execute.Emplace(TEXT("Curve"), TEXT("FRuntimeFloatCurve"));
		Arguments_FRigUnit_AnimRichCurve_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_AnimRichCurve::Execute"), &FRigUnit_AnimRichCurve::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_AnimRichCurve.OuterSingleton, Arguments_FRigUnit_AnimRichCurve_Execute);
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_AnimRichCurve_Statics::NewProp_Curve = { "Curve", nullptr, (EPropertyFlags)0x0010000000020005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_AnimRichCurve, Curve), Z_Construct_UScriptStruct_FRuntimeFloatCurve, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_AnimRichCurve_Statics::NewProp_Curve_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_AnimRichCurve_Statics::NewProp_Curve_MetaData)) }; // 1477693291
...
void FRigUnit_AnimRichCurve::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Animation_RigUnit_AnimRichCurve_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_AnimRichCurve::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_AnimRichCurve_Statics::NewStructOps, TEXT("RigUnit_AnimRichCurve"), &Z_Registration_Info_UScriptStruct_RigUnit_AnimRichCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_AnimRichCurve), 110294178U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Animation_RigUnit_AnimRichCurve_h_2455052131(TEXT("/Script/ControlRig"),
		nullptr, 0,
