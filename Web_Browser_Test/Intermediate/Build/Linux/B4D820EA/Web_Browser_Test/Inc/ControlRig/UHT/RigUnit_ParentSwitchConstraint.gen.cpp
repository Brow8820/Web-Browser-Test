...
class UScriptStruct* FRigUnit_ParentSwitchConstraint::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_ParentSwitchConstraint.OuterSingleton)
	{
		...
		Arguments_FRigUnit_ParentSwitchConstraint_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_ParentSwitchConstraint_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_ParentSwitchConstraintArray::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_ParentSwitchConstraintArray.OuterSingleton)
	{
		...
		Arguments_FRigUnit_ParentSwitchConstraintArray_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_ParentSwitchConstraintArray_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
