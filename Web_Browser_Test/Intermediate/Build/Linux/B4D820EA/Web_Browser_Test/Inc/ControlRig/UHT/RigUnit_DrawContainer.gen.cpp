...
class UScriptStruct* FRigUnit_DrawContainerGetInstruction::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_DrawContainerGetInstruction.OuterSingleton)
	{
		...
		Arguments_FRigUnit_DrawContainerGetInstruction_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_DrawContainerSetColor::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_DrawContainerSetColor.OuterSingleton)
	{
		...
		Arguments_FRigUnit_DrawContainerSetColor_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_DrawContainerSetColor_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_DrawContainerSetThickness::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_DrawContainerSetThickness.OuterSingleton)
	{
		...
		Arguments_FRigUnit_DrawContainerSetThickness_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_DrawContainerSetThickness_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_DrawContainerSetTransform::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_DrawContainerSetTransform.OuterSingleton)
	{
		...
		Arguments_FRigUnit_DrawContainerSetTransform_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_DrawContainerSetTransform_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
