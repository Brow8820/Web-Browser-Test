...
class UScriptStruct* FRigUnit_FitChainToCurve::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_FitChainToCurve.OuterSingleton)
	{
		...
		Arguments_FRigUnit_FitChainToCurve_Execute.Emplace(TEXT("Bezier"), TEXT("FCRFourPointBezier"));
		...
		Arguments_FRigUnit_FitChainToCurve_Execute.Emplace(TEXT("RotationEaseType"), TEXT("EControlRigAnimEasingType"));
		...
		Arguments_FRigUnit_FitChainToCurve_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_FitChainToCurve_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_FitChainToCurve_Statics::NewProp_Bezier = { "Bezier", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_FitChainToCurve, Bezier), Z_Construct_UScriptStruct_FCRFourPointBezier, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_FitChainToCurve_Statics::NewProp_Bezier_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_FitChainToCurve_Statics::NewProp_Bezier_MetaData)) }; // 3925716803
...
class UScriptStruct* FRigUnit_FitChainToCurvePerItem::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_FitChainToCurvePerItem.OuterSingleton)
	{
		...
		Arguments_FRigUnit_FitChainToCurvePerItem_Execute.Emplace(TEXT("Bezier"), TEXT("FCRFourPointBezier"));
		...
		Arguments_FRigUnit_FitChainToCurvePerItem_Execute.Emplace(TEXT("RotationEaseType"), TEXT("EControlRigAnimEasingType"));
		...
		Arguments_FRigUnit_FitChainToCurvePerItem_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_FitChainToCurvePerItem_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_FitChainToCurvePerItem_Statics::NewProp_Bezier = { "Bezier", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_FitChainToCurvePerItem, Bezier), Z_Construct_UScriptStruct_FCRFourPointBezier, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_FitChainToCurvePerItem_Statics::NewProp_Bezier_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_FitChainToCurvePerItem_Statics::NewProp_Bezier_MetaData)) }; // 3925716803
...
class UScriptStruct* FRigUnit_FitChainToCurveItemArray::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_FitChainToCurveItemArray.OuterSingleton)
	{
		...
		Arguments_FRigUnit_FitChainToCurveItemArray_Execute.Emplace(TEXT("Bezier"), TEXT("FCRFourPointBezier"));
		...
		Arguments_FRigUnit_FitChainToCurveItemArray_Execute.Emplace(TEXT("RotationEaseType"), TEXT("EControlRigAnimEasingType"));
		...
		Arguments_FRigUnit_FitChainToCurveItemArray_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_FitChainToCurveItemArray_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_FitChainToCurveItemArray::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Highlevel_Hierarchy_RigUnit_FitChainToCurve_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_FitChainToCurve::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_FitChainToCurve_Statics::NewStructOps, TEXT("RigUnit_FitChainToCurve"), &Z_Registration_Info_UScriptStruct_RigUnit_FitChainToCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_FitChainToCurve), 635928436U) },
		{ FRigUnit_FitChainToCurvePerItem::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_FitChainToCurvePerItem_Statics::NewStructOps, TEXT("RigUnit_FitChainToCurvePerItem"), &Z_Registration_Info_UScriptStruct_RigUnit_FitChainToCurvePerItem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_FitChainToCurvePerItem), 2187763575U) },
		{ FRigUnit_FitChainToCurveItemArray::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_FitChainToCurveItemArray_Statics::NewStructOps, TEXT("RigUnit_FitChainToCurveItemArray"), &Z_Registration_Info_UScriptStruct_RigUnit_FitChainToCurveItemArray, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_FitChainToCurveItemArray), 3039862790U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Highlevel_Hierarchy_RigUnit_FitChainToCurve_h_684561730(TEXT("/Script/ControlRig"),
		nullptr, 0,
