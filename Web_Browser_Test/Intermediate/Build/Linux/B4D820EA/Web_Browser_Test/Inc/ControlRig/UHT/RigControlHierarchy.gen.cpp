...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigControlHierarchy>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigControlHierarchy_h_Statics::ScriptStructInfo[] = {
		{ FRigControl::StaticStruct, Z_Construct_UScriptStruct_FRigControl_Statics::NewStructOps, TEXT("RigControl"), &Z_Registration_Info_UScriptStruct_RigControl, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigControl), 1368504279U) },
		{ FRigControlHierarchy::StaticStruct, Z_Construct_UScriptStruct_FRigControlHierarchy_Statics::NewStructOps, TEXT("RigControlHierarchy"), &Z_Registration_Info_UScriptStruct_RigControlHierarchy, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigControlHierarchy), 4054633975U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigControlHierarchy_h_1634213454(TEXT("/Script/ControlRig"),
		nullptr, 0,
