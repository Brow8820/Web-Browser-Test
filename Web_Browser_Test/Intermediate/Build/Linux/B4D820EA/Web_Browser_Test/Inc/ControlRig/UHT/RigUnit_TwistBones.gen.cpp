...
class UScriptStruct* FRigUnit_TwistBones::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_TwistBones.OuterSingleton)
	{
		...
		Arguments_FRigUnit_TwistBones_Execute.Emplace(TEXT("TwistEaseType"), TEXT("EControlRigAnimEasingType"));
		...
		Arguments_FRigUnit_TwistBones_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_TwistBones_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_TwistBonesPerItem::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_TwistBonesPerItem.OuterSingleton)
	{
		...
		Arguments_FRigUnit_TwistBonesPerItem_Execute.Emplace(TEXT("TwistEaseType"), TEXT("EControlRigAnimEasingType"));
		...
		Arguments_FRigUnit_TwistBonesPerItem_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_TwistBonesPerItem_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_TwistBonesPerItem::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Highlevel_Hierarchy_RigUnit_TwistBones_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_TwistBones::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_TwistBones_Statics::NewStructOps, TEXT("RigUnit_TwistBones"), &Z_Registration_Info_UScriptStruct_RigUnit_TwistBones, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_TwistBones), 3159355003U) },
		{ FRigUnit_TwistBonesPerItem::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_TwistBonesPerItem_Statics::NewStructOps, TEXT("RigUnit_TwistBonesPerItem"), &Z_Registration_Info_UScriptStruct_RigUnit_TwistBonesPerItem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_TwistBonesPerItem), 2784346939U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Highlevel_Hierarchy_RigUnit_TwistBones_h_2012500258(TEXT("/Script/ControlRig"),
		nullptr, 0,
