...
class UScriptStruct* FRigUnit_SetSpaceTransform::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetSpaceTransform.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetSpaceTransform_Execute.Emplace(TEXT("SpaceType"), TEXT("EBoneGetterSetterMode"));
		Arguments_FRigUnit_SetSpaceTransform_Execute.Emplace(TEXT("CachedSpaceIndex"), TEXT("FCachedRigElement"));
		Arguments_FRigUnit_SetSpaceTransform_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetSpaceTransform_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetSpaceTransform_Statics::NewProp_SpaceType = { "SpaceType", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_SetSpaceTransform, SpaceType), Z_Construct_UEnum_ControlRig_EBoneGetterSetterMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SetSpaceTransform_Statics::NewProp_SpaceType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetSpaceTransform_Statics::NewProp_SpaceType_MetaData)) }; // 899847808
#if WITH_METADATA
...
void FRigUnit_SetSpaceTransform::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetSpaceTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_SetSpaceTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetSpaceTransform_Statics::NewStructOps, TEXT("RigUnit_SetSpaceTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_SetSpaceTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetSpaceTransform), 2414271804U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetSpaceTransform_h_2857638651(TEXT("/Script/ControlRig"),
		nullptr, 0,
