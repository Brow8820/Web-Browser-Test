...
class UScriptStruct* FRigDispatchFactory::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigDispatchFactory.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigDispatchFactory, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigDispatchFactory"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigDispatchFactory>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_RigDispatchFactory_h_Statics::ScriptStructInfo[] = {
		{ FRigDispatchFactory::StaticStruct, Z_Construct_UScriptStruct_FRigDispatchFactory_Statics::NewStructOps, TEXT("RigDispatchFactory"), &Z_Registration_Info_UScriptStruct_RigDispatchFactory, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigDispatchFactory), 40646987U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_RigDispatchFactory_h_730406477(TEXT("/Script/ControlRig"),
		nullptr, 0,
