...
class UScriptStruct* FRigUnit_GetSpaceTransform::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_GetSpaceTransform.OuterSingleton)
	{
		...
		Arguments_FRigUnit_GetSpaceTransform_Execute.Emplace(TEXT("SpaceType"), TEXT("EBoneGetterSetterMode"));
		...
		Arguments_FRigUnit_GetSpaceTransform_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetSpaceTransform_Statics::NewProp_SpaceType = { "SpaceType", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_GetSpaceTransform, SpaceType), Z_Construct_UEnum_ControlRig_EBoneGetterSetterMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetSpaceTransform_Statics::NewProp_SpaceType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetSpaceTransform_Statics::NewProp_SpaceType_MetaData)) }; // 899847808
#if WITH_METADATA
...
void FRigUnit_GetSpaceTransform::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetSpaceTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_GetSpaceTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetSpaceTransform_Statics::NewStructOps, TEXT("RigUnit_GetSpaceTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_GetSpaceTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetSpaceTransform), 1437459554U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetSpaceTransform_h_3444936389(TEXT("/Script/ControlRig"),
		nullptr, 0,
