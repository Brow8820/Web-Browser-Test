...
class UScriptStruct* FRigUnit_SetRelativeBoneTransform::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetRelativeBoneTransform.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetRelativeBoneTransform_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetRelativeBoneTransform_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
