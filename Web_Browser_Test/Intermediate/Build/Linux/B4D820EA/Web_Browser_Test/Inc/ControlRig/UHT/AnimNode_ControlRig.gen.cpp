...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FAnimNode_ControlRig>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_AnimNode_ControlRig_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_ControlRig::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_ControlRig_Statics::NewStructOps, TEXT("AnimNode_ControlRig"), &Z_Registration_Info_UScriptStruct_AnimNode_ControlRig, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_ControlRig), 2179952321U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_AnimNode_ControlRig_h_1386146834(TEXT("/Script/ControlRig"),
		nullptr, 0,
