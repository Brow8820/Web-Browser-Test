...
class UScriptStruct* FRigUnit_DebugBezier::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_DebugBezier.OuterSingleton)
	{
		...
		Arguments_FRigUnit_DebugBezier_Execute.Emplace(TEXT("Bezier"), TEXT("FCRFourPointBezier"));
		...
		Arguments_FRigUnit_DebugBezier_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_DebugBezier_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_DebugBezierItemSpace::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_DebugBezierItemSpace.OuterSingleton)
	{
		...
		Arguments_FRigUnit_DebugBezierItemSpace_Execute.Emplace(TEXT("Bezier"), TEXT("FCRFourPointBezier"));
		...
		Arguments_FRigUnit_DebugBezierItemSpace_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_DebugBezierItemSpace_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_DebugBezierItemSpace_Statics::NewProp_Bezier = { "Bezier", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_DebugBezierItemSpace, Bezier), Z_Construct_UScriptStruct_FCRFourPointBezier, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_DebugBezierItemSpace_Statics::NewProp_Bezier_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_DebugBezierItemSpace_Statics::NewProp_Bezier_MetaData)) }; // 3925716803
#if WITH_METADATA
...
void FRigUnit_DebugBezierItemSpace::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Debug_RigUnit_DebugBezier_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_DebugBezier::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_DebugBezier_Statics::NewStructOps, TEXT("RigUnit_DebugBezier"), &Z_Registration_Info_UScriptStruct_RigUnit_DebugBezier, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_DebugBezier), 2872578361U) },
		{ FRigUnit_DebugBezierItemSpace::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_DebugBezierItemSpace_Statics::NewStructOps, TEXT("RigUnit_DebugBezierItemSpace"), &Z_Registration_Info_UScriptStruct_RigUnit_DebugBezierItemSpace, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_DebugBezierItemSpace), 300068679U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Debug_RigUnit_DebugBezier_h_1038105166(TEXT("/Script/ControlRig"),
		nullptr, 0,
