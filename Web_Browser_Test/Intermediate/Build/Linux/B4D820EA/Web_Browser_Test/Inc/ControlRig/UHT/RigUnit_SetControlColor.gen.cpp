...
class UScriptStruct* FRigUnit_GetControlColor::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_GetControlColor.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_GetControlColor, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_GetControlColor"));
		...
		Arguments_FRigUnit_GetControlColor_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_GetControlColor::Execute(const FRigUnitContext & Context)
{
...
class UScriptStruct* FRigUnit_SetControlColor::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetControlColor.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetControlColor_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetControlColor_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_SetControlColor::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetControlColor_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_GetControlColor::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetControlColor_Statics::NewStructOps, TEXT("RigUnit_GetControlColor"), &Z_Registration_Info_UScriptStruct_RigUnit_GetControlColor, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetControlColor), 78382389U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetControlColor_h_3515197046(TEXT("/Script/ControlRig"),
		nullptr, 0,
