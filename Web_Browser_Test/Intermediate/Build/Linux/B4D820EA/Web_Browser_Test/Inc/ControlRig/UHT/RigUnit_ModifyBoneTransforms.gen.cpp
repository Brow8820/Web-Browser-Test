...
class UScriptStruct* FRigUnit_ModifyBoneTransforms::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_ModifyBoneTransforms.OuterSingleton)
	{
		...
		Arguments_FRigUnit_ModifyBoneTransforms_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_ModifyBoneTransforms_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
