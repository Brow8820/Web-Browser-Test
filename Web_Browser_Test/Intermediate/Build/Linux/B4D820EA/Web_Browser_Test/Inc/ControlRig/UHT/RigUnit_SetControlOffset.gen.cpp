...
class UScriptStruct* FRigUnit_SetControlOffset::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetControlOffset.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetControlOffset_Execute.Emplace(TEXT("Space"), TEXT("EBoneGetterSetterMode"));
		Arguments_FRigUnit_SetControlOffset_Execute.Emplace(TEXT("CachedControlIndex"), TEXT("FCachedRigElement"));
		Arguments_FRigUnit_SetControlOffset_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetControlOffset_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetControlOffset_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_SetControlOffset, Space), Z_Construct_UEnum_ControlRig_EBoneGetterSetterMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SetControlOffset_Statics::NewProp_Space_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetControlOffset_Statics::NewProp_Space_MetaData)) }; // 899847808
#if WITH_METADATA
...
class UScriptStruct* FRigUnit_GetShapeTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_GetShapeTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_GetShapeTransform, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_GetShapeTransform"));
		...
		Arguments_FRigUnit_GetShapeTransform_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_GetShapeTransform::Execute(const FRigUnitContext & Context)
{
	FRigVMExecuteContext RigVMExecuteContext;
	StaticExecute(
		RigVMExecuteContext,
...
class UScriptStruct* FRigUnit_SetShapeTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_SetShapeTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_SetShapeTransform, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_SetShapeTransform"));
		...
		Arguments_FRigUnit_SetShapeTransform_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetShapeTransform_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_SetShapeTransform::Execute(const FRigUnitContext & Context)
{
	FRigVMExecuteContext RigVMExecuteContext;
	StaticExecute(
		RigVMExecuteContext,
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetControlOffset_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_SetControlOffset::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetControlOffset_Statics::NewStructOps, TEXT("RigUnit_SetControlOffset"), &Z_Registration_Info_UScriptStruct_RigUnit_SetControlOffset, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetControlOffset), 741691705U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetControlOffset_h_1084890740(TEXT("/Script/ControlRig"),
		nullptr, 0,
