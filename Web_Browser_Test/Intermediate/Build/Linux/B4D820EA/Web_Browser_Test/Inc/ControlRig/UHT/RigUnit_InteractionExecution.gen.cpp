...
class UScriptStruct* FRigUnit_InteractionExecution::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_InteractionExecution.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_InteractionExecution, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_InteractionExecution"));
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_InteractionExecution_Execute;
		Arguments_FRigUnit_InteractionExecution_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_InteractionExecution_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_InteractionExecution::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_InteractionExecution_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_InteractionExecution::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_InteractionExecution_Statics::NewStructOps, TEXT("RigUnit_InteractionExecution"), &Z_Registration_Info_UScriptStruct_RigUnit_InteractionExecution, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_InteractionExecution), 3702042863U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_InteractionExecution_h_2979277725(TEXT("/Script/ControlRig"),
		nullptr, 0,
