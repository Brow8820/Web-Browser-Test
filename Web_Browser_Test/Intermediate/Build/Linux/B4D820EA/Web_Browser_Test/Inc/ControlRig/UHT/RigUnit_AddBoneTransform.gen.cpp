...
class UScriptStruct* FRigUnit_AddBoneTransform::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_AddBoneTransform.OuterSingleton)
	{
		...
		Arguments_FRigUnit_AddBoneTransform_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_AddBoneTransform_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
