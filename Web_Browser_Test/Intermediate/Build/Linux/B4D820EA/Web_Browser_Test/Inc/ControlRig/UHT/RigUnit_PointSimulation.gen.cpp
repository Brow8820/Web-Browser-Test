...
class UScriptStruct* FRigUnit_PointSimulation::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_PointSimulation.OuterSingleton)
	{
		...
		Arguments_FRigUnit_PointSimulation_Execute.Emplace(TEXT("Points"), TEXT("TArray<FCRSimPoint>"));
		...
		Arguments_FRigUnit_PointSimulation_Execute.Emplace(TEXT("IntegratorType"), TEXT("ECRSimPointIntegrateType"));
		...
		Arguments_FRigUnit_PointSimulation_Execute.Emplace(TEXT("Bezier"), TEXT("FCRFourPointBezier"));
		Arguments_FRigUnit_PointSimulation_Execute.Emplace(TEXT("WorkData"), TEXT("FRigUnit_PointSimulation_WorkData"));
		Arguments_FRigUnit_PointSimulation_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_PointSimulation_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_PointSimulation>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_PointSimulation_Statics::NewProp_Points_Inner = { "Points", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FCRSimPoint, METADATA_PARAMS(nullptr, 0) }; // 1775132219
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_PointSimulation_Statics::NewProp_IntegratorType = { "IntegratorType", nullptr, (EPropertyFlags)0x0010000000020005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_PointSimulation, IntegratorType), Z_Construct_UEnum_ControlRig_ECRSimPointIntegrateType, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_PointSimulation_Statics::NewProp_IntegratorType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_PointSimulation_Statics::NewProp_IntegratorType_MetaData)) }; // 2666222048
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_PointSimulation_Statics::NewProp_Bezier = { "Bezier", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_PointSimulation, Bezier), Z_Construct_UScriptStruct_FCRFourPointBezier, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_PointSimulation_Statics::NewProp_Bezier_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_PointSimulation_Statics::NewProp_Bezier_MetaData)) }; // 3925716803
#if WITH_METADATA
...
void FRigUnit_PointSimulation::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Simulation_RigUnit_PointSimulation_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_PointSimulation_WorkData::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_PointSimulation_WorkData_Statics::NewStructOps, TEXT("RigUnit_PointSimulation_WorkData"), &Z_Registration_Info_UScriptStruct_RigUnit_PointSimulation_WorkData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_PointSimulation_WorkData), 855390886U) },
		{ FRigUnit_PointSimulation::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_PointSimulation_Statics::NewStructOps, TEXT("RigUnit_PointSimulation"), &Z_Registration_Info_UScriptStruct_RigUnit_PointSimulation, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_PointSimulation), 2149103641U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Simulation_RigUnit_PointSimulation_h_715024768(TEXT("/Script/ControlRig"),
		nullptr, 0,
