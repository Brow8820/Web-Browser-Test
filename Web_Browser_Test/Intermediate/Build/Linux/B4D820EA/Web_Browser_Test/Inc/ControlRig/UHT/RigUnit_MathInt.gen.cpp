...
// Cross Module References
	...
	CONTROLRIG_API UScriptStruct* Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp();
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntUnaryOp_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntUnaryOp, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntUnaryOp_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntUnaryOp_Statics::NewProp_Value_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntUnaryOp_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntUnaryOp, Result), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntUnaryOp_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntUnaryOp_Statics::NewProp_Result_MetaData)) };
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryOp_Statics::NewProp_A = { "A", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntBinaryOp, A), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryOp_Statics::NewProp_A_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryOp_Statics::NewProp_A_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryOp_Statics::NewProp_B = { "B", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntBinaryOp, B), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryOp_Statics::NewProp_B_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryOp_Statics::NewProp_B_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryOp_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntBinaryOp, Result), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryOp_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryOp_Statics::NewProp_Result_MetaData)) };
...
static_assert(std::is_polymorphic<FRigUnit_MathIntBinaryAggregateOp>() == std::is_polymorphic<FRigUnit_MathIntBase>(), "USTRUCT FRigUnit_MathIntBinaryAggregateOp cannot be polymorphic unless super FRigUnit_MathIntBase is polymorphic");

	static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_RigUnit_MathIntBinaryAggregateOp;
class UScriptStruct* FRigUnit_MathIntBinaryAggregateOp::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntBinaryAggregateOp.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_RigUnit_MathIntBinaryAggregateOp.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_MathIntBinaryAggregateOp"));
	}
	return Z_Registration_Info_UScriptStruct_RigUnit_MathIntBinaryAggregateOp.OuterSingleton;
}
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_MathIntBinaryAggregateOp>()
{
	return FRigUnit_MathIntBinaryAggregateOp::StaticStruct();
}
	struct Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::Struct_MetaDataParams[] = {
		{ "Abstract", "" },
		{ "ModuleRelativePath", "Private/Units/Math/RigUnit_MathInt.h" },
	};
#endif
	void* Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FRigUnit_MathIntBinaryAggregateOp>();
	}
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewProp_A_MetaData[] = {
		{ "Aggregate", "" },
		{ "Category", "Pins" },
		{ "Input", "" },
		{ "ModuleRelativePath", "Private/Units/Math/RigUnit_MathInt.h" },
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewProp_A = { "A", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntBinaryAggregateOp, A), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewProp_A_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewProp_A_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewProp_B_MetaData[] = {
		{ "Aggregate", "" },
		{ "Category", "Pins" },
		{ "Input", "" },
		{ "ModuleRelativePath", "Private/Units/Math/RigUnit_MathInt.h" },
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewProp_B = { "B", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntBinaryAggregateOp, B), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewProp_B_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewProp_B_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewProp_Result_MetaData[] = {
		{ "Aggregate", "" },
		{ "Category", "Pins" },
		{ "ModuleRelativePath", "Private/Units/Math/RigUnit_MathInt.h" },
		{ "Output", "" },
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntBinaryAggregateOp, Result), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewProp_Result_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewProp_A,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewProp_B,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewProp_Result,
	};
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_ControlRig,
		Z_Construct_UScriptStruct_FRigUnit_MathIntBase,
		&NewStructOps,
		"RigUnit_MathIntBinaryAggregateOp",
		sizeof(FRigUnit_MathIntBinaryAggregateOp),
		alignof(FRigUnit_MathIntBinaryAggregateOp),
		Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::PropPointers,
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::Struct_MetaDataParams))
	};
	UScriptStruct* Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp()
	{
		if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntBinaryAggregateOp.InnerSingleton)
		{
			UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_RigUnit_MathIntBinaryAggregateOp.InnerSingleton, Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::ReturnStructParams);
		}
		return Z_Registration_Info_UScriptStruct_RigUnit_MathIntBinaryAggregateOp.InnerSingleton;
	}

static_assert(std::is_polymorphic<FRigUnit_MathIntAdd>() == std::is_polymorphic<FRigUnit_MathIntBinaryAggregateOp>(), "USTRUCT FRigUnit_MathIntAdd cannot be polymorphic unless super FRigUnit_MathIntBinaryAggregateOp is polymorphic");
...
class UScriptStruct* FRigUnit_MathIntAdd::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntAdd.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntAdd_Execute;
		Arguments_FRigUnit_MathIntAdd_Execute.Emplace(TEXT("A"), TEXT("int32"));
		Arguments_FRigUnit_MathIntAdd_Execute.Emplace(TEXT("B"), TEXT("int32"));
		Arguments_FRigUnit_MathIntAdd_Execute.Emplace(TEXT("Result"), TEXT("int32"));
		Arguments_FRigUnit_MathIntAdd_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntAdd::Execute"), &FRigUnit_MathIntAdd::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntAdd.OuterSingleton, Arguments_FRigUnit_MathIntAdd_Execute);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_MathIntAdd>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRigUnit_MathIntAdd_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_ControlRig,
		Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp,
		&NewStructOps,
		"RigUnit_MathIntAdd",
...
class UScriptStruct* FRigUnit_MathIntSub::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntSub.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntSub_Execute;
		Arguments_FRigUnit_MathIntSub_Execute.Emplace(TEXT("A"), TEXT("int32"));
		Arguments_FRigUnit_MathIntSub_Execute.Emplace(TEXT("B"), TEXT("int32"));
		Arguments_FRigUnit_MathIntSub_Execute.Emplace(TEXT("Result"), TEXT("int32"));
		Arguments_FRigUnit_MathIntSub_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntSub::Execute"), &FRigUnit_MathIntSub::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntSub.OuterSingleton, Arguments_FRigUnit_MathIntSub_Execute);
	}
...
static_assert(std::is_polymorphic<FRigUnit_MathIntMul>() == std::is_polymorphic<FRigUnit_MathIntBinaryAggregateOp>(), "USTRUCT FRigUnit_MathIntMul cannot be polymorphic unless super FRigUnit_MathIntBinaryAggregateOp is polymorphic");
...
class UScriptStruct* FRigUnit_MathIntMul::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntMul.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntMul_Execute;
		Arguments_FRigUnit_MathIntMul_Execute.Emplace(TEXT("A"), TEXT("int32"));
		Arguments_FRigUnit_MathIntMul_Execute.Emplace(TEXT("B"), TEXT("int32"));
		Arguments_FRigUnit_MathIntMul_Execute.Emplace(TEXT("Result"), TEXT("int32"));
		Arguments_FRigUnit_MathIntMul_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntMul::Execute"), &FRigUnit_MathIntMul::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntMul.OuterSingleton, Arguments_FRigUnit_MathIntMul_Execute);
	}
...
class UScriptStruct* FRigUnit_MathIntDiv::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntDiv.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntDiv_Execute;
		Arguments_FRigUnit_MathIntDiv_Execute.Emplace(TEXT("A"), TEXT("int32"));
		Arguments_FRigUnit_MathIntDiv_Execute.Emplace(TEXT("B"), TEXT("int32"));
		Arguments_FRigUnit_MathIntDiv_Execute.Emplace(TEXT("Result"), TEXT("int32"));
		Arguments_FRigUnit_MathIntDiv_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntDiv::Execute"), &FRigUnit_MathIntDiv::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntDiv.OuterSingleton, Arguments_FRigUnit_MathIntDiv_Execute);
	}
...
class UScriptStruct* FRigUnit_MathIntMod::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntMod.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntMod_Execute;
		Arguments_FRigUnit_MathIntMod_Execute.Emplace(TEXT("A"), TEXT("int32"));
		Arguments_FRigUnit_MathIntMod_Execute.Emplace(TEXT("B"), TEXT("int32"));
		Arguments_FRigUnit_MathIntMod_Execute.Emplace(TEXT("Result"), TEXT("int32"));
		Arguments_FRigUnit_MathIntMod_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntMod::Execute"), &FRigUnit_MathIntMod::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntMod.OuterSingleton, Arguments_FRigUnit_MathIntMod_Execute);
	}
...
static_assert(std::is_polymorphic<FRigUnit_MathIntMin>() == std::is_polymorphic<FRigUnit_MathIntBinaryAggregateOp>(), "USTRUCT FRigUnit_MathIntMin cannot be polymorphic unless super FRigUnit_MathIntBinaryAggregateOp is polymorphic");
...
class UScriptStruct* FRigUnit_MathIntMin::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntMin.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntMin_Execute;
		Arguments_FRigUnit_MathIntMin_Execute.Emplace(TEXT("A"), TEXT("int32"));
		Arguments_FRigUnit_MathIntMin_Execute.Emplace(TEXT("B"), TEXT("int32"));
		Arguments_FRigUnit_MathIntMin_Execute.Emplace(TEXT("Result"), TEXT("int32"));
		Arguments_FRigUnit_MathIntMin_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntMin::Execute"), &FRigUnit_MathIntMin::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntMin.OuterSingleton, Arguments_FRigUnit_MathIntMin_Execute);
	}
...
static_assert(std::is_polymorphic<FRigUnit_MathIntMax>() == std::is_polymorphic<FRigUnit_MathIntBinaryAggregateOp>(), "USTRUCT FRigUnit_MathIntMax cannot be polymorphic unless super FRigUnit_MathIntBinaryAggregateOp is polymorphic");
...
class UScriptStruct* FRigUnit_MathIntMax::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntMax.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntMax_Execute;
		Arguments_FRigUnit_MathIntMax_Execute.Emplace(TEXT("A"), TEXT("int32"));
		Arguments_FRigUnit_MathIntMax_Execute.Emplace(TEXT("B"), TEXT("int32"));
		Arguments_FRigUnit_MathIntMax_Execute.Emplace(TEXT("Result"), TEXT("int32"));
		Arguments_FRigUnit_MathIntMax_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntMax::Execute"), &FRigUnit_MathIntMax::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntMax.OuterSingleton, Arguments_FRigUnit_MathIntMax_Execute);
	}
...
class UScriptStruct* FRigUnit_MathIntPow::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntPow.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntPow_Execute;
		Arguments_FRigUnit_MathIntPow_Execute.Emplace(TEXT("A"), TEXT("int32"));
		Arguments_FRigUnit_MathIntPow_Execute.Emplace(TEXT("B"), TEXT("int32"));
		Arguments_FRigUnit_MathIntPow_Execute.Emplace(TEXT("Result"), TEXT("int32"));
		Arguments_FRigUnit_MathIntPow_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntPow::Execute"), &FRigUnit_MathIntPow::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntPow.OuterSingleton, Arguments_FRigUnit_MathIntPow_Execute);
	}
...
class UScriptStruct* FRigUnit_MathIntNegate::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntNegate.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntNegate_Execute;
		Arguments_FRigUnit_MathIntNegate_Execute.Emplace(TEXT("Value"), TEXT("int32"));
		Arguments_FRigUnit_MathIntNegate_Execute.Emplace(TEXT("Result"), TEXT("int32"));
		Arguments_FRigUnit_MathIntNegate_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntNegate::Execute"), &FRigUnit_MathIntNegate::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntNegate.OuterSingleton, Arguments_FRigUnit_MathIntNegate_Execute);
	}
...
class UScriptStruct* FRigUnit_MathIntAbs::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntAbs.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntAbs_Execute;
		Arguments_FRigUnit_MathIntAbs_Execute.Emplace(TEXT("Value"), TEXT("int32"));
		Arguments_FRigUnit_MathIntAbs_Execute.Emplace(TEXT("Result"), TEXT("int32"));
		Arguments_FRigUnit_MathIntAbs_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntAbs::Execute"), &FRigUnit_MathIntAbs::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntAbs.OuterSingleton, Arguments_FRigUnit_MathIntAbs_Execute);
	}
...
class UScriptStruct* FRigUnit_MathIntToFloat::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntToFloat.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntToFloat_Execute;
		Arguments_FRigUnit_MathIntToFloat_Execute.Emplace(TEXT("Value"), TEXT("int32"));
		Arguments_FRigUnit_MathIntToFloat_Execute.Emplace(TEXT("Result"), TEXT("float"));
		Arguments_FRigUnit_MathIntToFloat_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntToFloat::Execute"), &FRigUnit_MathIntToFloat::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntToFloat.OuterSingleton, Arguments_FRigUnit_MathIntToFloat_Execute);
	}
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntToFloat_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntToFloat, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntToFloat_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntToFloat_Statics::NewProp_Value_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntToFloat_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntToFloat, Result), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntToFloat_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntToFloat_Statics::NewProp_Result_MetaData)) };
...
class UScriptStruct* FRigUnit_MathIntSign::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntSign.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntSign_Execute;
		Arguments_FRigUnit_MathIntSign_Execute.Emplace(TEXT("Value"), TEXT("int32"));
		Arguments_FRigUnit_MathIntSign_Execute.Emplace(TEXT("Result"), TEXT("int32"));
		Arguments_FRigUnit_MathIntSign_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntSign::Execute"), &FRigUnit_MathIntSign::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntSign.OuterSingleton, Arguments_FRigUnit_MathIntSign_Execute);
	}
...
class UScriptStruct* FRigUnit_MathIntClamp::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntClamp.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntClamp_Execute;
		Arguments_FRigUnit_MathIntClamp_Execute.Emplace(TEXT("Value"), TEXT("int32"));
		Arguments_FRigUnit_MathIntClamp_Execute.Emplace(TEXT("Minimum"), TEXT("int32"));
		Arguments_FRigUnit_MathIntClamp_Execute.Emplace(TEXT("Maximum"), TEXT("int32"));
		Arguments_FRigUnit_MathIntClamp_Execute.Emplace(TEXT("Result"), TEXT("int32"));
		Arguments_FRigUnit_MathIntClamp_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntClamp::Execute"), &FRigUnit_MathIntClamp::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntClamp.OuterSingleton, Arguments_FRigUnit_MathIntClamp_Execute);
	}
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntClamp_Statics::NewProp_Maximum = { "Maximum", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntClamp, Maximum), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntClamp_Statics::NewProp_Maximum_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntClamp_Statics::NewProp_Maximum_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntClamp_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntClamp, Result), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntClamp_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntClamp_Statics::NewProp_Result_MetaData)) };
...
class UScriptStruct* FRigUnit_MathIntEquals::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntEquals.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntEquals_Execute;
		Arguments_FRigUnit_MathIntEquals_Execute.Emplace(TEXT("A"), TEXT("int32"));
		Arguments_FRigUnit_MathIntEquals_Execute.Emplace(TEXT("B"), TEXT("int32"));
		Arguments_FRigUnit_MathIntEquals_Execute.Emplace(TEXT("Result"), TEXT("bool"));
		Arguments_FRigUnit_MathIntEquals_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntEquals::Execute"), &FRigUnit_MathIntEquals::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntEquals.OuterSingleton, Arguments_FRigUnit_MathIntEquals_Execute);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_MathIntEquals>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntEquals_Statics::NewProp_A = { "A", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntEquals, A), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntEquals_Statics::NewProp_A_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntEquals_Statics::NewProp_A_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntEquals_Statics::NewProp_B = { "B", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntEquals, B), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntEquals_Statics::NewProp_B_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntEquals_Statics::NewProp_B_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntEquals_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FRigUnit_MathIntEquals), &Z_Construct_UScriptStruct_FRigUnit_MathIntEquals_Statics::NewProp_Result_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntEquals_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntEquals_Statics::NewProp_Result_MetaData)) };
...
class UScriptStruct* FRigUnit_MathIntNotEquals::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntNotEquals.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntNotEquals_Execute;
		Arguments_FRigUnit_MathIntNotEquals_Execute.Emplace(TEXT("A"), TEXT("int32"));
		Arguments_FRigUnit_MathIntNotEquals_Execute.Emplace(TEXT("B"), TEXT("int32"));
		Arguments_FRigUnit_MathIntNotEquals_Execute.Emplace(TEXT("Result"), TEXT("bool"));
		Arguments_FRigUnit_MathIntNotEquals_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntNotEquals::Execute"), &FRigUnit_MathIntNotEquals::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntNotEquals.OuterSingleton, Arguments_FRigUnit_MathIntNotEquals_Execute);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_MathIntNotEquals>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntNotEquals_Statics::NewProp_B = { "B", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntNotEquals, B), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntNotEquals_Statics::NewProp_B_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntNotEquals_Statics::NewProp_B_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntNotEquals_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FRigUnit_MathIntNotEquals), &Z_Construct_UScriptStruct_FRigUnit_MathIntNotEquals_Statics::NewProp_Result_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntNotEquals_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntNotEquals_Statics::NewProp_Result_MetaData)) };
...
class UScriptStruct* FRigUnit_MathIntGreater::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntGreater.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntGreater_Execute;
		Arguments_FRigUnit_MathIntGreater_Execute.Emplace(TEXT("A"), TEXT("int32"));
		Arguments_FRigUnit_MathIntGreater_Execute.Emplace(TEXT("B"), TEXT("int32"));
		Arguments_FRigUnit_MathIntGreater_Execute.Emplace(TEXT("Result"), TEXT("bool"));
		Arguments_FRigUnit_MathIntGreater_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntGreater::Execute"), &FRigUnit_MathIntGreater::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntGreater.OuterSingleton, Arguments_FRigUnit_MathIntGreater_Execute);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_MathIntGreater>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntGreater_Statics::NewProp_B = { "B", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntGreater, B), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntGreater_Statics::NewProp_B_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntGreater_Statics::NewProp_B_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntGreater_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FRigUnit_MathIntGreater), &Z_Construct_UScriptStruct_FRigUnit_MathIntGreater_Statics::NewProp_Result_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntGreater_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntGreater_Statics::NewProp_Result_MetaData)) };
...
class UScriptStruct* FRigUnit_MathIntLess::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntLess.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntLess_Execute;
		Arguments_FRigUnit_MathIntLess_Execute.Emplace(TEXT("A"), TEXT("int32"));
		Arguments_FRigUnit_MathIntLess_Execute.Emplace(TEXT("B"), TEXT("int32"));
		Arguments_FRigUnit_MathIntLess_Execute.Emplace(TEXT("Result"), TEXT("bool"));
		Arguments_FRigUnit_MathIntLess_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntLess::Execute"), &FRigUnit_MathIntLess::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntLess.OuterSingleton, Arguments_FRigUnit_MathIntLess_Execute);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_MathIntLess>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntLess_Statics::NewProp_A = { "A", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntLess, A), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntLess_Statics::NewProp_A_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntLess_Statics::NewProp_A_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntLess_Statics::NewProp_B = { "B", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntLess, B), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntLess_Statics::NewProp_B_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntLess_Statics::NewProp_B_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntLess_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FRigUnit_MathIntLess), &Z_Construct_UScriptStruct_FRigUnit_MathIntLess_Statics::NewProp_Result_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntLess_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntLess_Statics::NewProp_Result_MetaData)) };
...
class UScriptStruct* FRigUnit_MathIntGreaterEqual::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntGreaterEqual.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntGreaterEqual_Execute;
		Arguments_FRigUnit_MathIntGreaterEqual_Execute.Emplace(TEXT("A"), TEXT("int32"));
		Arguments_FRigUnit_MathIntGreaterEqual_Execute.Emplace(TEXT("B"), TEXT("int32"));
		Arguments_FRigUnit_MathIntGreaterEqual_Execute.Emplace(TEXT("Result"), TEXT("bool"));
		Arguments_FRigUnit_MathIntGreaterEqual_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntGreaterEqual::Execute"), &FRigUnit_MathIntGreaterEqual::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntGreaterEqual.OuterSingleton, Arguments_FRigUnit_MathIntGreaterEqual_Execute);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_MathIntGreaterEqual>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntGreaterEqual_Statics::NewProp_A = { "A", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntGreaterEqual, A), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntGreaterEqual_Statics::NewProp_A_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntGreaterEqual_Statics::NewProp_A_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntGreaterEqual_Statics::NewProp_B = { "B", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntGreaterEqual, B), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntGreaterEqual_Statics::NewProp_B_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntGreaterEqual_Statics::NewProp_B_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntGreaterEqual_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FRigUnit_MathIntGreaterEqual), &Z_Construct_UScriptStruct_FRigUnit_MathIntGreaterEqual_Statics::NewProp_Result_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntGreaterEqual_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntGreaterEqual_Statics::NewProp_Result_MetaData)) };
...
class UScriptStruct* FRigUnit_MathIntLessEqual::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_MathIntLessEqual.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_MathIntLessEqual_Execute;
		Arguments_FRigUnit_MathIntLessEqual_Execute.Emplace(TEXT("A"), TEXT("int32"));
		Arguments_FRigUnit_MathIntLessEqual_Execute.Emplace(TEXT("B"), TEXT("int32"));
		Arguments_FRigUnit_MathIntLessEqual_Execute.Emplace(TEXT("Result"), TEXT("bool"));
		Arguments_FRigUnit_MathIntLessEqual_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MathIntLessEqual::Execute"), &FRigUnit_MathIntLessEqual::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MathIntLessEqual.OuterSingleton, Arguments_FRigUnit_MathIntLessEqual_Execute);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_MathIntLessEqual>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntLessEqual_Statics::NewProp_A = { "A", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntLessEqual, A), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntLessEqual_Statics::NewProp_A_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntLessEqual_Statics::NewProp_A_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntLessEqual_Statics::NewProp_B = { "B", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_MathIntLessEqual, B), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntLessEqual_Statics::NewProp_B_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntLessEqual_Statics::NewProp_B_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_MathIntLessEqual_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FRigUnit_MathIntLessEqual), &Z_Construct_UScriptStruct_FRigUnit_MathIntLessEqual_Statics::NewProp_Result_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_MathIntLessEqual_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_MathIntLessEqual_Statics::NewProp_Result_MetaData)) };
...
void FRigUnit_MathIntLessEqual::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Math_RigUnit_MathInt_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_MathIntUnaryOp::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntUnaryOp_Statics::NewStructOps, TEXT("RigUnit_MathIntUnaryOp"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntUnaryOp, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntUnaryOp), 3962085895U) },
		{ FRigUnit_MathIntBinaryOp::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryOp_Statics::NewStructOps, TEXT("RigUnit_MathIntBinaryOp"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntBinaryOp, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntBinaryOp), 222466687U) },
		{ FRigUnit_MathIntBinaryAggregateOp::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntBinaryAggregateOp_Statics::NewStructOps, TEXT("RigUnit_MathIntBinaryAggregateOp"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntBinaryAggregateOp, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntBinaryAggregateOp), 1740258429U) },
		{ FRigUnit_MathIntAdd::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntAdd_Statics::NewStructOps, TEXT("RigUnit_MathIntAdd"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntAdd, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntAdd), 4247889054U) },
		{ FRigUnit_MathIntSub::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntSub_Statics::NewStructOps, TEXT("RigUnit_MathIntSub"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntSub, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntSub), 499027668U) },
		{ FRigUnit_MathIntMul::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntMul_Statics::NewStructOps, TEXT("RigUnit_MathIntMul"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntMul, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntMul), 3730462089U) },
		{ FRigUnit_MathIntDiv::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntDiv_Statics::NewStructOps, TEXT("RigUnit_MathIntDiv"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntDiv, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntDiv), 3498106191U) },
		{ FRigUnit_MathIntMod::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntMod_Statics::NewStructOps, TEXT("RigUnit_MathIntMod"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntMod, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntMod), 2217784866U) },
		{ FRigUnit_MathIntMin::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntMin_Statics::NewStructOps, TEXT("RigUnit_MathIntMin"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntMin, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntMin), 4128013276U) },
		{ FRigUnit_MathIntMax::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntMax_Statics::NewStructOps, TEXT("RigUnit_MathIntMax"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntMax, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntMax), 2300581376U) },
		{ FRigUnit_MathIntPow::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntPow_Statics::NewStructOps, TEXT("RigUnit_MathIntPow"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntPow, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntPow), 1988441518U) },
		{ FRigUnit_MathIntNegate::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntNegate_Statics::NewStructOps, TEXT("RigUnit_MathIntNegate"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntNegate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntNegate), 2534030159U) },
		{ FRigUnit_MathIntAbs::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntAbs_Statics::NewStructOps, TEXT("RigUnit_MathIntAbs"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntAbs, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntAbs), 4066208696U) },
		{ FRigUnit_MathIntToFloat::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntToFloat_Statics::NewStructOps, TEXT("RigUnit_MathIntToFloat"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntToFloat, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntToFloat), 1701976232U) },
		{ FRigUnit_MathIntSign::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntSign_Statics::NewStructOps, TEXT("RigUnit_MathIntSign"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntSign, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntSign), 3267222938U) },
		{ FRigUnit_MathIntClamp::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntClamp_Statics::NewStructOps, TEXT("RigUnit_MathIntClamp"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntClamp, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntClamp), 1540947323U) },
		{ FRigUnit_MathIntEquals::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntEquals_Statics::NewStructOps, TEXT("RigUnit_MathIntEquals"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntEquals, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntEquals), 773950439U) },
		{ FRigUnit_MathIntNotEquals::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntNotEquals_Statics::NewStructOps, TEXT("RigUnit_MathIntNotEquals"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntNotEquals, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntNotEquals), 3572800993U) },
		{ FRigUnit_MathIntGreater::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntGreater_Statics::NewStructOps, TEXT("RigUnit_MathIntGreater"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntGreater, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntGreater), 4111491170U) },
		{ FRigUnit_MathIntLess::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntLess_Statics::NewStructOps, TEXT("RigUnit_MathIntLess"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntLess, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntLess), 4326673U) },
		{ FRigUnit_MathIntGreaterEqual::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntGreaterEqual_Statics::NewStructOps, TEXT("RigUnit_MathIntGreaterEqual"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntGreaterEqual, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntGreaterEqual), 189933387U) },
		{ FRigUnit_MathIntLessEqual::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_MathIntLessEqual_Statics::NewStructOps, TEXT("RigUnit_MathIntLessEqual"), &Z_Registration_Info_UScriptStruct_RigUnit_MathIntLessEqual, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_MathIntLessEqual), 1954548240U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Math_RigUnit_MathInt_h_4011724416(TEXT("/Script/ControlRig"),
		nullptr, 0,
