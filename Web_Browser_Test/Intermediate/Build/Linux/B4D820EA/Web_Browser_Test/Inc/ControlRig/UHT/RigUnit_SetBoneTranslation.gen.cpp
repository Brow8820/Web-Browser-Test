...
class UScriptStruct* FRigUnit_SetBoneTranslation::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetBoneTranslation.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetBoneTranslation_Execute.Emplace(TEXT("Space"), TEXT("EBoneGetterSetterMode"));
		...
		Arguments_FRigUnit_SetBoneTranslation_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetBoneTranslation_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_SetBoneTranslation::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetBoneTranslation_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_SetBoneTranslation::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation_Statics::NewStructOps, TEXT("RigUnit_SetBoneTranslation"), &Z_Registration_Info_UScriptStruct_RigUnit_SetBoneTranslation, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetBoneTranslation), 2314755510U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetBoneTranslation_h_3938944740(TEXT("/Script/ControlRig"),
		nullptr, 0,
