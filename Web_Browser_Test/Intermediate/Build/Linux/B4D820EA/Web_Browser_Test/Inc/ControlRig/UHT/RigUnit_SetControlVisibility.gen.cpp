...
class UScriptStruct* FRigUnit_GetControlVisibility::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_GetControlVisibility.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_GetControlVisibility, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_GetControlVisibility"));
		...
		Arguments_FRigUnit_GetControlVisibility_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_GetControlVisibility::Execute(const FRigUnitContext & Context)
{
...
class UScriptStruct* FRigUnit_SetControlVisibility::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetControlVisibility.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetControlVisibility_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetControlVisibility_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
