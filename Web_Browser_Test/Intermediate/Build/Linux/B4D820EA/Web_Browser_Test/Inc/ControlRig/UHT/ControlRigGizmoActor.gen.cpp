...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FControlShapeActorCreationParam>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_ControlRigGizmoActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AControlRigShapeActor, AControlRigShapeActor::StaticClass, TEXT("AControlRigShapeActor"), &Z_Registration_Info_UClass_AControlRigShapeActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AControlRigShapeActor), 571769018U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_ControlRigGizmoActor_h_1315789354(TEXT("/Script/ControlRig"),
