...
class UScriptStruct* FRigUnit_Control::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_Control.OuterSingleton)
	{
		...
		Arguments_FRigUnit_Control_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_Control::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Control_RigUnit_Control_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_Control::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_Control_Statics::NewStructOps, TEXT("RigUnit_Control"), &Z_Registration_Info_UScriptStruct_RigUnit_Control, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_Control), 3629163337U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Control_RigUnit_Control_h_3646166483(TEXT("/Script/ControlRig"),
		nullptr, 0,
