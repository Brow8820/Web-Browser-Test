...
class UScriptStruct* FRigUnit_OffsetTransformForItem::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_OffsetTransformForItem.OuterSingleton)
	{
		...
		Arguments_FRigUnit_OffsetTransformForItem_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_OffsetTransformForItem_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
