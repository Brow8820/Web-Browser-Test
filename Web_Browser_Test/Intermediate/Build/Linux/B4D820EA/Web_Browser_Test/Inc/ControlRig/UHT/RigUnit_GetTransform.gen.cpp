...
class UScriptStruct* FRigUnit_GetTransform::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_GetTransform.OuterSingleton)
	{
		...
		Arguments_FRigUnit_GetTransform_Execute.Emplace(TEXT("Space"), TEXT("EBoneGetterSetterMode"));
		...
		Arguments_FRigUnit_GetTransform_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetTransform_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_GetTransform, Space), Z_Construct_UEnum_ControlRig_EBoneGetterSetterMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetTransform_Statics::NewProp_Space_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetTransform_Statics::NewProp_Space_MetaData)) }; // 899847808
#if WITH_METADATA
...
class UScriptStruct* FRigUnit_GetTransformArray::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_GetTransformArray.OuterSingleton)
	{
		...
		Arguments_FRigUnit_GetTransformArray_Execute.Emplace(TEXT("Space"), TEXT("EBoneGetterSetterMode"));
		...
		Arguments_FRigUnit_GetTransformArray_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetTransformArray_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_GetTransformArray, Space), Z_Construct_UEnum_ControlRig_EBoneGetterSetterMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetTransformArray_Statics::NewProp_Space_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetTransformArray_Statics::NewProp_Space_MetaData)) }; // 899847808
#if WITH_METADATA
...
class UScriptStruct* FRigUnit_GetTransformItemArray::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_GetTransformItemArray.OuterSingleton)
	{
		...
		Arguments_FRigUnit_GetTransformItemArray_Execute.Emplace(TEXT("Space"), TEXT("EBoneGetterSetterMode"));
		...
		Arguments_FRigUnit_GetTransformItemArray_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_GetTransformItemArray::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_GetTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetTransform_Statics::NewStructOps, TEXT("RigUnit_GetTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_GetTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetTransform), 911293022U) },
		{ FRigUnit_GetTransformArray::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetTransformArray_Statics::NewStructOps, TEXT("RigUnit_GetTransformArray"), &Z_Registration_Info_UScriptStruct_RigUnit_GetTransformArray, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetTransformArray), 347642914U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetTransform_h_757353325(TEXT("/Script/ControlRig"),
		nullptr, 0,
