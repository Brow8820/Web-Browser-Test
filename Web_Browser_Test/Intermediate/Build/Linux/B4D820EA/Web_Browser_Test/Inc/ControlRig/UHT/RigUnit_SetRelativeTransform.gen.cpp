...
class UScriptStruct* FRigUnit_SetRelativeTransformForItem::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetRelativeTransformForItem.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetRelativeTransformForItem_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetRelativeTransformForItem_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_SetRelativeTranslationForItem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_SetRelativeTranslationForItem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_SetRelativeTranslationForItem, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_SetRelativeTranslationForItem"));
		...
		Arguments_FRigUnit_SetRelativeTranslationForItem_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetRelativeTranslationForItem_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_SetRelativeTranslationForItem::Execute(const FRigUnitContext & Context)
{
	FRigVMExecuteContext RigVMExecuteContext;
	StaticExecute(
		RigVMExecuteContext,
...
class UScriptStruct* FRigUnit_SetRelativeRotationForItem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_SetRelativeRotationForItem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_SetRelativeRotationForItem, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_SetRelativeRotationForItem"));
		...
		Arguments_FRigUnit_SetRelativeRotationForItem_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetRelativeRotationForItem_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_SetRelativeRotationForItem::Execute(const FRigUnitContext & Context)
{
	FRigVMExecuteContext RigVMExecuteContext;
	StaticExecute(
		RigVMExecuteContext,
