...
class UScriptStruct* FRigPreferredEulerAngles::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigPreferredEulerAngles.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigPreferredEulerAngles, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigPreferredEulerAngles"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigHierarchyCopyPasteContent>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigHierarchyElements_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigControlSettings::StaticStruct, Z_Construct_UScriptStruct_FRigControlSettings_Statics::NewStructOps, TEXT("RigControlSettings"), &Z_Registration_Info_UScriptStruct_RigControlSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigControlSettings), 2634395611U) },
		{ FRigControlElement::StaticStruct, Z_Construct_UScriptStruct_FRigControlElement_Statics::NewStructOps, TEXT("RigControlElement"), &Z_Registration_Info_UScriptStruct_RigControlElement, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigControlElement), 444095642U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigHierarchyElements_h_2106897231(TEXT("/Script/ControlRig"),
		nullptr, 0,
