...
class UScriptStruct* FRigUnit_GetControlBool::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_GetControlBool.OuterSingleton)
	{
		...
		Arguments_FRigUnit_GetControlBool_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_GetControlFloat::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_GetControlFloat.OuterSingleton)
	{
		...
		Arguments_FRigUnit_GetControlFloat_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_GetControlInteger::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_GetControlInteger.OuterSingleton)
	{
		...
		Arguments_FRigUnit_GetControlInteger_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_GetControlVector2D::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_GetControlVector2D.OuterSingleton)
	{
		...
		Arguments_FRigUnit_GetControlVector2D_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_GetControlVector::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_GetControlVector.OuterSingleton)
	{
		...
		Arguments_FRigUnit_GetControlVector_Execute.Emplace(TEXT("Space"), TEXT("EBoneGetterSetterMode"));
		...
		Arguments_FRigUnit_GetControlVector_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetControlVector_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_GetControlVector, Space), Z_Construct_UEnum_ControlRig_EBoneGetterSetterMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetControlVector_Statics::NewProp_Space_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetControlVector_Statics::NewProp_Space_MetaData)) }; // 899847808
#if WITH_METADATA
...
class UScriptStruct* FRigUnit_GetControlRotator::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_GetControlRotator.OuterSingleton)
	{
		...
		Arguments_FRigUnit_GetControlRotator_Execute.Emplace(TEXT("Space"), TEXT("EBoneGetterSetterMode"));
		...
		Arguments_FRigUnit_GetControlRotator_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetControlRotator_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_GetControlRotator, Space), Z_Construct_UEnum_ControlRig_EBoneGetterSetterMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetControlRotator_Statics::NewProp_Space_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetControlRotator_Statics::NewProp_Space_MetaData)) }; // 899847808
#if WITH_METADATA
...
class UScriptStruct* FRigUnit_GetControlTransform::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_GetControlTransform.OuterSingleton)
	{
		...
		Arguments_FRigUnit_GetControlTransform_Execute.Emplace(TEXT("Space"), TEXT("EBoneGetterSetterMode"));
		...
		Arguments_FRigUnit_GetControlTransform_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_GetControlTransform::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetControlTransform_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_GetControlVector::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetControlVector_Statics::NewStructOps, TEXT("RigUnit_GetControlVector"), &Z_Registration_Info_UScriptStruct_RigUnit_GetControlVector, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetControlVector), 3596261525U) },
		{ FRigUnit_GetControlRotator::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetControlRotator_Statics::NewStructOps, TEXT("RigUnit_GetControlRotator"), &Z_Registration_Info_UScriptStruct_RigUnit_GetControlRotator, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetControlRotator), 992021545U) },
		{ FRigUnit_GetControlTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetControlTransform_Statics::NewStructOps, TEXT("RigUnit_GetControlTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_GetControlTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetControlTransform), 855398897U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetControlTransform_h_381630267(TEXT("/Script/ControlRig"),
		nullptr, 0,
