...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FCRSimSoftCollision>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Math_Simulation_CRSimSoftCollision_h_Statics::ScriptStructInfo[] = {
		{ FCRSimSoftCollision::StaticStruct, Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewStructOps, TEXT("CRSimSoftCollision"), &Z_Registration_Info_UScriptStruct_CRSimSoftCollision, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCRSimSoftCollision), 947874629U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Math_Simulation_CRSimSoftCollision_h_1967862441(TEXT("/Script/ControlRig"),
		nullptr, 0,
