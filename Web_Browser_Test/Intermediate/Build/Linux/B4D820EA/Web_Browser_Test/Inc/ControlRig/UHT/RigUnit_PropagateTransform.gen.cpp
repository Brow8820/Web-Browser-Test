...
class UScriptStruct* FRigUnit_PropagateTransform::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_PropagateTransform.OuterSingleton)
	{
		...
		Arguments_FRigUnit_PropagateTransform_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_PropagateTransform_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
