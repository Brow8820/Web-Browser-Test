...
class UScriptStruct* FRigUnit_GetBoneTransform::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_GetBoneTransform.OuterSingleton)
	{
		...
		Arguments_FRigUnit_GetBoneTransform_Execute.Emplace(TEXT("Space"), TEXT("EBoneGetterSetterMode"));
		...
		Arguments_FRigUnit_GetBoneTransform_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetBoneTransform_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_GetBoneTransform, Space), Z_Construct_UEnum_ControlRig_EBoneGetterSetterMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetBoneTransform_Statics::NewProp_Space_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetBoneTransform_Statics::NewProp_Space_MetaData)) }; // 899847808
#if WITH_METADATA
...
void FRigUnit_GetBoneTransform::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetBoneTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_GetBoneTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetBoneTransform_Statics::NewStructOps, TEXT("RigUnit_GetBoneTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_GetBoneTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetBoneTransform), 930031087U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetBoneTransform_h_225711810(TEXT("/Script/ControlRig"),
		nullptr, 0,
