...
class UScriptStruct* FRigUnit_CollectionChain::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionChain.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionChain_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionChainArray::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionChainArray.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionChainArray_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionNameSearch::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionNameSearch.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionNameSearch_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionNameSearchArray::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionNameSearchArray.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionNameSearchArray_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionChildren::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionChildren.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionChildren_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionChildrenArray::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionChildrenArray.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionChildrenArray_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionGetAll::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_CollectionGetAll.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_CollectionGetAll, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_CollectionGetAll"));
		...
		Arguments_FRigUnit_CollectionGetAll_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_CollectionGetAll::Execute(const FRigUnitContext & Context)
{
	FRigVMExecuteContext RigVMExecuteContext;
	StaticExecute(
		RigVMExecuteContext,
...
class UScriptStruct* FRigUnit_CollectionReplaceItems::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionReplaceItems.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionReplaceItems_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionReplaceItemsArray::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionReplaceItemsArray.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionReplaceItemsArray_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionItems::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionItems.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionItems_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionGetItems::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionGetItems.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionGetItems_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionGetParentIndices::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionGetParentIndices.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionGetParentIndices_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionGetParentIndicesItemArray::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionGetParentIndicesItemArray.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionGetParentIndicesItemArray_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionUnion::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionUnion.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionUnion_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionIntersection::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionIntersection.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionIntersection_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionDifference::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionDifference.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionDifference_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionReverse::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionReverse.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionReverse_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionCount::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionCount.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionCount_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionItemAtIndex::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionItemAtIndex.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionItemAtIndex_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_CollectionLoop::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionLoop.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionLoop_Execute.Emplace(TEXT("Continue"), TEXT("bool"));
		Arguments_FRigUnit_CollectionLoop_Execute.Emplace(TEXT("Completed"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_CollectionLoop_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_CollectionLoop_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_CollectionLoop>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_CollectionLoop_Statics::NewProp_Continue = { "Continue", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FRigUnit_CollectionLoop), &Z_Construct_UScriptStruct_FRigUnit_CollectionLoop_Statics::NewProp_Continue_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_CollectionLoop_Statics::NewProp_Continue_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_CollectionLoop_Statics::NewProp_Continue_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FRigUnit_CollectionAddItem::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_CollectionAddItem.OuterSingleton)
	{
		...
		Arguments_FRigUnit_CollectionAddItem_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_CollectionAddItem::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_Collection_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_CollectionLoop::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_CollectionLoop_Statics::NewStructOps, TEXT("RigUnit_CollectionLoop"), &Z_Registration_Info_UScriptStruct_RigUnit_CollectionLoop, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_CollectionLoop), 970396135U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_Collection_h_915953814(TEXT("/Script/ControlRig"),
		nullptr, 0,
