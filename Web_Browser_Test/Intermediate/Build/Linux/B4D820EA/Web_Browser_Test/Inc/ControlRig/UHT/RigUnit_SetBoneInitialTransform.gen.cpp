...
class UScriptStruct* FRigUnit_SetBoneInitialTransform::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetBoneInitialTransform.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetBoneInitialTransform_Execute.Emplace(TEXT("Space"), TEXT("EBoneGetterSetterMode"));
		...
		Arguments_FRigUnit_SetBoneInitialTransform_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetBoneInitialTransform_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetBoneInitialTransform_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_SetBoneInitialTransform, Space), Z_Construct_UEnum_ControlRig_EBoneGetterSetterMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SetBoneInitialTransform_Statics::NewProp_Space_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetBoneInitialTransform_Statics::NewProp_Space_MetaData)) }; // 899847808
#if WITH_METADATA
...
void FRigUnit_SetBoneInitialTransform::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetBoneInitialTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_SetBoneInitialTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetBoneInitialTransform_Statics::NewStructOps, TEXT("RigUnit_SetBoneInitialTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_SetBoneInitialTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetBoneInitialTransform), 1211114079U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetBoneInitialTransform_h_2353150840(TEXT("/Script/ControlRig"),
		nullptr, 0,
