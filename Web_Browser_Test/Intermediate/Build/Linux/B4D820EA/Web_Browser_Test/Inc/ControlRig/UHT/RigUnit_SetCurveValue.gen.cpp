...
class UScriptStruct* FRigUnit_SetCurveValue::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetCurveValue.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetCurveValue_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetCurveValue_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
