...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnitMutable>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_RigUnit_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_Statics::NewStructOps, TEXT("RigUnit"), &Z_Registration_Info_UScriptStruct_RigUnit, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit), 174642725U) },
		{ FRigUnitMutable::StaticStruct, Z_Construct_UScriptStruct_FRigUnitMutable_Statics::NewStructOps, TEXT("RigUnitMutable"), &Z_Registration_Info_UScriptStruct_RigUnitMutable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnitMutable), 3308058541U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_RigUnit_h_162035025(TEXT("/Script/ControlRig"),
		nullptr, 0,
