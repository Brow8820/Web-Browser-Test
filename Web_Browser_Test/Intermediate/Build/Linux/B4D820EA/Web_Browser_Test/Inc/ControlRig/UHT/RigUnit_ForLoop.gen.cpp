...
class UScriptStruct* FRigUnit_ForLoopCount::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_ForLoopCount.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_ForLoopCount_Execute;
		Arguments_FRigUnit_ForLoopCount_Execute.Emplace(TEXT("Count"), TEXT("int32"));
		Arguments_FRigUnit_ForLoopCount_Execute.Emplace(TEXT("Index"), TEXT("int32"));
		Arguments_FRigUnit_ForLoopCount_Execute.Emplace(TEXT("Ratio"), TEXT("float"));
		Arguments_FRigUnit_ForLoopCount_Execute.Emplace(TEXT("Continue"), TEXT("bool"));
		Arguments_FRigUnit_ForLoopCount_Execute.Emplace(TEXT("Completed"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_ForLoopCount_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_ForLoopCount_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_ForLoopCount::Execute"), &FRigUnit_ForLoopCount::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_ForLoopCount.OuterSingleton, Arguments_FRigUnit_ForLoopCount_Execute);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_ForLoopCount>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_ForLoopCount_Statics::NewProp_Count = { "Count", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_ForLoopCount, Count), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ForLoopCount_Statics::NewProp_Count_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ForLoopCount_Statics::NewProp_Count_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigUnit_ForLoopCount_Statics::NewProp_Index = { "Index", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_ForLoopCount, Index), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ForLoopCount_Statics::NewProp_Index_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ForLoopCount_Statics::NewProp_Index_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_ForLoopCount_Statics::NewProp_Continue = { "Continue", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FRigUnit_ForLoopCount), &Z_Construct_UScriptStruct_FRigUnit_ForLoopCount_Statics::NewProp_Continue_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ForLoopCount_Statics::NewProp_Continue_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ForLoopCount_Statics::NewProp_Continue_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_ForLoopCount_Statics::NewProp_Completed = { "Completed", nullptr, (EPropertyFlags)0x0010000000002015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_ForLoopCount, Completed), Z_Construct_UScriptStruct_FControlRigExecuteContext, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ForLoopCount_Statics::NewProp_Completed_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ForLoopCount_Statics::NewProp_Completed_MetaData)) }; // 1688564855
...
void FRigUnit_ForLoopCount::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_ForLoop_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_ForLoopCount::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_ForLoopCount_Statics::NewStructOps, TEXT("RigUnit_ForLoopCount"), &Z_Registration_Info_UScriptStruct_RigUnit_ForLoopCount, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_ForLoopCount), 2930183233U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_ForLoop_h_2915830259(TEXT("/Script/ControlRig"),
		nullptr, 0,
