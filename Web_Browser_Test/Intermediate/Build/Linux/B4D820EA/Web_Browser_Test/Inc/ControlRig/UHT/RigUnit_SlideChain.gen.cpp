...
class UScriptStruct* FRigUnit_SlideChain::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SlideChain.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SlideChain_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SlideChain_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_SlideChainPerItem::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SlideChainPerItem.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SlideChainPerItem_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SlideChainPerItem_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_SlideChainItemArray::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SlideChainItemArray.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SlideChainItemArray_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SlideChainItemArray_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
