...
class UScriptStruct* FRigUnit_BoneHarmonics::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_BoneHarmonics.OuterSingleton)
	{
		...
		Arguments_FRigUnit_BoneHarmonics_Execute.Emplace(TEXT("WaveEase"), TEXT("EControlRigAnimEasingType"));
		...
		Arguments_FRigUnit_BoneHarmonics_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_BoneHarmonics_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_ItemHarmonics::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_ItemHarmonics.OuterSingleton)
	{
		...
		Arguments_FRigUnit_ItemHarmonics_Execute.Emplace(TEXT("WaveEase"), TEXT("EControlRigAnimEasingType"));
		...
		Arguments_FRigUnit_ItemHarmonics_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_ItemHarmonics_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_ItemHarmonics_Statics::NewProp_WaveEase = { "WaveEase", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_ItemHarmonics, WaveEase), Z_Construct_UEnum_ControlRig_EControlRigAnimEasingType, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ItemHarmonics_Statics::NewProp_WaveEase_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ItemHarmonics_Statics::NewProp_WaveEase_MetaData)) }; // 3463141811
#if WITH_METADATA
...
void FRigUnit_ItemHarmonics::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Highlevel_Harmonics_RigUnit_BoneHarmonics_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_BoneHarmonics::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_BoneHarmonics_Statics::NewStructOps, TEXT("RigUnit_BoneHarmonics"), &Z_Registration_Info_UScriptStruct_RigUnit_BoneHarmonics, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_BoneHarmonics), 1697873110U) },
		{ FRigUnit_ItemHarmonics::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_ItemHarmonics_Statics::NewStructOps, TEXT("RigUnit_ItemHarmonics"), &Z_Registration_Info_UScriptStruct_RigUnit_ItemHarmonics, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_ItemHarmonics), 388724684U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Highlevel_Harmonics_RigUnit_BoneHarmonics_h_1123409289(TEXT("/Script/ControlRig"),
		nullptr, 0,
