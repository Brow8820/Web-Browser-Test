...
class UScriptStruct* FRigUnit_DistributeRotation::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_DistributeRotation.OuterSingleton)
	{
		...
		Arguments_FRigUnit_DistributeRotation_Execute.Emplace(TEXT("RotationEaseType"), TEXT("EControlRigAnimEasingType"));
		...
		Arguments_FRigUnit_DistributeRotation_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_DistributeRotation_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_DistributeRotationForCollection::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_DistributeRotationForCollection.OuterSingleton)
	{
		...
		Arguments_FRigUnit_DistributeRotationForCollection_Execute.Emplace(TEXT("RotationEaseType"), TEXT("EControlRigAnimEasingType"));
		...
		Arguments_FRigUnit_DistributeRotationForCollection_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_DistributeRotationForCollection_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_DistributeRotationForItemArray::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_DistributeRotationForItemArray.OuterSingleton)
	{
		...
		Arguments_FRigUnit_DistributeRotationForItemArray_Execute.Emplace(TEXT("RotationEaseType"), TEXT("EControlRigAnimEasingType"));
		...
		Arguments_FRigUnit_DistributeRotationForItemArray_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_DistributeRotationForItemArray_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_DistributeRotationForItemArray::Execute(const FRigUnitContext & Context)
{
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Highlevel_Hierarchy_RigUnit_DistributeRotation_h_2325382905(TEXT("/Script/ControlRig"),
		nullptr, 0,
