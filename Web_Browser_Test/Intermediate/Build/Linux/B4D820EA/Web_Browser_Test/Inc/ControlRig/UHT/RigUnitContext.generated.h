...
#define FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_RigUnitContext_h_44_GENERATED_BODY \
...
template<> struct TIsUEnumClass<EControlRigState> { enum { Value = true }; };
