...
class UScriptStruct* FRigUnit_PrepareForExecution::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_PrepareForExecution.OuterSingleton)
	{
		...
		Arguments_FRigUnit_PrepareForExecution_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_PrepareForExecution_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_PrepareForExecution::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_PrepareForExecution_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_PrepareForExecution::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_PrepareForExecution_Statics::NewStructOps, TEXT("RigUnit_PrepareForExecution"), &Z_Registration_Info_UScriptStruct_RigUnit_PrepareForExecution, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_PrepareForExecution), 2831540081U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_PrepareForExecution_h_2842085593(TEXT("/Script/ControlRig"),
		nullptr, 0,
