...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FControlRigControlPose>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UControlRigPoseAsset_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UControlRigPoseAsset_GetCurrentPose, "GetCurrentPose" }, // 633616471
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Tools_ControlRigPose_h_Statics::ScriptStructInfo[] = {
		{ FRigControlCopy::StaticStruct, Z_Construct_UScriptStruct_FRigControlCopy_Statics::NewStructOps, TEXT("RigControlCopy"), &Z_Registration_Info_UScriptStruct_RigControlCopy, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigControlCopy), 483856857U) },
		{ FControlRigControlPose::StaticStruct, Z_Construct_UScriptStruct_FControlRigControlPose_Statics::NewStructOps, TEXT("ControlRigControlPose"), &Z_Registration_Info_UScriptStruct_ControlRigControlPose, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FControlRigControlPose), 3433674435U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Tools_ControlRigPose_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UControlRigPoseAsset, UControlRigPoseAsset::StaticClass, TEXT("UControlRigPoseAsset"), &Z_Registration_Info_UClass_UControlRigPoseAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UControlRigPoseAsset), 3595257686U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Tools_ControlRigPose_h_1182394111(TEXT("/Script/ControlRig"),
