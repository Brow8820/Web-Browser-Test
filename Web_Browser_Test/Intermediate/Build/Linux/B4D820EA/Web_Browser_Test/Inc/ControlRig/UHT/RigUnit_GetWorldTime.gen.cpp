...
class UScriptStruct* FRigUnit_GetWorldTime::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_GetWorldTime.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_GetWorldTime_Execute;
		Arguments_FRigUnit_GetWorldTime_Execute.Emplace(TEXT("Year"), TEXT("float"));
		Arguments_FRigUnit_GetWorldTime_Execute.Emplace(TEXT("Month"), TEXT("float"));
		Arguments_FRigUnit_GetWorldTime_Execute.Emplace(TEXT("Day"), TEXT("float"));
		Arguments_FRigUnit_GetWorldTime_Execute.Emplace(TEXT("WeekDay"), TEXT("float"));
		Arguments_FRigUnit_GetWorldTime_Execute.Emplace(TEXT("Hours"), TEXT("float"));
		Arguments_FRigUnit_GetWorldTime_Execute.Emplace(TEXT("Minutes"), TEXT("float"));
		Arguments_FRigUnit_GetWorldTime_Execute.Emplace(TEXT("Seconds"), TEXT("float"));
		Arguments_FRigUnit_GetWorldTime_Execute.Emplace(TEXT("OverallSeconds"), TEXT("float"));
		Arguments_FRigUnit_GetWorldTime_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_GetWorldTime::Execute"), &FRigUnit_GetWorldTime::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_GetWorldTime.OuterSingleton, Arguments_FRigUnit_GetWorldTime_Execute);
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Year = { "Year", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_GetWorldTime, Year), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Year_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Year_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Month = { "Month", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_GetWorldTime, Month), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Month_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Month_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Day = { "Day", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_GetWorldTime, Day), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Day_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Day_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_WeekDay = { "WeekDay", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_GetWorldTime, WeekDay), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_WeekDay_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_WeekDay_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Hours = { "Hours", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_GetWorldTime, Hours), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Hours_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Hours_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Minutes = { "Minutes", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_GetWorldTime, Minutes), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Minutes_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Minutes_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Seconds = { "Seconds", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_GetWorldTime, Seconds), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Seconds_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_Seconds_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_OverallSeconds = { "OverallSeconds", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_GetWorldTime, OverallSeconds), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_OverallSeconds_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewProp_OverallSeconds_MetaData)) };
...
void FRigUnit_GetWorldTime::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Animation_RigUnit_GetWorldTime_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_GetWorldTime::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetWorldTime_Statics::NewStructOps, TEXT("RigUnit_GetWorldTime"), &Z_Registration_Info_UScriptStruct_RigUnit_GetWorldTime, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetWorldTime), 4187520343U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Animation_RigUnit_GetWorldTime_h_459173053(TEXT("/Script/ControlRig"),
		nullptr, 0,
