...
class UScriptStruct* FControlRigAnimNodeEventName::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ControlRigAnimNodeEventName.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FControlRigAnimNodeEventName, Z_Construct_UPackage__Script_ControlRig(), TEXT("ControlRigAnimNodeEventName"));
	}
