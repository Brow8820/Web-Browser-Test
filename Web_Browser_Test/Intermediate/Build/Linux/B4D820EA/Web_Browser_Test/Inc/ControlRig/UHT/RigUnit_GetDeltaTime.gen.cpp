...
class UScriptStruct* FRigUnit_GetDeltaTime::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_GetDeltaTime.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_GetDeltaTime_Execute;
		Arguments_FRigUnit_GetDeltaTime_Execute.Emplace(TEXT("Result"), TEXT("float"));
		Arguments_FRigUnit_GetDeltaTime_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_GetDeltaTime::Execute"), &FRigUnit_GetDeltaTime::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_GetDeltaTime.OuterSingleton, Arguments_FRigUnit_GetDeltaTime_Execute);
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetDeltaTime_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_GetDeltaTime, Result), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetDeltaTime_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetDeltaTime_Statics::NewProp_Result_MetaData)) };
...
void FRigUnit_GetDeltaTime::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Animation_RigUnit_GetDeltaTime_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_GetDeltaTime::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetDeltaTime_Statics::NewStructOps, TEXT("RigUnit_GetDeltaTime"), &Z_Registration_Info_UScriptStruct_RigUnit_GetDeltaTime, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetDeltaTime), 1707028392U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Animation_RigUnit_GetDeltaTime_h_3777987681(TEXT("/Script/ControlRig"),
		nullptr, 0,
