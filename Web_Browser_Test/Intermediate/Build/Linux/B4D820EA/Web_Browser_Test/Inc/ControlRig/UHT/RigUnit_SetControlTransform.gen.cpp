...
class UScriptStruct* FRigUnit_SetControlBool::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetControlBool.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetControlBool_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetControlBool_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_SetMultiControlBool::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetMultiControlBool.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetMultiControlBool_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetMultiControlBool_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_SetControlFloat::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetControlFloat.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetControlFloat_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetControlFloat_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_SetMultiControlFloat::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetMultiControlFloat.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetMultiControlFloat_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetMultiControlFloat_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_SetControlInteger::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetControlInteger.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetControlInteger_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetControlInteger_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_SetMultiControlInteger::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetMultiControlInteger.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetMultiControlInteger_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetMultiControlInteger_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_SetControlVector2D::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetControlVector2D.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetControlVector2D_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetControlVector2D_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_SetMultiControlVector2D::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetMultiControlVector2D.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetMultiControlVector2D_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetMultiControlVector2D_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_SetControlVector::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetControlVector.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetControlVector_Execute.Emplace(TEXT("Space"), TEXT("EBoneGetterSetterMode"));
		Arguments_FRigUnit_SetControlVector_Execute.Emplace(TEXT("CachedControlIndex"), TEXT("FCachedRigElement"));
		Arguments_FRigUnit_SetControlVector_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetControlVector_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_SetControlRotator::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetControlRotator.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetControlRotator_Execute.Emplace(TEXT("Space"), TEXT("EBoneGetterSetterMode"));
		Arguments_FRigUnit_SetControlRotator_Execute.Emplace(TEXT("CachedControlIndex"), TEXT("FCachedRigElement"));
		Arguments_FRigUnit_SetControlRotator_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetControlRotator_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetControlRotator_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_SetControlRotator, Space), Z_Construct_UEnum_ControlRig_EBoneGetterSetterMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SetControlRotator_Statics::NewProp_Space_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetControlRotator_Statics::NewProp_Space_MetaData)) }; // 899847808
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetMultiControlRotator_Entry_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_SetMultiControlRotator_Entry, Space), Z_Construct_UEnum_ControlRig_EBoneGetterSetterMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SetMultiControlRotator_Entry_Statics::NewProp_Space_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetMultiControlRotator_Entry_Statics::NewProp_Space_MetaData)) }; // 899847808
...
class UScriptStruct* FRigUnit_SetMultiControlRotator::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetMultiControlRotator.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetMultiControlRotator_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetMultiControlRotator_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_SetMultiControlRotator>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetMultiControlRotator_Statics::NewProp_Entries_Inner = { "Entries", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FRigUnit_SetMultiControlRotator_Entry, METADATA_PARAMS(nullptr, 0) }; // 4179534161
#if WITH_METADATA
...
class UScriptStruct* FRigUnit_SetControlTransform::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetControlTransform.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetControlTransform_Execute.Emplace(TEXT("Space"), TEXT("EBoneGetterSetterMode"));
		Arguments_FRigUnit_SetControlTransform_Execute.Emplace(TEXT("CachedControlIndex"), TEXT("FCachedRigElement"));
		Arguments_FRigUnit_SetControlTransform_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetControlTransform_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetControlTransform_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_SetControlTransform, Space), Z_Construct_UEnum_ControlRig_EBoneGetterSetterMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SetControlTransform_Statics::NewProp_Space_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetControlTransform_Statics::NewProp_Space_MetaData)) }; // 899847808
#if WITH_METADATA
...
void FRigUnit_SetControlTransform::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetControlTransform_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_SetControlVector::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetControlVector_Statics::NewStructOps, TEXT("RigUnit_SetControlVector"), &Z_Registration_Info_UScriptStruct_RigUnit_SetControlVector, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetControlVector), 3382691800U) },
		...
		{ FRigUnit_SetMultiControlRotator_Entry::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetMultiControlRotator_Entry_Statics::NewStructOps, TEXT("RigUnit_SetMultiControlRotator_Entry"), &Z_Registration_Info_UScriptStruct_RigUnit_SetMultiControlRotator_Entry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetMultiControlRotator_Entry), 4179534161U) },
		{ FRigUnit_SetMultiControlRotator::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetMultiControlRotator_Statics::NewStructOps, TEXT("RigUnit_SetMultiControlRotator"), &Z_Registration_Info_UScriptStruct_RigUnit_SetMultiControlRotator, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetMultiControlRotator), 285467907U) },
		{ FRigUnit_SetControlTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetControlTransform_Statics::NewStructOps, TEXT("RigUnit_SetControlTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_SetControlTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetControlTransform), 772160772U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetControlTransform_h_449221488(TEXT("/Script/ControlRig"),
		nullptr, 0,
