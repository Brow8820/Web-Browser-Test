...
#include "ControlRig/Private/Units/Hierarchy/RigUnit_UnsetCurveValue.h"
...
class UScriptStruct* FRigUnit_UnsetCurveValue::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_UnsetCurveValue.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_UnsetCurveValue, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_UnsetCurveValue"));
		...
		Arguments_FRigUnit_UnsetCurveValue_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_UnsetCurveValue_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_UnsetCurveValue::Execute(const FRigUnitContext & Context)
{
