...
class UScriptStruct* FRigUnit_FramesToSeconds::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_FramesToSeconds.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_FramesToSeconds_Execute;
		Arguments_FRigUnit_FramesToSeconds_Execute.Emplace(TEXT("Frames"), TEXT("float"));
		Arguments_FRigUnit_FramesToSeconds_Execute.Emplace(TEXT("Seconds"), TEXT("float"));
		Arguments_FRigUnit_FramesToSeconds_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_FramesToSeconds::Execute"), &FRigUnit_FramesToSeconds::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_FramesToSeconds.OuterSingleton, Arguments_FRigUnit_FramesToSeconds_Execute);
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_FramesToSeconds_Statics::NewProp_Frames = { "Frames", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_FramesToSeconds, Frames), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_FramesToSeconds_Statics::NewProp_Frames_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_FramesToSeconds_Statics::NewProp_Frames_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_FramesToSeconds_Statics::NewProp_Seconds = { "Seconds", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_FramesToSeconds, Seconds), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_FramesToSeconds_Statics::NewProp_Seconds_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_FramesToSeconds_Statics::NewProp_Seconds_MetaData)) };
...
class UScriptStruct* FRigUnit_SecondsToFrames::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SecondsToFrames.OuterSingleton)
	{
		...
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_SecondsToFrames_Execute;
		Arguments_FRigUnit_SecondsToFrames_Execute.Emplace(TEXT("Seconds"), TEXT("float"));
		Arguments_FRigUnit_SecondsToFrames_Execute.Emplace(TEXT("Frames"), TEXT("float"));
		Arguments_FRigUnit_SecondsToFrames_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_SecondsToFrames::Execute"), &FRigUnit_SecondsToFrames::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_SecondsToFrames.OuterSingleton, Arguments_FRigUnit_SecondsToFrames_Execute);
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_SecondsToFrames_Statics::NewProp_Seconds = { "Seconds", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_SecondsToFrames, Seconds), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SecondsToFrames_Statics::NewProp_Seconds_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SecondsToFrames_Statics::NewProp_Seconds_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_SecondsToFrames_Statics::NewProp_Frames = { "Frames", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_SecondsToFrames, Frames), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SecondsToFrames_Statics::NewProp_Frames_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SecondsToFrames_Statics::NewProp_Frames_MetaData)) };
...
void FRigUnit_SecondsToFrames::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Animation_RigUnit_TimeConversion_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_FramesToSeconds::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_FramesToSeconds_Statics::NewStructOps, TEXT("RigUnit_FramesToSeconds"), &Z_Registration_Info_UScriptStruct_RigUnit_FramesToSeconds, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_FramesToSeconds), 2855213047U) },
		{ FRigUnit_SecondsToFrames::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SecondsToFrames_Statics::NewStructOps, TEXT("RigUnit_SecondsToFrames"), &Z_Registration_Info_UScriptStruct_RigUnit_SecondsToFrames, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SecondsToFrames), 878765002U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Animation_RigUnit_TimeConversion_h_3858530104(TEXT("/Script/ControlRig"),
		nullptr, 0,
