...
class UScriptStruct* FRigUnit_ApplyFK::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_ApplyFK.OuterSingleton)
	{
		...
		Arguments_FRigUnit_ApplyFK_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_ApplyFK_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_ApplyFK::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Deprecated_RigUnit_ApplyFK_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_ApplyFK::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_ApplyFK_Statics::NewStructOps, TEXT("RigUnit_ApplyFK"), &Z_Registration_Info_UScriptStruct_RigUnit_ApplyFK, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_ApplyFK), 1006583118U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Deprecated_RigUnit_ApplyFK_h_3576195585(TEXT("/Script/ControlRig"),
		nullptr, 0,
