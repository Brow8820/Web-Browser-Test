...
class UScriptStruct* FRigUnit_SequenceExecution::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SequenceExecution.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SequenceExecution_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SequenceExecution_Execute.Emplace(TEXT("A"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SequenceExecution_Execute.Emplace(TEXT("B"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SequenceExecution_Execute.Emplace(TEXT("C"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SequenceExecution_Execute.Emplace(TEXT("D"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SequenceExecution_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_SequenceAggregate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_SequenceAggregate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_SequenceAggregate, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_SequenceAggregate"));
		TArray<FRigVMFunctionArgument> Arguments_FRigUnit_SequenceAggregate_Execute;
		Arguments_FRigUnit_SequenceAggregate_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SequenceAggregate_Execute.Emplace(TEXT("A"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SequenceAggregate_Execute.Emplace(TEXT("B"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SequenceAggregate_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_SequenceAggregate::Execute(const FRigUnitContext & Context)
{
	FRigVMExecuteContext RigVMExecuteContext;
	StaticExecute(
		RigVMExecuteContext,
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_SequenceExecution_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_SequenceAggregate::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SequenceAggregate_Statics::NewStructOps, TEXT("RigUnit_SequenceAggregate"), &Z_Registration_Info_UScriptStruct_RigUnit_SequenceAggregate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SequenceAggregate), 1146767168U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_SequenceExecution_h_3291357400(TEXT("/Script/ControlRig"),
		nullptr, 0,
