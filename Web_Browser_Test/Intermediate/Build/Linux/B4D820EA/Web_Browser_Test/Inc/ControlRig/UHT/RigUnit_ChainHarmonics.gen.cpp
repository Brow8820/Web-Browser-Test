...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_ChainHarmonics_Reach_Statics::NewProp_ReachEase = { "ReachEase", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_ChainHarmonics_Reach, ReachEase), Z_Construct_UEnum_ControlRig_EControlRigAnimEasingType, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ChainHarmonics_Reach_Statics::NewProp_ReachEase_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ChainHarmonics_Reach_Statics::NewProp_ReachEase_MetaData)) }; // 3463141811
...
class UScriptStruct* FRigUnit_ChainHarmonics::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_ChainHarmonics.OuterSingleton)
	{
		...
		Arguments_FRigUnit_ChainHarmonics_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_ChainHarmonics_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_ChainHarmonics_Statics::NewProp_Wave = { "Wave", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_ChainHarmonics, Wave), Z_Construct_UScriptStruct_FRigUnit_ChainHarmonics_Wave, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ChainHarmonics_Statics::NewProp_Wave_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ChainHarmonics_Statics::NewProp_Wave_MetaData)) }; // 2030167436
#if WITH_METADATA
...
class UScriptStruct* FRigUnit_ChainHarmonicsPerItem::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_ChainHarmonicsPerItem.OuterSingleton)
	{
		...
		Arguments_FRigUnit_ChainHarmonicsPerItem_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_ChainHarmonicsPerItem_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_ChainHarmonicsPerItem_Statics::NewProp_Wave = { "Wave", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_ChainHarmonicsPerItem, Wave), Z_Construct_UScriptStruct_FRigUnit_ChainHarmonics_Wave, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ChainHarmonicsPerItem_Statics::NewProp_Wave_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ChainHarmonicsPerItem_Statics::NewProp_Wave_MetaData)) }; // 2030167436
#if WITH_METADATA
...
void FRigUnit_ChainHarmonicsPerItem::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Highlevel_Harmonics_RigUnit_ChainHarmonics_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_ChainHarmonics_Wave::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_ChainHarmonics_Wave_Statics::NewStructOps, TEXT("RigUnit_ChainHarmonics_Wave"), &Z_Registration_Info_UScriptStruct_RigUnit_ChainHarmonics_Wave, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_ChainHarmonics_Wave), 2030167436U) },
		{ FRigUnit_ChainHarmonics_Pendulum::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_ChainHarmonics_Pendulum_Statics::NewStructOps, TEXT("RigUnit_ChainHarmonics_Pendulum"), &Z_Registration_Info_UScriptStruct_RigUnit_ChainHarmonics_Pendulum, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_ChainHarmonics_Pendulum), 3069491516U) },
		...
		{ FRigUnit_ChainHarmonics::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_ChainHarmonics_Statics::NewStructOps, TEXT("RigUnit_ChainHarmonics"), &Z_Registration_Info_UScriptStruct_RigUnit_ChainHarmonics, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_ChainHarmonics), 2149337026U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Highlevel_Harmonics_RigUnit_ChainHarmonics_h_2015958889(TEXT("/Script/ControlRig"),
		nullptr, 0,
