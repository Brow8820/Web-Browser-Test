...
#include "ControlRig/Private/Units/Animation/RigUnit_AnimAttribute.h"
...
class UScriptStruct* FRigDispatch_AnimAttributeBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigDispatch_AnimAttributeBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigDispatch_AnimAttributeBase, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigDispatch_AnimAttributeBase"));
	}
...
class UScriptStruct* FRigDispatch_GetAnimAttribute::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigDispatch_GetAnimAttribute.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigDispatch_GetAnimAttribute, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigDispatch_GetAnimAttribute"));
	}
...
class UScriptStruct* FRigDispatch_SetAnimAttribute::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigDispatch_SetAnimAttribute.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigDispatch_SetAnimAttribute, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigDispatch_SetAnimAttribute"));
	}
