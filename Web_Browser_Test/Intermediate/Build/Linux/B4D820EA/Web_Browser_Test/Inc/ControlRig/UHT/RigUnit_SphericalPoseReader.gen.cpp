...
class UScriptStruct* FRigUnit_SphericalPoseReader::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SphericalPoseReader.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SphericalPoseReader_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SphericalPoseReader_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
