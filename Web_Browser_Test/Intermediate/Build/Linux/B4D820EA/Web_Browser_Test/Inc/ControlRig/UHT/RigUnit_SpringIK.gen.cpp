...
class UScriptStruct* FRigUnit_SpringIK::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SpringIK.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SpringIK_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SpringIK_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_SpringIK_Statics::NewProp_WorkData = { "WorkData", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FRigUnit_SpringIK, WorkData), Z_Construct_UScriptStruct_FRigUnit_SpringIK_WorkData, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SpringIK_Statics::NewProp_WorkData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SpringIK_Statics::NewProp_WorkData_MetaData)) }; // 3060424619
...
void FRigUnit_SpringIK::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Highlevel_Hierarchy_RigUnit_SpringIK_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_SpringIK::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SpringIK_Statics::NewStructOps, TEXT("RigUnit_SpringIK"), &Z_Registration_Info_UScriptStruct_RigUnit_SpringIK, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SpringIK), 3426838280U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Highlevel_Hierarchy_RigUnit_SpringIK_h_3195171069(TEXT("/Script/ControlRig"),
		nullptr, 0,
