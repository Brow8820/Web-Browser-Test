...
class UScriptStruct* FRigUnit_BeginExecution::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_BeginExecution.OuterSingleton)
	{
		...
		Arguments_FRigUnit_BeginExecution_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_BeginExecution_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_BeginExecution::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_BeginExecution_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_BeginExecution::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_BeginExecution_Statics::NewStructOps, TEXT("RigUnit_BeginExecution"), &Z_Registration_Info_UScriptStruct_RigUnit_BeginExecution, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_BeginExecution), 1373604284U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_BeginExecution_h_1899052977(TEXT("/Script/ControlRig"),
		nullptr, 0,
