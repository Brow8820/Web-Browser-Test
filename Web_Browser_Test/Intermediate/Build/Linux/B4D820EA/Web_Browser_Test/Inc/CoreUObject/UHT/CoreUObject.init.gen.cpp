...
void EmptyLinkFunctionForGeneratedCodeCoreUObject_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_CoreUObject()
	{
		if (!Z_Registration_Info_UPackage__Script_CoreUObject.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UScriptStruct_FTopLevelAssetPath,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_CoreUObject(Z_Construct_UPackage__Script_CoreUObject, TEXT("/Script/CoreUObject"), Z_Registration_Info_UPackage__Script_CoreUObject, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x2D9179E5, 0x7ECDA956));
