...
class UScriptStruct* FRigUnit_ControlRigSplineFromPoints::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_ControlRigSplineFromPoints.OuterSingleton)
	{
		...
		Arguments_FRigUnit_ControlRigSplineFromPoints_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_SetSplinePoints::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_SetSplinePoints.OuterSingleton)
	{
		...
		Arguments_FRigUnit_SetSplinePoints_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_SetSplinePoints_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_PositionFromControlRigSpline::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_PositionFromControlRigSpline.OuterSingleton)
	{
		...
		Arguments_FRigUnit_PositionFromControlRigSpline_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_TransformFromControlRigSpline::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_TransformFromControlRigSpline.OuterSingleton)
	{
		...
		Arguments_FRigUnit_TransformFromControlRigSpline_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_TangentFromControlRigSpline::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_TangentFromControlRigSpline.OuterSingleton)
	{
		...
		Arguments_FRigUnit_TangentFromControlRigSpline_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_DrawControlRigSpline::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_DrawControlRigSpline.OuterSingleton)
	{
		...
		Arguments_FRigUnit_DrawControlRigSpline_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_DrawControlRigSpline_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_GetLengthControlRigSpline::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_GetLengthControlRigSpline.OuterSingleton)
	{
		...
		Arguments_FRigUnit_GetLengthControlRigSpline_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_FitChainToSplineCurve::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_FitChainToSplineCurve.OuterSingleton)
	{
		...
		Arguments_FRigUnit_FitChainToSplineCurve_Execute.Emplace(TEXT("RotationEaseType"), TEXT("EControlRigAnimEasingType"));
		...
		Arguments_FRigUnit_FitChainToSplineCurve_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_FitChainToSplineCurve_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_FitChainToSplineCurveItemArray::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_FitChainToSplineCurveItemArray.OuterSingleton)
	{
		...
		Arguments_FRigUnit_FitChainToSplineCurveItemArray_Execute.Emplace(TEXT("RotationEaseType"), TEXT("EControlRigAnimEasingType"));
		...
		Arguments_FRigUnit_FitChainToSplineCurveItemArray_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_FitChainToSplineCurveItemArray_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_FitSplineCurveToChain::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_FitSplineCurveToChain.OuterSingleton)
	{
		...
		Arguments_FRigUnit_FitSplineCurveToChain_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_FitSplineCurveToChain_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_FitSplineCurveToChainItemArray::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_FitSplineCurveToChainItemArray.OuterSingleton)
	{
		...
		Arguments_FRigUnit_FitSplineCurveToChainItemArray_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_FitSplineCurveToChainItemArray_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_ClosestParameterFromControlRigSpline::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_ClosestParameterFromControlRigSpline.OuterSingleton)
	{
		...
		Arguments_FRigUnit_ClosestParameterFromControlRigSpline_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
class UScriptStruct* FRigUnit_ParameterAtPercentage::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_ParameterAtPercentage.OuterSingleton)
	{
		...
		Arguments_FRigUnit_ParameterAtPercentage_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_ParameterAtPercentage::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRigSpline_Source_ControlRigSpline_Public_ControlRigSplineUnits_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_FitChainToSplineCurve::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_FitChainToSplineCurve_Statics::NewStructOps, TEXT("RigUnit_FitChainToSplineCurve"), &Z_Registration_Info_UScriptStruct_RigUnit_FitChainToSplineCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_FitChainToSplineCurve), 1618829454U) },
		{ FRigUnit_FitChainToSplineCurveItemArray::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_FitChainToSplineCurveItemArray_Statics::NewStructOps, TEXT("RigUnit_FitChainToSplineCurveItemArray"), &Z_Registration_Info_UScriptStruct_RigUnit_FitChainToSplineCurveItemArray, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_FitChainToSplineCurveItemArray), 2871422106U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRigSpline_Source_ControlRigSpline_Public_ControlRigSplineUnits_h_323295820(TEXT("/Script/ControlRigSpline"),
		nullptr, 0,
