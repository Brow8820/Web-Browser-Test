...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FModularSynthPresetBankEntry>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SynthComponents_EpicSynth1Component_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UModularSynthComponent, UModularSynthComponent::StaticClass, TEXT("UModularSynthComponent"), &Z_Registration_Info_UClass_UModularSynthComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UModularSynthComponent), 3287335053U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SynthComponents_EpicSynth1Component_h_4028674822(TEXT("/Script/Synthesis"),
