...
class UScriptStruct* FSourceEffectConvolutionReverbSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SourceEffectConvolutionReverbSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSourceEffectConvolutionReverbSettings, Z_Construct_UPackage__Script_Synthesis(), TEXT("SourceEffectConvolutionReverbSettings"));
	}
