...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UBrushBinding_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UBrushBinding_GetValue, "GetValue" }, // 564706920
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_BrushBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBrushBinding, UBrushBinding::StaticClass, TEXT("UBrushBinding"), &Z_Registration_Info_UClass_UBrushBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBrushBinding), 3638891196U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_BrushBinding_h_2235075604(TEXT("/Script/UMG"),
