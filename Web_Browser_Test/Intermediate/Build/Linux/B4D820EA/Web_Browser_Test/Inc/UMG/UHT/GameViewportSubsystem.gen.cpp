...
class UScriptStruct* FGameViewportWidgetSlot::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GameViewportWidgetSlot.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGameViewportWidgetSlot, Z_Construct_UPackage__Script_UMG(), TEXT("GameViewportWidgetSlot"));
	}
...
template<> UMG_API UScriptStruct* StaticStruct<FGameViewportWidgetSlot>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Blueprint_GameViewportSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameViewportSubsystem, UGameViewportSubsystem::StaticClass, TEXT("UGameViewportSubsystem"), &Z_Registration_Info_UClass_UGameViewportSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameViewportSubsystem), 2033070405U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Blueprint_GameViewportSubsystem_h_2570753779(TEXT("/Script/UMG"),
