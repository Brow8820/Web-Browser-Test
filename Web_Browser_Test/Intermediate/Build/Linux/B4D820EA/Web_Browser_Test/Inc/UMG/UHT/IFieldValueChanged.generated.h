...
static inline void FFieldValueChangedDynamicDelegate_DelegateWrapper(const FScriptDelegate& FieldValueChangedDynamicDelegate, UObject* Object, FFieldNotificationId Field) \
{ \
...
#define FID_Engine_Source_Runtime_UMG_Public_FieldNotification_IFieldValueChanged_h_19_ENHANCED_CONSTRUCTORS \
	/** Standard constructor, called after all reflected properties have been initialized */ \
	UMG_API UNotifyFieldValueChanged(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()) : Super(ObjectInitializer) { }; \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	UMG_API UNotifyFieldValueChanged(UNotifyFieldValueChanged&&); \
	UMG_API UNotifyFieldValueChanged(const UNotifyFieldValueChanged&); \
