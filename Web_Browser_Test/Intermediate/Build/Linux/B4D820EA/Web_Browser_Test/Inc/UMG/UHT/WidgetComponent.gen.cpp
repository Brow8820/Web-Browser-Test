...
template<> UMG_API UScriptStruct* StaticStruct<FWidgetComponentInstanceData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_WidgetComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWidgetComponent, UWidgetComponent::StaticClass, TEXT("UWidgetComponent"), &Z_Registration_Info_UClass_UWidgetComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWidgetComponent), 4167490923U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_WidgetComponent_h_13374001(TEXT("/Script/UMG"),
