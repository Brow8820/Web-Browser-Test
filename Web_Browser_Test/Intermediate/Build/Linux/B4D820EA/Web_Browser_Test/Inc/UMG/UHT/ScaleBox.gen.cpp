...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UScaleBox_Statics::NewProp_StretchDirection = { "StretchDirection", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UScaleBox, StretchDirection), Z_Construct_UEnum_Slate_EStretchDirection, METADATA_PARAMS(Z_Construct_UClass_UScaleBox_Statics::NewProp_StretchDirection_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UScaleBox_Statics::NewProp_StretchDirection_MetaData)) }; // 231333316
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_ScaleBox_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UScaleBox, UScaleBox::StaticClass, TEXT("UScaleBox"), &Z_Registration_Info_UClass_UScaleBox, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UScaleBox), 2702946238U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_ScaleBox_h_2584023641(TEXT("/Script/UMG"),
