...
class UScriptStruct* FFieldNotificationId::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FieldNotificationId.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFieldNotificationId, Z_Construct_UPackage__Script_UMG(), TEXT("FieldNotificationId"));
	}
