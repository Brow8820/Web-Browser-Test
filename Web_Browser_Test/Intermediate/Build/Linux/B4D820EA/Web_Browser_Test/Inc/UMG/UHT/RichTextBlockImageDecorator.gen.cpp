...
template<> UMG_API UScriptStruct* StaticStruct<FRichImageRow>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_RichTextBlockImageDecorator_h_Statics::ScriptStructInfo[] = {
		{ FRichImageRow::StaticStruct, Z_Construct_UScriptStruct_FRichImageRow_Statics::NewStructOps, TEXT("RichImageRow"), &Z_Registration_Info_UScriptStruct_RichImageRow, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRichImageRow), 3058603227U) },
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_RichTextBlockImageDecorator_h_277211416(TEXT("/Script/UMG"),
