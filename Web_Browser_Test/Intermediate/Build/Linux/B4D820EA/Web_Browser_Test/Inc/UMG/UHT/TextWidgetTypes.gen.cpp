...
template<> UMG_API UScriptStruct* StaticStruct<FShapedTextOptions>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_TextWidgetTypes_h_Statics::ScriptStructInfo[] = {
		{ FShapedTextOptions::StaticStruct, Z_Construct_UScriptStruct_FShapedTextOptions_Statics::NewStructOps, TEXT("ShapedTextOptions"), &Z_Registration_Info_UScriptStruct_ShapedTextOptions, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FShapedTextOptions), 1749121143U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_TextWidgetTypes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTextLayoutWidget, UTextLayoutWidget::StaticClass, TEXT("UTextLayoutWidget"), &Z_Registration_Info_UClass_UTextLayoutWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTextLayoutWidget), 3937471166U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_TextWidgetTypes_h_1571886708(TEXT("/Script/UMG"),
