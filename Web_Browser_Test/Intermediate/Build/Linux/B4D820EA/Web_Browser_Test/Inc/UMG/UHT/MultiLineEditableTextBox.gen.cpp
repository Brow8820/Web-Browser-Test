...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMultiLineEditableTextBox_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMultiLineEditableTextBox_SetTextStyle, "SetTextStyle" }, // 1378718839
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_MultiLineEditableTextBox_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMultiLineEditableTextBox, UMultiLineEditableTextBox::StaticClass, TEXT("UMultiLineEditableTextBox"), &Z_Registration_Info_UClass_UMultiLineEditableTextBox, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMultiLineEditableTextBox), 4267832789U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_MultiLineEditableTextBox_h_3281686381(TEXT("/Script/UMG"),
