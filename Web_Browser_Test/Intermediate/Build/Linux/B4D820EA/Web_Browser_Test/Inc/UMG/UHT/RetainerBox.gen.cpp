...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URetainerBox_Statics::NewProp_RenderOnInvalidation = { "RenderOnInvalidation", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(URetainerBox), &Z_Construct_UClass_URetainerBox_Statics::NewProp_RenderOnInvalidation_SetBit, METADATA_PARAMS(Z_Construct_UClass_URetainerBox_Statics::NewProp_RenderOnInvalidation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URetainerBox_Statics::NewProp_RenderOnInvalidation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_URetainerBox_Statics::NewProp_PhaseCount = { "PhaseCount", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(URetainerBox, PhaseCount), METADATA_PARAMS(Z_Construct_UClass_URetainerBox_Statics::NewProp_PhaseCount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URetainerBox_Statics::NewProp_PhaseCount_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URetainerBox_Statics::NewProp_EffectMaterial = { "EffectMaterial", nullptr, (EPropertyFlags)0x0024080000000015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(URetainerBox, EffectMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(Z_Construct_UClass_URetainerBox_Statics::NewProp_EffectMaterial_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URetainerBox_Statics::NewProp_EffectMaterial_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_URetainerBox_Statics::NewProp_TextureParameter = { "TextureParameter", nullptr, (EPropertyFlags)0x0020080000000015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(URetainerBox, TextureParameter), METADATA_PARAMS(Z_Construct_UClass_URetainerBox_Statics::NewProp_TextureParameter_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URetainerBox_Statics::NewProp_TextureParameter_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_RetainerBox_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URetainerBox, URetainerBox::StaticClass, TEXT("URetainerBox"), &Z_Registration_Info_UClass_URetainerBox, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URetainerBox), 1464961454U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_RetainerBox_h_3507720254(TEXT("/Script/UMG"),
