...
template<> UMG_API UScriptStruct* StaticStruct<FDelegateRuntimeBinding>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Blueprint_WidgetBlueprintGeneratedClass_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWidgetBlueprintGeneratedClass, UWidgetBlueprintGeneratedClass::StaticClass, TEXT("UWidgetBlueprintGeneratedClass"), &Z_Registration_Info_UClass_UWidgetBlueprintGeneratedClass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWidgetBlueprintGeneratedClass), 232079082U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Blueprint_WidgetBlueprintGeneratedClass_h_1744725220(TEXT("/Script/UMG"),
