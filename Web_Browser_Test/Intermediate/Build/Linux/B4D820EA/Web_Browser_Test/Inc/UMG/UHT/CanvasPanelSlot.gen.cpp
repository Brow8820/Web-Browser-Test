...
template<> UMG_API UScriptStruct* StaticStruct<FAnchorData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_CanvasPanelSlot_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCanvasPanelSlot, UCanvasPanelSlot::StaticClass, TEXT("UCanvasPanelSlot"), &Z_Registration_Info_UClass_UCanvasPanelSlot, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCanvasPanelSlot), 1939416292U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_CanvasPanelSlot_h_2329299440(TEXT("/Script/UMG"),
