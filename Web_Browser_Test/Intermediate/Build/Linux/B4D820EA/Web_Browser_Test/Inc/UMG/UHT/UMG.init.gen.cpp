...
void EmptyLinkFunctionForGeneratedCodeUMG_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_UMG()
	{
		if (!Z_Registration_Info_UPackage__Script_UMG.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_UMG_FieldValueChangedDynamicDelegate__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_UMG(Z_Construct_UPackage__Script_UMG, TEXT("/Script/UMG"), Z_Registration_Info_UPackage__Script_UMG, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x143E91BC, 0x43A6B907));
