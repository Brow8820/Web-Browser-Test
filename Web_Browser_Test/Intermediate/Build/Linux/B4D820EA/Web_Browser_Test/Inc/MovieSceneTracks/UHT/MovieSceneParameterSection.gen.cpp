...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FTransformParameterNameAndCurves>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneParameterSection_h_Statics::ScriptStructInfo[] = {
		{ FBoolParameterNameAndCurve::StaticStruct, Z_Construct_UScriptStruct_FBoolParameterNameAndCurve_Statics::NewStructOps, TEXT("BoolParameterNameAndCurve"), &Z_Registration_Info_UScriptStruct_BoolParameterNameAndCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBoolParameterNameAndCurve), 4206555506U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneParameterSection_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UMovieSceneParameterSection, UMovieSceneParameterSection::StaticClass, TEXT("UMovieSceneParameterSection"), &Z_Registration_Info_UClass_UMovieSceneParameterSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneParameterSection), 515181389U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneParameterSection_h_3963087411(TEXT("/Script/MovieSceneTracks"),
