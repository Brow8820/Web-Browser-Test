...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneVector4dKeyStruct>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneVectorSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneFloatVectorSection, UMovieSceneFloatVectorSection::StaticClass, TEXT("UMovieSceneFloatVectorSection"), &Z_Registration_Info_UClass_UMovieSceneFloatVectorSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneFloatVectorSection), 4182428862U) },
		{ Z_Construct_UClass_UMovieSceneDoubleVectorSection, UMovieSceneDoubleVectorSection::StaticClass, TEXT("UMovieSceneDoubleVectorSection"), &Z_Registration_Info_UClass_UMovieSceneDoubleVectorSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneDoubleVectorSection), 3039008975U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneVectorSection_h_1640647222(TEXT("/Script/MovieSceneTracks"),
