...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneFadeSectionTemplate>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneFadeSectionTemplate_Statics::NewProp_FadeCurve = { "FadeCurve", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FMovieSceneFadeSectionTemplate, FadeCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneFadeSectionTemplate_Statics::NewProp_FadeCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneFadeSectionTemplate_Statics::NewProp_FadeCurve_MetaData)) }; // 3942748414
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneFadeSectionTemplate_Statics::NewProp_FadeColor = { "FadeColor", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FMovieSceneFadeSectionTemplate, FadeColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneFadeSectionTemplate_Statics::NewProp_FadeColor_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneFadeSectionTemplate_Statics::NewProp_FadeColor_MetaData)) };
#if WITH_METADATA
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Private_Evaluation_MovieSceneFadeTemplate_h_223246223(TEXT("/Script/MovieSceneTracks"),
		nullptr, 0,
