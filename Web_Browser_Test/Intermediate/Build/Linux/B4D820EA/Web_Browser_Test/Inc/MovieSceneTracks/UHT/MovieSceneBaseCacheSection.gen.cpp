...
#include "MovieSceneTracks/Public/Sections/MovieSceneBaseCacheSection.h"
...
class UScriptStruct* FMovieSceneBaseCacheParams::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneBaseCacheParams.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneBaseCacheParams, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneBaseCacheParams"));
	}
...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneBaseCacheParams>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneBaseCacheSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneBaseCacheSection, UMovieSceneBaseCacheSection::StaticClass, TEXT("UMovieSceneBaseCacheSection"), &Z_Registration_Info_UClass_UMovieSceneBaseCacheSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneBaseCacheSection), 2646003649U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneBaseCacheSection_h_3935601090(TEXT("/Script/MovieSceneTracks"),
