...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneCVarOverrides>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneCVarSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneCVarSection, UMovieSceneCVarSection::StaticClass, TEXT("UMovieSceneCVarSection"), &Z_Registration_Info_UClass_UMovieSceneCVarSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneCVarSection), 3769522579U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneCVarSection_h_540263499(TEXT("/Script/MovieSceneTracks"),
