...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneStringChannel>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Channels_MovieSceneStringChannel_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneStringChannel::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneStringChannel_Statics::NewStructOps, TEXT("MovieSceneStringChannel"), &Z_Registration_Info_UScriptStruct_MovieSceneStringChannel, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneStringChannel), 1425564024U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Channels_MovieSceneStringChannel_h_2783649741(TEXT("/Script/MovieSceneTracks"),
		nullptr, 0,
