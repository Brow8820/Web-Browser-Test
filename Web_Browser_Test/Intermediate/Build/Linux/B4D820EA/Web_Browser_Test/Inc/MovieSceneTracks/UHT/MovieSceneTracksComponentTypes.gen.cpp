...
class UScriptStruct* FPerlinNoiseParams::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PerlinNoiseParams.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPerlinNoiseParams, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("PerlinNoiseParams"));
	}
...
class UScriptStruct* FConstraintComponentData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ConstraintComponentData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FConstraintComponentData, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("ConstraintComponentData"));
	}
...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FConstraintComponentData>()
{
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_MovieSceneTracksComponentTypes_h_3053752623(TEXT("/Script/MovieSceneTracks"),
		nullptr, 0,
