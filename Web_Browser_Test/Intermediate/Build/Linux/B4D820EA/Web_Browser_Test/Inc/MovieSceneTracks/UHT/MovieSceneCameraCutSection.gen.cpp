...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneCameraCutSection_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneCameraCutSection_GetCameraBindingID, "GetCameraBindingID" }, // 3349504109
		{ &Z_Construct_UFunction_UMovieSceneCameraCutSection_SetCameraBindingID, "SetCameraBindingID" }, // 2508009563
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneCameraCutSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneCameraCutSection, UMovieSceneCameraCutSection::StaticClass, TEXT("UMovieSceneCameraCutSection"), &Z_Registration_Info_UClass_UMovieSceneCameraCutSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneCameraCutSection), 2028070440U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneCameraCutSection_h_1674094938(TEXT("/Script/MovieSceneTracks"),
