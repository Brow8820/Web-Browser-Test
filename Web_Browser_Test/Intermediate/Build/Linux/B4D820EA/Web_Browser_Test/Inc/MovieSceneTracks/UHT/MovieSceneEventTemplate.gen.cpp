...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneEventSectionTemplate>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Private_Evaluation_MovieSceneEventTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneEventSectionTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneEventSectionTemplate_Statics::NewStructOps, TEXT("MovieSceneEventSectionTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneEventSectionTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneEventSectionTemplate), 4261223975U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Private_Evaluation_MovieSceneEventTemplate_h_3896554484(TEXT("/Script/MovieSceneTracks"),
		nullptr, 0,
