...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneParticleChannel>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneParticleSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneParticleSection, UMovieSceneParticleSection::StaticClass, TEXT("UMovieSceneParticleSection"), &Z_Registration_Info_UClass_UMovieSceneParticleSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneParticleSection), 152425341U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneParticleSection_h_1369708374(TEXT("/Script/MovieSceneTracks"),
