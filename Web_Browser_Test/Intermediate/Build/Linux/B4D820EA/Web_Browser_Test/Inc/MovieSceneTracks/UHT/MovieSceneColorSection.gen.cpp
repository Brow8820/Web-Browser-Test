...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneColorKeyStruct>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneColorSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneColorSection, UMovieSceneColorSection::StaticClass, TEXT("UMovieSceneColorSection"), &Z_Registration_Info_UClass_UMovieSceneColorSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneColorSection), 2168719817U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneColorSection_h_715306428(TEXT("/Script/MovieSceneTracks"),
