...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieSceneEnumTrack_Statics::NewProp_Enum = { "Enum", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UMovieSceneEnumTrack, Enum), Z_Construct_UClass_UEnum, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneEnumTrack_Statics::NewProp_Enum_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneEnumTrack_Statics::NewProp_Enum_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneEnumTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneEnumTrack, UMovieSceneEnumTrack::StaticClass, TEXT("UMovieSceneEnumTrack"), &Z_Registration_Info_UClass_UMovieSceneEnumTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneEnumTrack), 1106046721U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneEnumTrack_h_1858096947(TEXT("/Script/MovieSceneTracks"),
