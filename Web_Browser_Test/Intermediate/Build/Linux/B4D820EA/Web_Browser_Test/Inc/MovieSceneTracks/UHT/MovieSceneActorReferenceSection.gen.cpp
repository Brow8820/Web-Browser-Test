...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneActorReferenceData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneActorReferenceSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneActorReferenceSection, UMovieSceneActorReferenceSection::StaticClass, TEXT("UMovieSceneActorReferenceSection"), &Z_Registration_Info_UClass_UMovieSceneActorReferenceSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneActorReferenceSection), 952086512U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneActorReferenceSection_h_3069934018(TEXT("/Script/MovieSceneTracks"),
