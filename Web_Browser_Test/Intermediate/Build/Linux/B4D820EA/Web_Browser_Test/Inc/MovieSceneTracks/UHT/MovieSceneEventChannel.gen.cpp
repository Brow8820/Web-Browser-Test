...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneEventChannel>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Channels_MovieSceneEventChannel_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneEventChannel::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneEventChannel_Statics::NewStructOps, TEXT("MovieSceneEventChannel"), &Z_Registration_Info_UScriptStruct_MovieSceneEventChannel, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneEventChannel), 3718284047U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Channels_MovieSceneEventChannel_h_882869684(TEXT("/Script/MovieSceneTracks"),
		nullptr, 0,
