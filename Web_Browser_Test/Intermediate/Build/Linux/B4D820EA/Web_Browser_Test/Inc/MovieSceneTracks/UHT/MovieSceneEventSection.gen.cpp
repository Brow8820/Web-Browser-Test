...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneEventSectionData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneEventSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneEventSection, UMovieSceneEventSection::StaticClass, TEXT("UMovieSceneEventSection"), &Z_Registration_Info_UClass_UMovieSceneEventSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneEventSection), 2634871370U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneEventSection_h_4073893054(TEXT("/Script/MovieSceneTracks"),
