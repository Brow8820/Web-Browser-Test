...
class UScriptStruct* FMovieSceneConstraintChannel::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneConstraintChannel.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneConstraintChannel, Z_Construct_UPackage__Script_Constraints(), TEXT("MovieSceneConstraintChannel"));
	}
...
class UScriptStruct* FConstraintAndActiveChannel::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ConstraintAndActiveChannel.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FConstraintAndActiveChannel, Z_Construct_UPackage__Script_Constraints(), TEXT("ConstraintAndActiveChannel"));
	}
