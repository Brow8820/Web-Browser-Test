...
#define FID_Engine_Source_Developer_SourceControl_Public_SourceControlHelpers_h_476_DELEGATE \
struct SourceControlHelpers_eventQueryFileStateDelegate_Parms \
{ \
	FSourceControlState FileStateOut; \
}; \
static inline void FQueryFileStateDelegate_DelegateWrapper(const FScriptDelegate& QueryFileStateDelegate, FSourceControlState FileStateOut) \
{ \
