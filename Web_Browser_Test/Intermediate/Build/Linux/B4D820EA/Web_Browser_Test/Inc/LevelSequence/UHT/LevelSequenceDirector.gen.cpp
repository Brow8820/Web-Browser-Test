...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ULevelSequenceDirector_GetCurrentTime_Statics::Function_MetaDataParams[] = {
		{ "Category", "Sequencer|Director" },
		{ "Comment", "/**\n\x09 * Get the current time for this director's sub-sequence (or the master sequence, if this is a master sequence director)\n\x09 * @return The current playback position of this director's sequence\n\x09 */" },
		{ "ModuleRelativePath", "Public/LevelSequenceDirector.h" },
		{ "ToolTip", "Get the current time for this director's sub-sequence (or the master sequence, if this is a master sequence director)\n@return The current playback position of this director's sequence" },
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ULevelSequenceDirector_GetMasterSequenceTime_Statics::Function_MetaDataParams[] = {
		{ "Category", "Sequencer|Director" },
		{ "Comment", "/**\n\x09 * Get the current time for the outermost (root, or master) sequence\n\x09 * @return The current playback position of the master sequence\n\x09 */" },
		{ "ModuleRelativePath", "Public/LevelSequenceDirector.h" },
		{ "ToolTip", "Get the current time for the outermost (root, or master) sequence\n@return The current playback position of the master sequence" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULevelSequenceDirector_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULevelSequenceDirector_GetBoundActor, "GetBoundActor" }, // 3972131776
		{ &Z_Construct_UFunction_ULevelSequenceDirector_GetBoundActors, "GetBoundActors" }, // 1729483306
		{ &Z_Construct_UFunction_ULevelSequenceDirector_GetBoundObject, "GetBoundObject" }, // 3533782804
		{ &Z_Construct_UFunction_ULevelSequenceDirector_GetBoundObjects, "GetBoundObjects" }, // 2328206937
		{ &Z_Construct_UFunction_ULevelSequenceDirector_GetCurrentTime, "GetCurrentTime" }, // 1630910636
		{ &Z_Construct_UFunction_ULevelSequenceDirector_GetMasterSequenceTime, "GetMasterSequenceTime" }, // 2092216107
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_LevelSequence_Public_LevelSequenceDirector_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULevelSequenceDirector, ULevelSequenceDirector::StaticClass, TEXT("ULevelSequenceDirector"), &Z_Registration_Info_UClass_ULevelSequenceDirector, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULevelSequenceDirector), 1052454824U) },
		{ Z_Construct_UClass_ULegacyLevelSequenceDirectorBlueprint, ULegacyLevelSequenceDirectorBlueprint::StaticClass, TEXT("ULegacyLevelSequenceDirectorBlueprint"), &Z_Registration_Info_UClass_ULegacyLevelSequenceDirectorBlueprint, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULegacyLevelSequenceDirectorBlueprint), 1823588780U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_LevelSequence_Public_LevelSequenceDirector_h_908472696(TEXT("/Script/LevelSequence"),
