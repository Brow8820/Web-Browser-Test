...
// End Cross Module References
	...
	static UEnum* EWaveTableResolution_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EWaveTableResolution.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_WaveTable_EWaveTableResolution, Z_Construct_UPackage__Script_WaveTable(), TEXT("EWaveTableResolution"));
		}
...
class UScriptStruct* FWaveTableSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WaveTableSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWaveTableSettings, Z_Construct_UPackage__Script_WaveTable(), TEXT("WaveTableSettings"));
	}
...
template<> WAVETABLE_API UScriptStruct* StaticStruct<FWaveTableSettings>()
{
	...
	static UEnum* EWaveTableCurve_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EWaveTableCurve.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_WaveTable_EWaveTableCurve, Z_Construct_UPackage__Script_WaveTable(), TEXT("EWaveTableCurve"));
		}
