...
class UScriptStruct* FWaveTableBankEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WaveTableBankEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWaveTableBankEntry, Z_Construct_UPackage__Script_WaveTable(), TEXT("WaveTableBankEntry"));
	}
...
template<> WAVETABLE_API UScriptStruct* StaticStruct<FWaveTableBankEntry>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWaveTableBank_Statics::NewProp_Resolution_MetaData[] = {
		{ "Category", "Options" },
		{ "Comment", "// Number of sampled cached for each curve in the given bank.\n" },
		{ "ModuleRelativePath", "Public/WaveTableBank.h" },
		{ "ToolTip", "Number of sampled cached for each curve in the given bank." },
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWaveTableBank_Statics::NewProp_bBipolar_MetaData[] = {
		{ "Category", "Options" },
		{ "Comment", "// Determines if output from curve/wavetable are to be clamped between [-1.0f, 1.0f]\n// (i.e. for waveform generation, oscillation, etc.) or between [0.0f, 1.0f]\n// (i.e. for enveloping) when sampling curve/wavetable\n" },
		{ "ModuleRelativePath", "Public/WaveTableBank.h" },
		{ "ToolTip", "Determines if output from curve/wavetable are to be clamped between [-1.0f, 1.0f]\n(i.e. for waveform generation, oscillation, etc.) or between [0.0f, 1.0f]\n(i.e. for enveloping) when sampling curve/wavetable" },
	};
#endif
...
#endif // WITH_EDITORONLY_DATA
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWaveTableBank_Statics::NewProp_Entries_Inner = { "Entries", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FWaveTableBankEntry, METADATA_PARAMS(nullptr, 0) }; // 1216389787
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WaveTable_Source_WaveTable_Public_WaveTableBank_h_Statics::ScriptStructInfo[] = {
		{ FWaveTableBankEntry::StaticStruct, Z_Construct_UScriptStruct_FWaveTableBankEntry_Statics::NewStructOps, TEXT("WaveTableBankEntry"), &Z_Registration_Info_UScriptStruct_WaveTableBankEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWaveTableBankEntry), 1216389787U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WaveTable_Source_WaveTable_Public_WaveTableBank_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWaveTableBank, UWaveTableBank::StaticClass, TEXT("UWaveTableBank"), &Z_Registration_Info_UClass_UWaveTableBank, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWaveTableBank), 63737678U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WaveTable_Source_WaveTable_Public_WaveTableBank_h_839324248(TEXT("/Script/WaveTable"),
