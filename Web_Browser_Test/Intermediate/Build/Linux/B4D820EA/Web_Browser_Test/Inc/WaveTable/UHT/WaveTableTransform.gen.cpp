...
class UScriptStruct* FWaveTableTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WaveTableTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWaveTableTransform, Z_Construct_UPackage__Script_WaveTable(), TEXT("WaveTableTransform"));
	}
...
template<> WAVETABLE_API UScriptStruct* StaticStruct<FWaveTableTransform>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WaveTable_Source_WaveTable_Public_WaveTableTransform_h_Statics::ScriptStructInfo[] = {
		{ FWaveTableTransform::StaticStruct, Z_Construct_UScriptStruct_FWaveTableTransform_Statics::NewStructOps, TEXT("WaveTableTransform"), &Z_Registration_Info_UScriptStruct_WaveTableTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWaveTableTransform), 2320691749U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_WaveTable_Source_WaveTable_Public_WaveTableTransform_h_3124996101(TEXT("/Script/WaveTable"),
		nullptr, 0,
