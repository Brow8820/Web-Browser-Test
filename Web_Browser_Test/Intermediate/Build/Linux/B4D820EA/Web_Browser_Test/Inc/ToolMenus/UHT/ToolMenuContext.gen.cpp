...
class UScriptStruct* FToolMenuContext::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ToolMenuContext.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FToolMenuContext, Z_Construct_UPackage__Script_ToolMenus(), TEXT("ToolMenuContext"));
	}
