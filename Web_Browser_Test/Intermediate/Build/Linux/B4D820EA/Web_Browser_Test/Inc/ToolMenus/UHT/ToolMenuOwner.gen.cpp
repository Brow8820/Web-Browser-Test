...
class UScriptStruct* FToolMenuOwner::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ToolMenuOwner.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FToolMenuOwner, Z_Construct_UPackage__Script_ToolMenus(), TEXT("ToolMenuOwner"));
	}
