...
class UScriptStruct* FToolDynamicUIAction::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ToolDynamicUIAction.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FToolDynamicUIAction, Z_Construct_UPackage__Script_ToolMenus(), TEXT("ToolDynamicUIAction"));
	}
