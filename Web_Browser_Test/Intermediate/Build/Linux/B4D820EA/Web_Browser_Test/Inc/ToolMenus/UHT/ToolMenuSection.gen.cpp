...
#include "ToolMenus/Public/ToolMenuOwner.h"
...
class UScriptStruct* FToolMenuSection::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ToolMenuSection.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FToolMenuSection, Z_Construct_UPackage__Script_ToolMenus(), TEXT("ToolMenuSection"));
	}
