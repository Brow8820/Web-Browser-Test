...
#include "ToolMenus/Public/ToolMenuMisc.h"
...
// End Cross Module References
	...
	static UEnum* EToolMenuStringCommandType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EToolMenuStringCommandType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ToolMenus_EToolMenuStringCommandType, Z_Construct_UPackage__Script_ToolMenus(), TEXT("EToolMenuStringCommandType"));
		}
...
class UScriptStruct* FToolMenuStringCommand::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ToolMenuStringCommand.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FToolMenuStringCommand, Z_Construct_UPackage__Script_ToolMenus(), TEXT("ToolMenuStringCommand"));
	}
...
template<> TOOLMENUS_API UScriptStruct* StaticStruct<FToolMenuStringCommand>()
{
	...
	static UEnum* EToolMenuInsertType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EToolMenuInsertType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ToolMenus_EToolMenuInsertType, Z_Construct_UPackage__Script_ToolMenus(), TEXT("EToolMenuInsertType"));
		}
...
class UScriptStruct* FToolMenuInsert::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ToolMenuInsert.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FToolMenuInsert, Z_Construct_UPackage__Script_ToolMenus(), TEXT("ToolMenuInsert"));
	}
