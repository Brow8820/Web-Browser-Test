...
#include "ToolMenus/Public/ToolMenuEntryScript.h"
...
class UScriptStruct* FScriptSlateIcon::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ScriptSlateIcon.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FScriptSlateIcon, Z_Construct_UPackage__Script_ToolMenus(), TEXT("ScriptSlateIcon"));
	}
...
class UScriptStruct* FToolMenuEntryScriptDataAdvanced::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ToolMenuEntryScriptDataAdvanced.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FToolMenuEntryScriptDataAdvanced, Z_Construct_UPackage__Script_ToolMenus(), TEXT("ToolMenuEntryScriptDataAdvanced"));
	}
...
class UScriptStruct* FToolMenuEntryScriptData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ToolMenuEntryScriptData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FToolMenuEntryScriptData, Z_Construct_UPackage__Script_ToolMenus(), TEXT("ToolMenuEntryScriptData"));
	}
