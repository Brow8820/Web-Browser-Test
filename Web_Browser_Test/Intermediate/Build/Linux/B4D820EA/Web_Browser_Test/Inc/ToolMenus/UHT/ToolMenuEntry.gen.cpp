...
class UScriptStruct* FToolMenuEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ToolMenuEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FToolMenuEntry, Z_Construct_UPackage__Script_ToolMenus(), TEXT("ToolMenuEntry"));
	}
