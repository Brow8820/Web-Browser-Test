...
template<> NAVIGATIONSYSTEM_API UScriptStruct* StaticStruct<FNavLinkCustomInstanceData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavLinkCustomComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNavLinkCustomComponent, UNavLinkCustomComponent::StaticClass, TEXT("UNavLinkCustomComponent"), &Z_Registration_Info_UClass_UNavLinkCustomComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNavLinkCustomComponent), 2110515151U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavLinkCustomComponent_h_2988137230(TEXT("/Script/NavigationSystem"),
