...
template<> NAVIGATIONSYSTEM_API UScriptStruct* StaticStruct<FSupportedAreaData>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ANavigationData_Statics::NewProp_SupportedAreas_Inner = { "SupportedAreas", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FSupportedAreaData, METADATA_PARAMS(nullptr, 0) }; // 2287586580
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavigationData_h_Statics::ScriptStructInfo[] = {
		{ FSupportedAreaData::StaticStruct, Z_Construct_UScriptStruct_FSupportedAreaData_Statics::NewStructOps, TEXT("SupportedAreaData"), &Z_Registration_Info_UScriptStruct_SupportedAreaData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSupportedAreaData), 2287586580U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavigationData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANavigationData, ANavigationData::StaticClass, TEXT("ANavigationData"), &Z_Registration_Info_UClass_ANavigationData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANavigationData), 4255165638U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavigationData_h_2692200699(TEXT("/Script/NavigationSystem"),
