...
template<> AUGMENTEDREALITY_API UScriptStruct* StaticStruct<FARSharedWorldReplicationState>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARSharedWorldGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AARSharedWorldGameMode, AARSharedWorldGameMode::StaticClass, TEXT("AARSharedWorldGameMode"), &Z_Registration_Info_UClass_AARSharedWorldGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AARSharedWorldGameMode), 1160887795U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARSharedWorldGameMode_h_3967642841(TEXT("/Script/AugmentedReality"),
