...
template<> AUGMENTEDREALITY_API UScriptStruct* StaticStruct<FARGeoAnchorUpdatePayload>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UARComponent, UARComponent::StaticClass, TEXT("UARComponent"), &Z_Registration_Info_UClass_UARComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARComponent), 31795820U) },
		{ Z_Construct_UClass_UARPlaneComponent, UARPlaneComponent::StaticClass, TEXT("UARPlaneComponent"), &Z_Registration_Info_UClass_UARPlaneComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARPlaneComponent), 2676269887U) },
		{ Z_Construct_UClass_UARPointComponent, UARPointComponent::StaticClass, TEXT("UARPointComponent"), &Z_Registration_Info_UClass_UARPointComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARPointComponent), 326850673U) },
		{ Z_Construct_UClass_UARFaceComponent, UARFaceComponent::StaticClass, TEXT("UARFaceComponent"), &Z_Registration_Info_UClass_UARFaceComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARFaceComponent), 551727542U) },
		{ Z_Construct_UClass_UARImageComponent, UARImageComponent::StaticClass, TEXT("UARImageComponent"), &Z_Registration_Info_UClass_UARImageComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARImageComponent), 2514591801U) },
		{ Z_Construct_UClass_UARQRCodeComponent, UARQRCodeComponent::StaticClass, TEXT("UARQRCodeComponent"), &Z_Registration_Info_UClass_UARQRCodeComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARQRCodeComponent), 4238188445U) },
		{ Z_Construct_UClass_UARPoseComponent, UARPoseComponent::StaticClass, TEXT("UARPoseComponent"), &Z_Registration_Info_UClass_UARPoseComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARPoseComponent), 1270048809U) },
		{ Z_Construct_UClass_UAREnvironmentProbeComponent, UAREnvironmentProbeComponent::StaticClass, TEXT("UAREnvironmentProbeComponent"), &Z_Registration_Info_UClass_UAREnvironmentProbeComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAREnvironmentProbeComponent), 2428324362U) },
		{ Z_Construct_UClass_UARObjectComponent, UARObjectComponent::StaticClass, TEXT("UARObjectComponent"), &Z_Registration_Info_UClass_UARObjectComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARObjectComponent), 2917701666U) },
		{ Z_Construct_UClass_UARMeshComponent, UARMeshComponent::StaticClass, TEXT("UARMeshComponent"), &Z_Registration_Info_UClass_UARMeshComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARMeshComponent), 1108384718U) },
		{ Z_Construct_UClass_UARGeoAnchorComponent, UARGeoAnchorComponent::StaticClass, TEXT("UARGeoAnchorComponent"), &Z_Registration_Info_UClass_UARGeoAnchorComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARGeoAnchorComponent), 2206168063U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARComponent_h_173114769(TEXT("/Script/AugmentedReality"),
