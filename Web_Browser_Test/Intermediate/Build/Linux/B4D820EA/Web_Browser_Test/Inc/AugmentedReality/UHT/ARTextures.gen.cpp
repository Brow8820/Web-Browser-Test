...
// End Cross Module References
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARTextures_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UARTexture, UARTexture::StaticClass, TEXT("UARTexture"), &Z_Registration_Info_UClass_UARTexture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARTexture), 3124149432U) },
		{ Z_Construct_UClass_UARTextureCameraImage, UARTextureCameraImage::StaticClass, TEXT("UARTextureCameraImage"), &Z_Registration_Info_UClass_UARTextureCameraImage, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARTextureCameraImage), 775901476U) },
		{ Z_Construct_UClass_UARTextureCameraDepth, UARTextureCameraDepth::StaticClass, TEXT("UARTextureCameraDepth"), &Z_Registration_Info_UClass_UARTextureCameraDepth, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARTextureCameraDepth), 133426654U) },
		{ Z_Construct_UClass_UAREnvironmentCaptureProbeTexture, UAREnvironmentCaptureProbeTexture::StaticClass, TEXT("UAREnvironmentCaptureProbeTexture"), &Z_Registration_Info_UClass_UAREnvironmentCaptureProbeTexture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAREnvironmentCaptureProbeTexture), 703057773U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARTextures_h_1968994592(TEXT("/Script/AugmentedReality"),
