...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneIntegerChannel>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Channels_MovieSceneIntegerChannel_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneIntegerChannel::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneIntegerChannel_Statics::NewStructOps, TEXT("MovieSceneIntegerChannel"), &Z_Registration_Info_UScriptStruct_MovieSceneIntegerChannel, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneIntegerChannel), 1999530015U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Channels_MovieSceneIntegerChannel_h_2899347354(TEXT("/Script/MovieScene"),
		nullptr, 0,
