...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneCompiledSequenceFlagStruct>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Compilation_MovieSceneCompiledDataManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneCompiledData, UMovieSceneCompiledData::StaticClass, TEXT("UMovieSceneCompiledData"), &Z_Registration_Info_UClass_UMovieSceneCompiledData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneCompiledData), 1845390533U) },
		{ Z_Construct_UClass_UMovieSceneCompiledDataManager, UMovieSceneCompiledDataManager::StaticClass, TEXT("UMovieSceneCompiledDataManager"), &Z_Registration_Info_UClass_UMovieSceneCompiledDataManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneCompiledDataManager), 4287442289U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Compilation_MovieSceneCompiledDataManager_h_2786567309(TEXT("/Script/MovieScene"),
