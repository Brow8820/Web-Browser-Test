...
class UScriptStruct* FMovieSceneSequenceTickInterval::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneSequenceTickInterval.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneSequenceTickInterval, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneSequenceTickInterval"));
	}
