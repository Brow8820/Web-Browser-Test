...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneSpawnable>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneSpawnable_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneSpawnable::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewStructOps, TEXT("MovieSceneSpawnable"), &Z_Registration_Info_UScriptStruct_MovieSceneSpawnable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneSpawnable), 659182208U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneSpawnable_h_3165696(TEXT("/Script/MovieScene"),
		nullptr, 0,
