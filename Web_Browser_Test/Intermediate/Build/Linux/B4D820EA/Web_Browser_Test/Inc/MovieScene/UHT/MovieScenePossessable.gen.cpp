...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieScenePossessable>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieScenePossessable_h_Statics::ScriptStructInfo[] = {
		{ FMovieScenePossessable::StaticStruct, Z_Construct_UScriptStruct_FMovieScenePossessable_Statics::NewStructOps, TEXT("MovieScenePossessable"), &Z_Registration_Info_UScriptStruct_MovieScenePossessable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieScenePossessable), 3629916338U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieScenePossessable_h_1245302426(TEXT("/Script/MovieScene"),
		nullptr, 0,
