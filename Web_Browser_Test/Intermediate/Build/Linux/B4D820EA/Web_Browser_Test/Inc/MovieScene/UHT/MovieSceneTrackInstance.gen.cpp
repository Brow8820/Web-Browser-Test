...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneTrackInstanceInput>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_TrackInstance_MovieSceneTrackInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneTrackInstance, UMovieSceneTrackInstance::StaticClass, TEXT("UMovieSceneTrackInstance"), &Z_Registration_Info_UClass_UMovieSceneTrackInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneTrackInstance), 923782484U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_TrackInstance_MovieSceneTrackInstance_h_2886915223(TEXT("/Script/MovieScene"),
