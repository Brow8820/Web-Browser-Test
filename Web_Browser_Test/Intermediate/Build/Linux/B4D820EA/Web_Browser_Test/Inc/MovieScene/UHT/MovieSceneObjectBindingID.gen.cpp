...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneObjectBindingID>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneObjectBindingID_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneObjectBindingID::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneObjectBindingID_Statics::NewStructOps, TEXT("MovieSceneObjectBindingID"), &Z_Registration_Info_UScriptStruct_MovieSceneObjectBindingID, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneObjectBindingID), 2079199892U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneObjectBindingID_h_4056351463(TEXT("/Script/MovieScene"),
		nullptr, 0,
