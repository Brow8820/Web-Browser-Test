...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneEvaluationTrack>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieSceneEvaluationTrack_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneEvaluationTrack::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneEvaluationTrack_Statics::NewStructOps, TEXT("MovieSceneEvaluationTrack"), &Z_Registration_Info_UScriptStruct_MovieSceneEvaluationTrack, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneEvaluationTrack), 397737307U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieSceneEvaluationTrack_h_3672381179(TEXT("/Script/MovieScene"),
		nullptr, 0,
