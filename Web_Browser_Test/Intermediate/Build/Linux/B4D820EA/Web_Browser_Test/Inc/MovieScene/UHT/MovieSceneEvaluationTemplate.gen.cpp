...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneEvaluationTemplate>()
{
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FMovieSceneEvaluationTemplate_Statics::NewProp_Tracks = { "Tracks", nullptr, (EPropertyFlags)0x0040008000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FMovieSceneEvaluationTemplate, Tracks), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEvaluationTemplate_Statics::NewProp_Tracks_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEvaluationTemplate_Statics::NewProp_Tracks_MetaData)) }; // 2461206580 397737307
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieSceneEvaluationTemplate_h_Statics::ScriptStructInfo[] = {
		...
		{ FMovieSceneEvaluationTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneEvaluationTemplate_Statics::NewStructOps, TEXT("MovieSceneEvaluationTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneEvaluationTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneEvaluationTemplate), 3688782122U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieSceneEvaluationTemplate_h_682341377(TEXT("/Script/MovieScene"),
		nullptr, 0,
