...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneTimecodeSource>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneSection, UMovieSceneSection::StaticClass, TEXT("UMovieSceneSection"), &Z_Registration_Info_UClass_UMovieSceneSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneSection), 3993489997U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneSection_h_3153224221(TEXT("/Script/MovieScene"),
