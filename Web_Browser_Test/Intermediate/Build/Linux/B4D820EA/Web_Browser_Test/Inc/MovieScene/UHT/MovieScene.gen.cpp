...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneObjectBindingIDs>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneObjectBindingIDs_Statics::NewProp_IDs_Inner = { "IDs", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, METADATA_PARAMS(nullptr, 0) }; // 2079199892
#if WITH_METADATA
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneSectionGroup>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieScene_Statics::NewProp_MasterTracks_Inner = { "MasterTracks", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMovieScene_Statics::NewProp_MasterTracks_Inner_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene_Statics::NewProp_MasterTracks_Inner_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieScene_Statics::NewProp_MasterTracks = { "MasterTracks", nullptr, (EPropertyFlags)0x0044008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UMovieScene, MasterTracks), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMovieScene_Statics::NewProp_MasterTracks_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene_Statics::NewProp_MasterTracks_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieScene_h_Statics::ScriptStructInfo[] = {
		...
		{ FMovieSceneMarkedFrame::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneMarkedFrame_Statics::NewStructOps, TEXT("MovieSceneMarkedFrame"), &Z_Registration_Info_UScriptStruct_MovieSceneMarkedFrame, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneMarkedFrame), 55180665U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieScene_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UMovieScene, UMovieScene::StaticClass, TEXT("UMovieScene"), &Z_Registration_Info_UClass_UMovieScene, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieScene), 1287512067U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieScene_h_1894012724(TEXT("/Script/MovieScene"),
