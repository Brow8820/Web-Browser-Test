...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneBindingOverrideData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneBindingOverrides_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneBindingOverrides, UMovieSceneBindingOverrides::StaticClass, TEXT("UMovieSceneBindingOverrides"), &Z_Registration_Info_UClass_UMovieSceneBindingOverrides, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneBindingOverrides), 2478993103U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneBindingOverrides_h_487213907(TEXT("/Script/MovieScene"),
