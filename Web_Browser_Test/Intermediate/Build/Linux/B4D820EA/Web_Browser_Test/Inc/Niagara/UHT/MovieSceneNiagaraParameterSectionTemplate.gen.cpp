...
template<> NIAGARA_API UScriptStruct* StaticStruct<FMovieSceneNiagaraParameterSectionTemplate>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_MovieScene_Parameters_MovieSceneNiagaraParameterSectionTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneNiagaraParameterSectionTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneNiagaraParameterSectionTemplate_Statics::NewStructOps, TEXT("MovieSceneNiagaraParameterSectionTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneNiagaraParameterSectionTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneNiagaraParameterSectionTemplate), 2202536525U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_MovieScene_Parameters_MovieSceneNiagaraParameterSectionTemplate_h_3458613986(TEXT("/Script/Niagara"),
		nullptr, 0,
