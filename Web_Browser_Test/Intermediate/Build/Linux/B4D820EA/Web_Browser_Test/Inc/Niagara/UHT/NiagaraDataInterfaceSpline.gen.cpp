...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraDataInterfaceSplineLUT>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceSpline_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraDataInterfaceSpline, UNiagaraDataInterfaceSpline::StaticClass, TEXT("UNiagaraDataInterfaceSpline"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceSpline, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceSpline), 4205902502U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceSpline_h_2769501477(TEXT("/Script/Niagara"),
