...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraSystemCompileRequest>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraSystem_h_Statics::ScriptStructInfo[] = {
		...
		{ FNiagaraSystemCompiledData::StaticStruct, Z_Construct_UScriptStruct_FNiagaraSystemCompiledData_Statics::NewStructOps, TEXT("NiagaraSystemCompiledData"), &Z_Registration_Info_UScriptStruct_NiagaraSystemCompiledData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraSystemCompiledData), 1053392757U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraSystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraSystem, UNiagaraSystem::StaticClass, TEXT("UNiagaraSystem"), &Z_Registration_Info_UClass_UNiagaraSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraSystem), 531056190U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraSystem_h_2116797418(TEXT("/Script/Niagara"),
