...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraOutlinerWorldData>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraOutlinerWorldData_Statics::NewProp_Systems_ValueProp = { "Systems", nullptr, (EPropertyFlags)0x0000000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 1, Z_Construct_UScriptStruct_FNiagaraOutlinerSystemData, METADATA_PARAMS(nullptr, 0) }; // 736530089
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraOutlinerData>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraOutlinerData_Statics::NewProp_WorldData_ValueProp = { "WorldData", nullptr, (EPropertyFlags)0x0000000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 1, Z_Construct_UScriptStruct_FNiagaraOutlinerWorldData, METADATA_PARAMS(nullptr, 0) }; // 810252802
...
class UScriptStruct* FNiagaraSystemSimCacheCaptureRequest::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraSystemSimCacheCaptureRequest.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraSystemSimCacheCaptureRequest, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraSystemSimCacheCaptureRequest"));
	}
...
class UScriptStruct* FNiagaraSystemSimCacheCaptureReply::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraSystemSimCacheCaptureReply.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraSystemSimCacheCaptureReply, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraSystemSimCacheCaptureReply"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraSystemSimCacheCaptureReply>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraDebuggerCommon_h_Statics::ScriptStructInfo[] = {
		...
		{ FNiagaraOutlinerSystemInstanceData::StaticStruct, Z_Construct_UScriptStruct_FNiagaraOutlinerSystemInstanceData_Statics::NewStructOps, TEXT("NiagaraOutlinerSystemInstanceData"), &Z_Registration_Info_UScriptStruct_NiagaraOutlinerSystemInstanceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraOutlinerSystemInstanceData), 2091632560U) },
		{ FNiagaraOutlinerSystemData::StaticStruct, Z_Construct_UScriptStruct_FNiagaraOutlinerSystemData_Statics::NewStructOps, TEXT("NiagaraOutlinerSystemData"), &Z_Registration_Info_UScriptStruct_NiagaraOutlinerSystemData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraOutlinerSystemData), 736530089U) },
		{ FNiagaraOutlinerWorldData::StaticStruct, Z_Construct_UScriptStruct_FNiagaraOutlinerWorldData_Statics::NewStructOps, TEXT("NiagaraOutlinerWorldData"), &Z_Registration_Info_UScriptStruct_NiagaraOutlinerWorldData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraOutlinerWorldData), 810252802U) },
		{ FNiagaraOutlinerData::StaticStruct, Z_Construct_UScriptStruct_FNiagaraOutlinerData_Statics::NewStructOps, TEXT("NiagaraOutlinerData"), &Z_Registration_Info_UScriptStruct_NiagaraOutlinerData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraOutlinerData), 766103018U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraDebuggerCommon_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraDebugHUDSettings, UNiagaraDebugHUDSettings::StaticClass, TEXT("UNiagaraDebugHUDSettings"), &Z_Registration_Info_UClass_UNiagaraDebugHUDSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDebugHUDSettings), 1263536559U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraDebuggerCommon_h_3458239408(TEXT("/Script/Niagara"),
