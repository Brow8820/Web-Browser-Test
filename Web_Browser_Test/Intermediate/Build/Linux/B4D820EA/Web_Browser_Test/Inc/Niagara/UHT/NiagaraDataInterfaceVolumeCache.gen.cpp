...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_VolumeCache_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPtrPropertyParams NewProp_VolumeCache;
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraDataInterfaceVolumeCache_Statics::Class_MetaDataParams[] = {
		{ "Category", "Grid" },
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraDataInterfaceVolumeCache_Statics::NewProp_VolumeCache_MetaData[] = {
		{ "Category", "File" },
		{ "ModuleRelativePath", "Classes/NiagaraDataInterfaceVolumeCache.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceVolumeCache_Statics::NewProp_VolumeCache = { "VolumeCache", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UNiagaraDataInterfaceVolumeCache, VolumeCache), Z_Construct_UClass_UVolumeCache_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UNiagaraDataInterfaceVolumeCache_Statics::NewProp_VolumeCache_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceVolumeCache_Statics::NewProp_VolumeCache_MetaData)) };
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_UNiagaraDataInterfaceVolumeCache_Statics::StaticCppClassTypeInfo = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraDataInterfaceVolumeCache_Statics::ClassParams = {
		...
		0,
		0x001010A0u,
		METADATA_PARAMS(Z_Construct_UClass_UNiagaraDataInterfaceVolumeCache_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceVolumeCache_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceVolumeCache_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraDataInterfaceVolumeCache, UNiagaraDataInterfaceVolumeCache::StaticClass, TEXT("UNiagaraDataInterfaceVolumeCache"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceVolumeCache, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceVolumeCache), 4096110189U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceVolumeCache_h_1435106455(TEXT("/Script/Niagara"),
