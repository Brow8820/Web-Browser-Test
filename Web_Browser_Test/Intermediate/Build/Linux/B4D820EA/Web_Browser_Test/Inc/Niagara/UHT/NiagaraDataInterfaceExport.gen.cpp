...
template<> NIAGARA_API UScriptStruct* StaticStruct<FBasicParticleData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceExport_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UNiagaraDataInterfaceExport, UNiagaraDataInterfaceExport::StaticClass, TEXT("UNiagaraDataInterfaceExport"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceExport, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceExport), 351690897U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceExport_h_4136108493(TEXT("/Script/Niagara"),
