...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraPerfBaselineStats>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNiagaraBaselineController_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UNiagaraBaselineController_OnEndTest, "OnEndTest" }, // 2451446471
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraPerfBaseline_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraPerfBaselineStats::StaticStruct, Z_Construct_UScriptStruct_FNiagaraPerfBaselineStats_Statics::NewStructOps, TEXT("NiagaraPerfBaselineStats"), &Z_Registration_Info_UScriptStruct_NiagaraPerfBaselineStats, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraPerfBaselineStats), 2412919963U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraPerfBaseline_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraBaselineController, UNiagaraBaselineController::StaticClass, TEXT("UNiagaraBaselineController"), &Z_Registration_Info_UClass_UNiagaraBaselineController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraBaselineController), 1615285271U) },
		{ Z_Construct_UClass_UNiagaraBaselineController_Basic, UNiagaraBaselineController_Basic::StaticClass, TEXT("UNiagaraBaselineController_Basic"), &Z_Registration_Info_UClass_UNiagaraBaselineController_Basic, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraBaselineController_Basic), 754260217U) },
		{ Z_Construct_UClass_ANiagaraPerfBaselineActor, ANiagaraPerfBaselineActor::StaticClass, TEXT("ANiagaraPerfBaselineActor"), &Z_Registration_Info_UClass_ANiagaraPerfBaselineActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANiagaraPerfBaselineActor), 2685343803U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraPerfBaseline_h_2851395762(TEXT("/Script/Niagara"),
