...
// End Cross Module References
	...
	static UEnum* ENDIActorComponentSourceMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENDIActorComponentSourceMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENDIActorComponentSourceMode, Z_Construct_UPackage__Script_Niagara(), TEXT("ENDIActorComponentSourceMode"));
		}
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_DataInterface_NiagaraDataInterfaceActorComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraDataInterfaceActorComponent, UNiagaraDataInterfaceActorComponent::StaticClass, TEXT("UNiagaraDataInterfaceActorComponent"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceActorComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceActorComponent), 3332016901U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_DataInterface_NiagaraDataInterfaceActorComponent_h_146316773(TEXT("/Script/Niagara"),
