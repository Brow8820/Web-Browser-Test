...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraCulledComponentInfo>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraCullProxyComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraCullProxyComponent, UNiagaraCullProxyComponent::StaticClass, TEXT("UNiagaraCullProxyComponent"), &Z_Registration_Info_UClass_UNiagaraCullProxyComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraCullProxyComponent), 2191625740U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraCullProxyComponent_h_4218427350(TEXT("/Script/Niagara"),
