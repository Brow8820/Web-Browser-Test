...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraPlatformSetConflictInfo>()
{
	...
	static UEnum* ENiagaraCVarConditionResponse_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENiagaraCVarConditionResponse.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENiagaraCVarConditionResponse, Z_Construct_UPackage__Script_Niagara(), TEXT("ENiagaraCVarConditionResponse"));
		}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraPlatformSetCVarCondition>()
{
	...
	static UEnum* ENiagaraDeviceProfileRedirectMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENiagaraDeviceProfileRedirectMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENiagaraDeviceProfileRedirectMode, Z_Construct_UPackage__Script_Niagara(), TEXT("ENiagaraDeviceProfileRedirectMode"));
		}
...
class UScriptStruct* FNiagaraPlatformSetRedirect::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraPlatformSetRedirect.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraPlatformSetRedirect, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraPlatformSetRedirect"));
	}
