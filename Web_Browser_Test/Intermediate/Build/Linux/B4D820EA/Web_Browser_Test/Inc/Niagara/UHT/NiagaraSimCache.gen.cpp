...
// End Cross Module References
	...
	static UEnum* ENiagaraSimCacheAttributeCaptureMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENiagaraSimCacheAttributeCaptureMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENiagaraSimCacheAttributeCaptureMode, Z_Construct_UPackage__Script_Niagara(), TEXT("ENiagaraSimCacheAttributeCaptureMode"));
		}
...
class UScriptStruct* FNiagaraSimCacheCreateParameters::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraSimCacheCreateParameters.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraSimCacheCreateParameters, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraSimCacheCreateParameters"));
	}
...
class UScriptStruct* FNiagaraSimCacheDataBuffers::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraSimCacheDataBuffers.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraSimCacheDataBuffers, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraSimCacheDataBuffers"));
	}
...
class UScriptStruct* FNiagaraSimCacheEmitterFrame::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraSimCacheEmitterFrame.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraSimCacheEmitterFrame, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraSimCacheEmitterFrame"));
	}
...
class UScriptStruct* FNiagaraSimCacheSystemFrame::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraSimCacheSystemFrame.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraSimCacheSystemFrame, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraSimCacheSystemFrame"));
	}
...
class UScriptStruct* FNiagaraSimCacheFrame::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraSimCacheFrame.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraSimCacheFrame, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraSimCacheFrame"));
	}
...
class UScriptStruct* FNiagaraSimCacheVariable::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraSimCacheVariable.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraSimCacheVariable, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraSimCacheVariable"));
	}
...
class UScriptStruct* FNiagaraSimCacheDataBuffersLayout::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraSimCacheDataBuffersLayout.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraSimCacheDataBuffersLayout, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraSimCacheDataBuffersLayout"));
	}
...
class UScriptStruct* FNiagaraSimCacheLayout::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraSimCacheLayout.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraSimCacheLayout, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraSimCacheLayout"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraSimCacheLayout>()
{
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNiagaraSimCacheLayout_Statics::NewProp_EmitterLayouts = { "EmitterLayouts", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FNiagaraSimCacheLayout, EmitterLayouts), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraSimCacheLayout_Statics::NewProp_EmitterLayouts_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraSimCacheLayout_Statics::NewProp_EmitterLayouts_MetaData)) }; // 1317046817
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraSimCache_h_Statics::ScriptStructInfo[] = {
		...
		{ FNiagaraSimCacheLayout::StaticStruct, Z_Construct_UScriptStruct_FNiagaraSimCacheLayout_Statics::NewStructOps, TEXT("NiagaraSimCacheLayout"), &Z_Registration_Info_UScriptStruct_NiagaraSimCacheLayout, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraSimCacheLayout), 2475227559U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraSimCache_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraSimCache, UNiagaraSimCache::StaticClass, TEXT("UNiagaraSimCache"), &Z_Registration_Info_UClass_UNiagaraSimCache, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraSimCache), 208955854U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraSimCache_h_3889599628(TEXT("/Script/Niagara"),
