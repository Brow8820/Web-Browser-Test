...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraDataInterfaceRigidMeshCollisionQuery_Statics::NewProp_GlobalSearchAllowed_MetaData[] = {
		{ "Category", "Source" },
		{ "Comment", "/** If enabled the global search can be executed dependeing on GlobalSearchForced and GlobalSearchFallback_Unscripted */" },
		{ "DisplayName", "Global Search Allowed" },
		{ "ModuleRelativePath", "Public/NiagaraDataInterfaceRigidMeshCollisionQuery.h" },
		{ "ToolTip", "If enabled the global search can be executed dependeing on GlobalSearchForced and GlobalSearchFallback_Unscripted" },
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraDataInterfaceRigidMeshCollisionQuery_Statics::NewProp_GlobalSearchForced_MetaData[] = {
		{ "Category", "Source" },
		{ "Comment", "/** If enabled the global search will be performed only if there are no explicit actors specified */" },
		{ "DisplayName", "Global Search Forced" },
		{ "EditCondition", "GlobalSearchAllowed" },
		{ "ModuleRelativePath", "Public/NiagaraDataInterfaceRigidMeshCollisionQuery.h" },
		{ "ToolTip", "If enabled the global search will be performed only if there are no explicit actors specified" },
	};
#endif
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraDataInterfaceRigidMeshCollisionQuery_h_3629222400(TEXT("/Script/Niagara"),
