...
class UScriptStruct* FNiagaraBakerCameraSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraBakerCameraSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraBakerCameraSettings, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraBakerCameraSettings"));
	}
