...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraMeshRendererMeshProperties>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraMeshRendererProperties_Statics::NewProp_OverrideMaterials_Inner = { "OverrideMaterials", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FNiagaraMeshMaterialOverride, METADATA_PARAMS(nullptr, 0) }; // 1193440861
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraMeshRendererProperties_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraMeshRendererProperties, UNiagaraMeshRendererProperties::StaticClass, TEXT("UNiagaraMeshRendererProperties"), &Z_Registration_Info_UClass_UNiagaraMeshRendererProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraMeshRendererProperties), 1164102467U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraMeshRendererProperties_h_525288001(TEXT("/Script/Niagara"),
