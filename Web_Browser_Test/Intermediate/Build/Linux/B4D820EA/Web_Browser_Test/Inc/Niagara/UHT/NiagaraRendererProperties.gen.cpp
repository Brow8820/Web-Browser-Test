...
// End Cross Module References
	...
	static UEnum* ENiagaraRendererSortPrecision_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENiagaraRendererSortPrecision.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENiagaraRendererSortPrecision, Z_Construct_UPackage__Script_Niagara(), TEXT("ENiagaraRendererSortPrecision"));
		}
	...
	static UEnum* ENiagaraRendererGpuTranslucentLatency_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENiagaraRendererGpuTranslucentLatency.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENiagaraRendererGpuTranslucentLatency, Z_Construct_UPackage__Script_Niagara(), TEXT("ENiagaraRendererGpuTranslucentLatency"));
		}
...
class UScriptStruct* FNiagaraRendererMaterialScalarParameter::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraRendererMaterialScalarParameter.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraRendererMaterialScalarParameter, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraRendererMaterialScalarParameter"));
	}
...
class UScriptStruct* FNiagaraRendererMaterialVectorParameter::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraRendererMaterialVectorParameter.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraRendererMaterialVectorParameter, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraRendererMaterialVectorParameter"));
	}
...
class UScriptStruct* FNiagaraRendererMaterialTextureParameter::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraRendererMaterialTextureParameter.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraRendererMaterialTextureParameter, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraRendererMaterialTextureParameter"));
	}
...
class UScriptStruct* FNiagaraRendererMaterialParameters::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraRendererMaterialParameters.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraRendererMaterialParameters, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraRendererMaterialParameters"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraRendererMaterialParameters>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraRendererProperties_h_Statics::ScriptStructInfo[] = {
		...
		{ FNiagaraRendererMaterialParameters::StaticStruct, Z_Construct_UScriptStruct_FNiagaraRendererMaterialParameters_Statics::NewStructOps, TEXT("NiagaraRendererMaterialParameters"), &Z_Registration_Info_UScriptStruct_NiagaraRendererMaterialParameters, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraRendererMaterialParameters), 777178007U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraRendererProperties_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraRendererProperties, UNiagaraRendererProperties::StaticClass, TEXT("UNiagaraRendererProperties"), &Z_Registration_Info_UClass_UNiagaraRendererProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraRendererProperties), 2642673841U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraRendererProperties_h_3545487136(TEXT("/Script/Niagara"),
