...
// End Cross Module References
	...
	static UEnum* ENiagaraDefaultSortPrecision_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENiagaraDefaultSortPrecision.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENiagaraDefaultSortPrecision, Z_Construct_UPackage__Script_Niagara(), TEXT("ENiagaraDefaultSortPrecision"));
		}
	...
	static UEnum* ENiagaraDefaultGpuTranslucentLatency_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENiagaraDefaultGpuTranslucentLatency.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENiagaraDefaultGpuTranslucentLatency, Z_Construct_UPackage__Script_Niagara(), TEXT("ENiagaraDefaultGpuTranslucentLatency"));
		}
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraSettings, UNiagaraSettings::StaticClass, TEXT("UNiagaraSettings"), &Z_Registration_Info_UClass_UNiagaraSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraSettings), 1851851272U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraSettings_h_137694178(TEXT("/Script/Niagara"),
