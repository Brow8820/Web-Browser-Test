...
// End Cross Module References
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceRW_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UNiagaraDataInterfaceGrid3D, UNiagaraDataInterfaceGrid3D::StaticClass, TEXT("UNiagaraDataInterfaceGrid3D"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceGrid3D, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceGrid3D), 959939130U) },
		{ Z_Construct_UClass_UNiagaraDataInterfaceGrid2D, UNiagaraDataInterfaceGrid2D::StaticClass, TEXT("UNiagaraDataInterfaceGrid2D"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceGrid2D, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceGrid2D), 1323488908U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceRW_h_2305808976(TEXT("/Script/Niagara"),
