...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraComponentPropertyBinding>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraComponentRendererProperties_Statics::NewProp_PropertyBindings_Inner = { "PropertyBindings", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FNiagaraComponentPropertyBinding, METADATA_PARAMS(nullptr, 0) }; // 2399132553
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraComponentRendererProperties_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraComponentRendererProperties, UNiagaraComponentRendererProperties::StaticClass, TEXT("UNiagaraComponentRendererProperties"), &Z_Registration_Info_UClass_UNiagaraComponentRendererProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraComponentRendererProperties), 3808691743U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraComponentRendererProperties_h_2640116568(TEXT("/Script/Niagara"),
