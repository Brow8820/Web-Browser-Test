...
class UScriptStruct* FSynesthesiaSpectrumResults::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SynesthesiaSpectrumResults.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSynesthesiaSpectrumResults, Z_Construct_UPackage__Script_AudioSynesthesia(), TEXT("SynesthesiaSpectrumResults"));
	}
...
template<> AUDIOSYNESTHESIA_API UScriptStruct* StaticStruct<FSynesthesiaSpectrumResults>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioSynesthesia_Source_AudioSynesthesia_Classes_SynesthesiaSpectrumAnalysis_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_USynesthesiaSpectrumAnalyzer, USynesthesiaSpectrumAnalyzer::StaticClass, TEXT("USynesthesiaSpectrumAnalyzer"), &Z_Registration_Info_UClass_USynesthesiaSpectrumAnalyzer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USynesthesiaSpectrumAnalyzer), 3790757113U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioSynesthesia_Source_AudioSynesthesia_Classes_SynesthesiaSpectrumAnalysis_h_1296239005(TEXT("/Script/AudioSynesthesia"),
