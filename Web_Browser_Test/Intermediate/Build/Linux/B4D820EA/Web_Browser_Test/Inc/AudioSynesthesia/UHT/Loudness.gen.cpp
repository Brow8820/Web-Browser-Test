...
template<> AUDIOSYNESTHESIA_API UScriptStruct* StaticStruct<FLoudnessResults>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioSynesthesia_Source_AudioSynesthesia_Classes_Loudness_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_ULoudnessAnalyzer, ULoudnessAnalyzer::StaticClass, TEXT("ULoudnessAnalyzer"), &Z_Registration_Info_UClass_ULoudnessAnalyzer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULoudnessAnalyzer), 280712909U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioSynesthesia_Source_AudioSynesthesia_Classes_Loudness_h_3085673308(TEXT("/Script/AudioSynesthesia"),
