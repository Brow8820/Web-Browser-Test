...
template<> AUDIOSYNESTHESIA_API UScriptStruct* StaticStruct<FMeterResults>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioSynesthesia_Source_AudioSynesthesia_Classes_Meter_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UMeterAnalyzer, UMeterAnalyzer::StaticClass, TEXT("UMeterAnalyzer"), &Z_Registration_Info_UClass_UMeterAnalyzer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMeterAnalyzer), 3905249541U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioSynesthesia_Source_AudioSynesthesia_Classes_Meter_h_1993260737(TEXT("/Script/AudioSynesthesia"),
