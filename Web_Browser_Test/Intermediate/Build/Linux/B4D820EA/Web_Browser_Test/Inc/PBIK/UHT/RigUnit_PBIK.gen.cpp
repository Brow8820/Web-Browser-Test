...
class UScriptStruct* FRigUnit_PBIK::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_PBIK.OuterSingleton)
	{
		...
		Arguments_FRigUnit_PBIK_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_PBIK_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
...
void FRigUnit_PBIK::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_FullBodyIK_Source_PBIK_Public_RigUnit_PBIK_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_PBIK::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_PBIK_Statics::NewStructOps, TEXT("RigUnit_PBIK"), &Z_Registration_Info_UScriptStruct_RigUnit_PBIK, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_PBIK), 3076481406U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_FullBodyIK_Source_PBIK_Public_RigUnit_PBIK_h_1267417075(TEXT("/Script/PBIK"),
		nullptr, 0,
