...
#include "GameplayTags/Public/GameplayTagNetSerializer.h"
...
class UScriptStruct* FGameplayTagNetSerializerConfig::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GameplayTagNetSerializerConfig.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGameplayTagNetSerializerConfig, Z_Construct_UPackage__Script_GameplayTags(), TEXT("GameplayTagNetSerializerConfig"));
	}
