...
template<> GEOMETRYCACHETRACKS_API UScriptStruct* StaticStruct<FMovieSceneGeometryCacheParams>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCacheTracks_Classes_MovieSceneGeometryCacheSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneGeometryCacheSection, UMovieSceneGeometryCacheSection::StaticClass, TEXT("UMovieSceneGeometryCacheSection"), &Z_Registration_Info_UClass_UMovieSceneGeometryCacheSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneGeometryCacheSection), 1352708833U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCacheTracks_Classes_MovieSceneGeometryCacheSection_h_4074039316(TEXT("/Script/GeometryCacheTracks"),
