...
class UScriptStruct* FMeterChannelInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MeterChannelInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMeterChannelInfo, Z_Construct_UPackage__Script_AudioWidgets(), TEXT("MeterChannelInfo"));
	}
