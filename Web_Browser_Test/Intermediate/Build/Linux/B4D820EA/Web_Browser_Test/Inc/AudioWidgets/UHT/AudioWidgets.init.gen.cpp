...
void EmptyLinkFunctionForGeneratedCodeAudioWidgets_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_AudioWidgets()
	{
		if (!Z_Registration_Info_UPackage__Script_AudioWidgets.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_AudioWidgets_OnFloatValueChangedEvent__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_AudioWidgets(Z_Construct_UPackage__Script_AudioWidgets, TEXT("/Script/AudioWidgets"), Z_Registration_Info_UPackage__Script_AudioWidgets, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0xD3487C0F, 0x1AC5307B));
