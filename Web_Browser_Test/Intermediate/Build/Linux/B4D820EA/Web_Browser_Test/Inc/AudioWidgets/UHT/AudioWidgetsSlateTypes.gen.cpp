...
class UScriptStruct* FAudioTextBoxStyle::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AudioTextBoxStyle.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAudioTextBoxStyle, Z_Construct_UPackage__Script_AudioWidgets(), TEXT("AudioTextBoxStyle"));
	}
...
class UScriptStruct* FAudioSliderStyle::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AudioSliderStyle.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAudioSliderStyle, Z_Construct_UPackage__Script_AudioWidgets(), TEXT("AudioSliderStyle"));
	}
...
class UScriptStruct* FAudioRadialSliderStyle::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AudioRadialSliderStyle.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAudioRadialSliderStyle, Z_Construct_UPackage__Script_AudioWidgets(), TEXT("AudioRadialSliderStyle"));
	}
...
template<> AUDIOWIDGETS_API UScriptStruct* StaticStruct<FAudioRadialSliderStyle>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioWidgetsSlateTypes_h_Statics::ScriptStructInfo[] = {
		{ FAudioTextBoxStyle::StaticStruct, Z_Construct_UScriptStruct_FAudioTextBoxStyle_Statics::NewStructOps, TEXT("AudioTextBoxStyle"), &Z_Registration_Info_UScriptStruct_AudioTextBoxStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAudioTextBoxStyle), 2198619206U) },
		{ FAudioSliderStyle::StaticStruct, Z_Construct_UScriptStruct_FAudioSliderStyle_Statics::NewStructOps, TEXT("AudioSliderStyle"), &Z_Registration_Info_UScriptStruct_AudioSliderStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAudioSliderStyle), 4241502519U) },
		{ FAudioRadialSliderStyle::StaticStruct, Z_Construct_UScriptStruct_FAudioRadialSliderStyle_Statics::NewStructOps, TEXT("AudioRadialSliderStyle"), &Z_Registration_Info_UScriptStruct_AudioRadialSliderStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAudioRadialSliderStyle), 2916376760U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioWidgetsSlateTypes_h_2568109411(TEXT("/Script/AudioWidgets"),
		nullptr, 0,
