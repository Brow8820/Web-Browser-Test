...
#define FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioMeterTypes_h_11_GENERATED_BODY \
...
template<> AUDIOWIDGETS_API UScriptStruct* StaticStruct<struct FMeterChannelInfo>();
