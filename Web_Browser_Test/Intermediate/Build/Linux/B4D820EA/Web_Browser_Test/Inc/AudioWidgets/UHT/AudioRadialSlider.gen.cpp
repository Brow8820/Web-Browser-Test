...
// End Cross Module References
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioRadialSlider_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioRadialSlider, UAudioRadialSlider::StaticClass, TEXT("UAudioRadialSlider"), &Z_Registration_Info_UClass_UAudioRadialSlider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioRadialSlider), 1580930420U) },
		{ Z_Construct_UClass_UAudioVolumeRadialSlider, UAudioVolumeRadialSlider::StaticClass, TEXT("UAudioVolumeRadialSlider"), &Z_Registration_Info_UClass_UAudioVolumeRadialSlider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioVolumeRadialSlider), 3068591003U) },
		{ Z_Construct_UClass_UAudioFrequencyRadialSlider, UAudioFrequencyRadialSlider::StaticClass, TEXT("UAudioFrequencyRadialSlider"), &Z_Registration_Info_UClass_UAudioFrequencyRadialSlider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioFrequencyRadialSlider), 2283861178U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioRadialSlider_h_1972647719(TEXT("/Script/AudioWidgets"),
