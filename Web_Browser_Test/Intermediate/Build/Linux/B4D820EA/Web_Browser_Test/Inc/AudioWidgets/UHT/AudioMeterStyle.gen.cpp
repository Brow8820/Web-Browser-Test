...
class UScriptStruct* FAudioMeterStyle::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AudioMeterStyle.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAudioMeterStyle, Z_Construct_UPackage__Script_AudioWidgets(), TEXT("AudioMeterStyle"));
	}
...
template<> AUDIOWIDGETS_API UScriptStruct* StaticStruct<FAudioMeterStyle>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioMeterStyle_h_Statics::ScriptStructInfo[] = {
		{ FAudioMeterStyle::StaticStruct, Z_Construct_UScriptStruct_FAudioMeterStyle_Statics::NewStructOps, TEXT("AudioMeterStyle"), &Z_Registration_Info_UScriptStruct_AudioMeterStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAudioMeterStyle), 3712927655U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioMeterStyle_h_3438859720(TEXT("/Script/AudioWidgets"),
		nullptr, 0,
