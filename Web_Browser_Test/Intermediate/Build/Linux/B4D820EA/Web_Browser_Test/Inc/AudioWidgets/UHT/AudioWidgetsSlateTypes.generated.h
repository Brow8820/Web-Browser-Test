...
#define FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioWidgetsSlateTypes_h_20_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FAudioTextBoxStyle_Statics; \
	static class UScriptStruct* StaticStruct(); \
	typedef FSlateWidgetStyle Super;


template<> AUDIOWIDGETS_API UScriptStruct* StaticStruct<struct FAudioTextBoxStyle>();

#define FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioWidgetsSlateTypes_h_59_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FAudioSliderStyle_Statics; \
	static class UScriptStruct* StaticStruct(); \
	typedef FSlateWidgetStyle Super;


template<> AUDIOWIDGETS_API UScriptStruct* StaticStruct<struct FAudioSliderStyle>();

#define FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioWidgetsSlateTypes_h_134_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FAudioRadialSliderStyle_Statics; \
	static class UScriptStruct* StaticStruct(); \
	typedef FSlateWidgetStyle Super;


template<> AUDIOWIDGETS_API UScriptStruct* StaticStruct<struct FAudioRadialSliderStyle>();
