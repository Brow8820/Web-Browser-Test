...
// Cross Module References
	...
	AUDIOWIDGETS_API UFunction* Z_Construct_UDelegateFunction_AudioWidgets_OnFloatValueChangedEvent__DelegateSignature();
...
// End Cross Module References
	struct Z_Construct_UDelegateFunction_AudioWidgets_OnFloatValueChangedEvent__DelegateSignature_Statics
	{
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_AudioWidgets_OnFloatValueChangedEvent__DelegateSignature_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_AudioWidgets_eventOnFloatValueChangedEvent_Parms, Value), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_AudioWidgets_OnFloatValueChangedEvent__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_AudioWidgets_OnFloatValueChangedEvent__DelegateSignature_Statics::NewProp_Value,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_AudioWidgets_OnFloatValueChangedEvent__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/AudioSlider.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_AudioWidgets_OnFloatValueChangedEvent__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_AudioWidgets, nullptr, "OnFloatValueChangedEvent__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_AudioWidgets_OnFloatValueChangedEvent__DelegateSignature_Statics::_Script_AudioWidgets_eventOnFloatValueChangedEvent_Parms), Z_Construct_UDelegateFunction_AudioWidgets_OnFloatValueChangedEvent__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AudioWidgets_OnFloatValueChangedEvent__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_AudioWidgets_OnFloatValueChangedEvent__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AudioWidgets_OnFloatValueChangedEvent__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_AudioWidgets_OnFloatValueChangedEvent__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_AudioWidgets_OnFloatValueChangedEvent__DelegateSignature_Statics::FuncParams);
		}
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioSlider_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioSliderBase, UAudioSliderBase::StaticClass, TEXT("UAudioSliderBase"), &Z_Registration_Info_UClass_UAudioSliderBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioSliderBase), 2064371236U) },
		{ Z_Construct_UClass_UAudioSlider, UAudioSlider::StaticClass, TEXT("UAudioSlider"), &Z_Registration_Info_UClass_UAudioSlider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioSlider), 3251688981U) },
		{ Z_Construct_UClass_UAudioVolumeSlider, UAudioVolumeSlider::StaticClass, TEXT("UAudioVolumeSlider"), &Z_Registration_Info_UClass_UAudioVolumeSlider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioVolumeSlider), 2601161574U) },
		{ Z_Construct_UClass_UAudioFrequencySlider, UAudioFrequencySlider::StaticClass, TEXT("UAudioFrequencySlider"), &Z_Registration_Info_UClass_UAudioFrequencySlider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioFrequencySlider), 1085033967U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioWidgets_Source_AudioWidgets_Public_AudioSlider_h_997183080(TEXT("/Script/AudioWidgets"),
