...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_DefaultPreviewMesh_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPtrPropertyParams NewProp_DefaultPreviewMesh;
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGLTFMaterialExporter_Statics::NewProp_DefaultPreviewMesh_MetaData[] = {
		{ "ModuleRelativePath", "Public/Exporters/GLTFMaterialExporter.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGLTFMaterialExporter_Statics::NewProp_DefaultPreviewMesh = { "DefaultPreviewMesh", nullptr, (EPropertyFlags)0x0044000000202000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UGLTFMaterialExporter, DefaultPreviewMesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGLTFMaterialExporter_Statics::NewProp_DefaultPreviewMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGLTFMaterialExporter_Statics::NewProp_DefaultPreviewMesh_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UGLTFMaterialExporter_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UGLTFMaterialExporter_Statics::NewProp_DefaultPreviewMesh,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_GLTFExporter_Source_GLTFExporter_Public_Exporters_GLTFMaterialExporter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGLTFMaterialExporter, UGLTFMaterialExporter::StaticClass, TEXT("UGLTFMaterialExporter"), &Z_Registration_Info_UClass_UGLTFMaterialExporter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGLTFMaterialExporter), 3582433921U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_GLTFExporter_Source_GLTFExporter_Public_Exporters_GLTFMaterialExporter_h_2559377768(TEXT("/Script/GLTFExporter"),
