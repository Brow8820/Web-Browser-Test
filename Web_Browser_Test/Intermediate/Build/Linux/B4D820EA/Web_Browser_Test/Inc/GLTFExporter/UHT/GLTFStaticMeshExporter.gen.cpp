...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGLTFStaticMeshExporter_Statics::Class_MetaDataParams[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_GLTFExporter_Source_GLTFExporter_Public_Exporters_GLTFStaticMeshExporter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGLTFStaticMeshExporter, UGLTFStaticMeshExporter::StaticClass, TEXT("UGLTFStaticMeshExporter"), &Z_Registration_Info_UClass_UGLTFStaticMeshExporter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGLTFStaticMeshExporter), 707799473U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_GLTFExporter_Source_GLTFExporter_Public_Exporters_GLTFStaticMeshExporter_h_3207967068(TEXT("/Script/GLTFExporter"),
