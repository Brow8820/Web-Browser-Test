...
// End Cross Module References
	...
	static UEnum* EMetasoundFrontendLiteralType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMetasoundFrontendLiteralType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MetasoundFrontend_EMetasoundFrontendLiteralType, Z_Construct_UPackage__Script_MetasoundFrontend(), TEXT("EMetasoundFrontendLiteralType"));
		}
...
class UScriptStruct* FMetasoundFrontendLiteral::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MetasoundFrontendLiteral.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMetasoundFrontendLiteral, Z_Construct_UPackage__Script_MetasoundFrontend(), TEXT("MetasoundFrontendLiteral"));
	}
