...
template<> LANDSCAPE_API UScriptStruct* StaticStruct<FForeignWorldSplineData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeSplinesComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULandscapeSplinesComponent, ULandscapeSplinesComponent::StaticClass, TEXT("ULandscapeSplinesComponent"), &Z_Registration_Info_UClass_ULandscapeSplinesComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULandscapeSplinesComponent), 352536518U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeSplinesComponent_h_421700186(TEXT("/Script/Landscape"),
