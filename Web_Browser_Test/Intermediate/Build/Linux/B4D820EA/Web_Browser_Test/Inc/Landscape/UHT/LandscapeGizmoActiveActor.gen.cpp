...
template<> LANDSCAPE_API UScriptStruct* StaticStruct<FGizmoSelectData>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_bSnapToLandscapeGrid = { "bSnapToLandscapeGrid", nullptr, (EPropertyFlags)0x0010000800002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(ALandscapeGizmoActiveActor), &Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_bSnapToLandscapeGrid_SetBit, METADATA_PARAMS(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_bSnapToLandscapeGrid_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_bSnapToLandscapeGrid_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeGizmoActiveActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALandscapeGizmoActiveActor, ALandscapeGizmoActiveActor::StaticClass, TEXT("ALandscapeGizmoActiveActor"), &Z_Registration_Info_UClass_ALandscapeGizmoActiveActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALandscapeGizmoActiveActor), 3508434716U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeGizmoActiveActor_h_1774804499(TEXT("/Script/Landscape"),
