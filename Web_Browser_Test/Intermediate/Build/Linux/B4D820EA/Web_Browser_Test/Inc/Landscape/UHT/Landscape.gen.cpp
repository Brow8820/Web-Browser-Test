...
template<> LANDSCAPE_API UScriptStruct* StaticStruct<FLandscapeLayer>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_Landscape_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALandscape, ALandscape::StaticClass, TEXT("ALandscape"), &Z_Registration_Info_UClass_ALandscape, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALandscape), 653967990U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_Landscape_h_212263236(TEXT("/Script/Landscape"),
