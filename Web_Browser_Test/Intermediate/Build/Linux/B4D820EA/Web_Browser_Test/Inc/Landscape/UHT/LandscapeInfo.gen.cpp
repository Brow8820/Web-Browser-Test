...
template<> LANDSCAPE_API UScriptStruct* StaticStruct<FLandscapeInfoLayerSettings>()
{
...
#endif
	const UECodeGen_Private::FLazyObjectPropertyParams Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_LandscapeActor = { "LandscapeActor", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::LazyObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULandscapeInfo, LandscapeActor), Z_Construct_UClass_ALandscape_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_LandscapeActor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_LandscapeActor_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeInfo_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULandscapeInfo, ULandscapeInfo::StaticClass, TEXT("ULandscapeInfo"), &Z_Registration_Info_UClass_ULandscapeInfo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULandscapeInfo), 2844546426U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeInfo_h_469364259(TEXT("/Script/Landscape"),
