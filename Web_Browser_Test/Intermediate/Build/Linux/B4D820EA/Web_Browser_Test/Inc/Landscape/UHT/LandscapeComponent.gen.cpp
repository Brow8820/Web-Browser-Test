...
class UScriptStruct* FLandscapePerLODMaterialOverride::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LandscapePerLODMaterialOverride.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLandscapePerLODMaterialOverride, Z_Construct_UPackage__Script_Landscape(), TEXT("LandscapePerLODMaterialOverride"));
	}
...
template<> LANDSCAPE_API UScriptStruct* StaticStruct<FLandscapeLayerComponentData>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULandscapeComponent_Statics::NewProp_IrrelevantLights_Inner = { "IrrelevantLights", nullptr, (EPropertyFlags)0x0000000020000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULandscapeComponent_Statics::NewProp_IrrelevantLights = { "IrrelevantLights", nullptr, (EPropertyFlags)0x0010000020000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULandscapeComponent, IrrelevantLights_DEPRECATED), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULandscapeComponent_Statics::NewProp_IrrelevantLights_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeComponent_Statics::NewProp_IrrelevantLights_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULandscapeLODStreamingProxy_DEPRECATED, ULandscapeLODStreamingProxy_DEPRECATED::StaticClass, TEXT("ULandscapeLODStreamingProxy_DEPRECATED"), &Z_Registration_Info_UClass_ULandscapeLODStreamingProxy_DEPRECATED, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULandscapeLODStreamingProxy_DEPRECATED), 3316361021U) },
		{ Z_Construct_UClass_ULandscapeComponent, ULandscapeComponent::StaticClass, TEXT("ULandscapeComponent"), &Z_Registration_Info_UClass_ULandscapeComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULandscapeComponent), 1371413142U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeComponent_h_2552630716(TEXT("/Script/Landscape"),
