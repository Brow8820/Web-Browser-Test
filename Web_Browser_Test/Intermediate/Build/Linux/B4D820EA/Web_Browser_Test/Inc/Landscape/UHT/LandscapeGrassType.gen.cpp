...
template<> LANDSCAPE_API UScriptStruct* StaticStruct<FGrassVariety>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeGrassType_h_Statics::ScriptStructInfo[] = {
		{ FGrassVariety::StaticStruct, Z_Construct_UScriptStruct_FGrassVariety_Statics::NewStructOps, TEXT("GrassVariety"), &Z_Registration_Info_UScriptStruct_GrassVariety, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGrassVariety), 383523705U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeGrassType_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULandscapeGrassType, ULandscapeGrassType::StaticClass, TEXT("ULandscapeGrassType"), &Z_Registration_Info_UClass_ULandscapeGrassType, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULandscapeGrassType), 1176352299U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeGrassType_h_1106318859(TEXT("/Script/Landscape"),
