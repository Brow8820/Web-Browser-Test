...
template<> GAMEPLAYDEBUGGER_API UScriptStruct* StaticStruct<FGameplayDebuggerPlayerData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerPlayerManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGameplayDebuggerPlayerManager, AGameplayDebuggerPlayerManager::StaticClass, TEXT("AGameplayDebuggerPlayerManager"), &Z_Registration_Info_UClass_AGameplayDebuggerPlayerManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGameplayDebuggerPlayerManager), 825462717U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerPlayerManager_h_123140463(TEXT("/Script/GameplayDebugger"),
