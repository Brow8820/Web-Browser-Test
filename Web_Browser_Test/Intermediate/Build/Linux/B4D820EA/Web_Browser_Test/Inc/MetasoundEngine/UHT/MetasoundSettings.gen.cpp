...
// End Cross Module References
	...
	static UEnum* EMetaSoundMessageLevel_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMetaSoundMessageLevel.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MetasoundEngine_EMetaSoundMessageLevel, Z_Construct_UPackage__Script_MetasoundEngine(), TEXT("EMetaSoundMessageLevel"));
		}
...
class UScriptStruct* FDefaultMetaSoundAssetAutoUpdateSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DefaultMetaSoundAssetAutoUpdateSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDefaultMetaSoundAssetAutoUpdateSettings, Z_Construct_UPackage__Script_MetasoundEngine(), TEXT("DefaultMetaSoundAssetAutoUpdateSettings"));
	}
