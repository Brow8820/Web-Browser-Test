...
class UScriptStruct* FMetaSoundAssetDirectory::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MetaSoundAssetDirectory.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMetaSoundAssetDirectory, Z_Construct_UPackage__Script_MetasoundEngine(), TEXT("MetaSoundAssetDirectory"));
	}
...
class UScriptStruct* FMetaSoundAsyncAssetDependencies::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MetaSoundAsyncAssetDependencies.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMetaSoundAsyncAssetDependencies, Z_Construct_UPackage__Script_MetasoundEngine(), TEXT("MetaSoundAsyncAssetDependencies"));
	}
