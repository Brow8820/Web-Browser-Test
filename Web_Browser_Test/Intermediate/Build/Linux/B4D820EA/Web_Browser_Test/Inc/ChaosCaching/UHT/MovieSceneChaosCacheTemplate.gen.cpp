...
class UScriptStruct* FMovieSceneChaosCacheSectionTemplateParameters::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneChaosCacheSectionTemplateParameters.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneChaosCacheSectionTemplateParameters, Z_Construct_UPackage__Script_ChaosCaching(), TEXT("MovieSceneChaosCacheSectionTemplateParameters"));
	}
...
class UScriptStruct* FMovieSceneChaosCacheSectionTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneChaosCacheSectionTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneChaosCacheSectionTemplate, Z_Construct_UPackage__Script_ChaosCaching(), TEXT("MovieSceneChaosCacheSectionTemplate"));
	}
