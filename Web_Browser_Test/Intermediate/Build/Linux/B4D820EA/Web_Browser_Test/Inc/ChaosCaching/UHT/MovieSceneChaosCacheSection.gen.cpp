...
class UScriptStruct* FMovieSceneChaosCacheParams::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneChaosCacheParams.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneChaosCacheParams, Z_Construct_UPackage__Script_ChaosCaching(), TEXT("MovieSceneChaosCacheParams"));
	}
...
template<> CHAOSCACHING_API UScriptStruct* StaticStruct<FMovieSceneChaosCacheParams>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosCaching_Source_ChaosCaching_Public_Chaos_Sequencer_MovieSceneChaosCacheSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneChaosCacheSection, UMovieSceneChaosCacheSection::StaticClass, TEXT("UMovieSceneChaosCacheSection"), &Z_Registration_Info_UClass_UMovieSceneChaosCacheSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneChaosCacheSection), 3619719529U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_ChaosCaching_Source_ChaosCaching_Public_Chaos_Sequencer_MovieSceneChaosCacheSection_h_2415728759(TEXT("/Script/ChaosCaching"),
