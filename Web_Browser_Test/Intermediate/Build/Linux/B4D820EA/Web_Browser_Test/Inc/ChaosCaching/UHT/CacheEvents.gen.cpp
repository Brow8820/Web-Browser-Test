...
class UScriptStruct* FCacheEventBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CacheEventBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCacheEventBase, Z_Construct_UPackage__Script_ChaosCaching(), TEXT("CacheEventBase"));
	}
...
class UScriptStruct* FCacheEventTrack::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CacheEventTrack.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCacheEventTrack, Z_Construct_UPackage__Script_ChaosCaching(), TEXT("CacheEventTrack"));
	}
