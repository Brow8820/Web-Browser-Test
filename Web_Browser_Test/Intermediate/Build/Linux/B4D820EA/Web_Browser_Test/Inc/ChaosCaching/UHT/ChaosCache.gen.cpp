...
class UScriptStruct* FParticleTransformTrack::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ParticleTransformTrack.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FParticleTransformTrack, Z_Construct_UPackage__Script_ChaosCaching(), TEXT("ParticleTransformTrack"));
	}
...
class UScriptStruct* FPerParticleCacheData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PerParticleCacheData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPerParticleCacheData, Z_Construct_UPackage__Script_ChaosCaching(), TEXT("PerParticleCacheData"));
	}
...
class UScriptStruct* FCacheSpawnableTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CacheSpawnableTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCacheSpawnableTemplate, Z_Construct_UPackage__Script_ChaosCaching(), TEXT("CacheSpawnableTemplate"));
	}
...
class UScriptStruct* FRichCurves::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RichCurves.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRichCurves, Z_Construct_UPackage__Script_ChaosCaching(), TEXT("RichCurves"));
	}
