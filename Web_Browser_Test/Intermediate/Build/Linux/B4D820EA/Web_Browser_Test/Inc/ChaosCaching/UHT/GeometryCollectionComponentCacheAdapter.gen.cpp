...
class UScriptStruct* FEnableStateEvent::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EnableStateEvent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEnableStateEvent, Z_Construct_UPackage__Script_ChaosCaching(), TEXT("EnableStateEvent"));
	}
...
class UScriptStruct* FBreakingEvent::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BreakingEvent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBreakingEvent, Z_Construct_UPackage__Script_ChaosCaching(), TEXT("BreakingEvent"));
	}
...
class UScriptStruct* FCollisionEvent::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CollisionEvent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCollisionEvent, Z_Construct_UPackage__Script_ChaosCaching(), TEXT("CollisionEvent"));
	}
...
class UScriptStruct* FTrailingEvent::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TrailingEvent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTrailingEvent, Z_Construct_UPackage__Script_ChaosCaching(), TEXT("TrailingEvent"));
	}
