...
template<> ENGINE_API UScriptStruct* StaticStruct<FAlphaBlend>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_AlphaBlend_h_Statics::ScriptStructInfo[] = {
		{ FAlphaBlendArgs::StaticStruct, Z_Construct_UScriptStruct_FAlphaBlendArgs_Statics::NewStructOps, TEXT("AlphaBlendArgs"), &Z_Registration_Info_UScriptStruct_AlphaBlendArgs, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAlphaBlendArgs), 224497312U) },
		{ FAlphaBlend::StaticStruct, Z_Construct_UScriptStruct_FAlphaBlend_Statics::NewStructOps, TEXT("AlphaBlend"), &Z_Registration_Info_UScriptStruct_AlphaBlend, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAlphaBlend), 1978409609U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_AlphaBlend_h_3068247093(TEXT("/Script/Engine"),
		nullptr, 0,
