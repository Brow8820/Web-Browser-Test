...
#include "Engine/Public/LevelInstance/LevelInstanceInterface.h"
...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULevelInstanceInterface_Statics::Class_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/LevelInstance/LevelInstanceInterface.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_ULevelInstanceInterface_Statics::StaticCppClassTypeInfo = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ULevelInstanceInterface_Statics::ClassParams = {
		...
		0,
		0x001040A1u,
		METADATA_PARAMS(Z_Construct_UClass_ULevelInstanceInterface_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_ULevelInstanceInterface_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_LevelInstance_LevelInstanceInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULevelInstanceInterface, ULevelInstanceInterface::StaticClass, TEXT("ULevelInstanceInterface"), &Z_Registration_Info_UClass_ULevelInstanceInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULevelInstanceInterface), 990147043U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_LevelInstance_LevelInstanceInterface_h_2240417181(TEXT("/Script/Engine"),
