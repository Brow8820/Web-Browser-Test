...
template<> ENGINE_API UScriptStruct* StaticStruct<FNetViewer>()
{
	...
	static UEnum* EHierarchicalSimplificationMethod_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EHierarchicalSimplificationMethod.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EHierarchicalSimplificationMethod, Z_Construct_UPackage__Script_Engine(), TEXT("EHierarchicalSimplificationMethod"));
		}
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UHierarchicalLODSetup_Statics::NewProp_HierarchicalLODSetup = { "HierarchicalLODSetup", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UHierarchicalLODSetup, HierarchicalLODSetup), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UHierarchicalLODSetup_Statics::NewProp_HierarchicalLODSetup_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHierarchicalLODSetup_Statics::NewProp_HierarchicalLODSetup_MetaData)) }; // 4287212760
#if WITH_METADATA
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBroadphaseSettings>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_WorldSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHierarchicalLODSetup, UHierarchicalLODSetup::StaticClass, TEXT("UHierarchicalLODSetup"), &Z_Registration_Info_UClass_UHierarchicalLODSetup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHierarchicalLODSetup), 2750308541U) },
		{ Z_Construct_UClass_AWorldSettings, AWorldSettings::StaticClass, TEXT("AWorldSettings"), &Z_Registration_Info_UClass_AWorldSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AWorldSettings), 2872185452U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_WorldSettings_h_575757204(TEXT("/Script/Engine"),
