...
#include "Engine/Public/WorldPartition/ContentBundle/ContentBundleClient.h"
...
// End Cross Module References
	...
	static UEnum* EContentBundleClientState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EContentBundleClientState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EContentBundleClientState, Z_Construct_UPackage__Script_Engine(), TEXT("EContentBundleClientState"));
		}
	...
	static UEnum* EWorldContentState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EWorldContentState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EWorldContentState, Z_Construct_UPackage__Script_Engine(), TEXT("EWorldContentState"));
		}
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_Engine_EWorldContentState_Statics::Enumerators[] = {
		...
		{ "EWorldContentState::ContentBundleInjectionFailed", (int64)EWorldContentState::ContentBundleInjectionFailed },
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_Engine_EWorldContentState_Statics::Enum_MetaDataParams[] = {
		...
		{ "ContentBundleInjectionFailed.Name", "EWorldContentState::ContentBundleInjectionFailed" },
		{ "ModuleRelativePath", "Public/WorldPartition/ContentBundle/ContentBundleClient.h" },
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_ContentBundle_ContentBundleClient_h_Statics::EnumInfo[] = {
		...
		{ EWorldContentState_StaticEnum, TEXT("EWorldContentState"), &Z_Registration_Info_UEnum_EWorldContentState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 769962114U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_ContentBundle_ContentBundleClient_h_1747930459(TEXT("/Script/Engine"),
		nullptr, 0,
		nullptr, 0,
