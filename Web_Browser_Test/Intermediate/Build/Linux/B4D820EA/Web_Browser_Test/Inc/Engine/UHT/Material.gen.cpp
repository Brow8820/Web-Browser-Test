...
template<> ENGINE_API UScriptStruct* StaticStruct<FParameterGroupData>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_StrataBlendMode_MetaData[];
#endif
		static const UECodeGen_Private::FBytePropertyParams NewProp_StrataBlendMode;
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterial_Statics::NewProp_StrataBlendMode_MetaData[] = {
		{ "Category", "Material" },
		{ "Comment", "/** Determines how the material's color is blended with background colors. */" },
		{ "ModuleRelativePath", "Classes/Materials/Material.h" },
		{ "ToolTip", "Determines how the material's color is blended with background colors." },
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMaterial_Statics::NewProp_StrataBlendMode = { "StrataBlendMode", nullptr, (EPropertyFlags)0x0010010000000015, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UMaterial, StrataBlendMode), Z_Construct_UEnum_Engine_EStrataBlendMode, METADATA_PARAMS(Z_Construct_UClass_UMaterial_Statics::NewProp_StrataBlendMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterial_Statics::NewProp_StrataBlendMode_MetaData)) }; // 726924248
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMaterial_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMaterial_Statics::NewProp_StrataBlendMode,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_Material_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialEditorOnlyData, UMaterialEditorOnlyData::StaticClass, TEXT("UMaterialEditorOnlyData"), &Z_Registration_Info_UClass_UMaterialEditorOnlyData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialEditorOnlyData), 1986991714U) },
		{ Z_Construct_UClass_UMaterial, UMaterial::StaticClass, TEXT("UMaterial"), &Z_Registration_Info_UClass_UMaterial, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterial), 1636976735U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_Material_h_2534552761(TEXT("/Script/Engine"),
