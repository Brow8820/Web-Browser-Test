...
template<> ENGINE_API UScriptStruct* StaticStruct<FSkeletalMaterial>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_SkinnedAssetCommon_h_Statics::EnumInfo[] = {
		{ ESkinCacheUsage_StaticEnum, TEXT("ESkinCacheUsage"), &Z_Registration_Info_UEnum_ESkinCacheUsage, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 625670830U) },
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_SkinnedAssetCommon_h_Statics::ScriptStructInfo[] = {
		...
		{ FSkeletalMeshLODInfo::StaticStruct, Z_Construct_UScriptStruct_FSkeletalMeshLODInfo_Statics::NewStructOps, TEXT("SkeletalMeshLODInfo"), &Z_Registration_Info_UScriptStruct_SkeletalMeshLODInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSkeletalMeshLODInfo), 4065293534U) },
		{ FSkeletalMaterial::StaticStruct, Z_Construct_UScriptStruct_FSkeletalMaterial_Statics::NewStructOps, TEXT("SkeletalMaterial"), &Z_Registration_Info_UScriptStruct_SkeletalMaterial, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSkeletalMaterial), 1059816421U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_SkinnedAssetCommon_h_87795627(TEXT("/Script/Engine"),
		nullptr, 0,
