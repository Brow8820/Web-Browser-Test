...
template<> ENGINE_API UScriptStruct* StaticStruct<FFXSystemSpawnParameters>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_ParticleSystemComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFXSystemComponent, UFXSystemComponent::StaticClass, TEXT("UFXSystemComponent"), &Z_Registration_Info_UClass_UFXSystemComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFXSystemComponent), 2289015214U) },
		{ Z_Construct_UClass_UParticleSystemComponent, UParticleSystemComponent::StaticClass, TEXT("UParticleSystemComponent"), &Z_Registration_Info_UClass_UParticleSystemComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleSystemComponent), 2312488248U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_ParticleSystemComponent_h_632841291(TEXT("/Script/Engine"),
