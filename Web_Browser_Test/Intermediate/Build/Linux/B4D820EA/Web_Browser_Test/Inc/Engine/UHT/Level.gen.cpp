...
class UScriptStruct* FActorFolderSet::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ActorFolderSet.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FActorFolderSet, Z_Construct_UPackage__Script_Engine(), TEXT("ActorFolderSet"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FLevelSimplificationDetails_Statics::NewProp_LandscapeMaterialSettings = { "LandscapeMaterialSettings", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FLevelSimplificationDetails, LandscapeMaterialSettings), Z_Construct_UScriptStruct_FMaterialProxySettings, METADATA_PARAMS(Z_Construct_UScriptStruct_FLevelSimplificationDetails_Statics::NewProp_LandscapeMaterialSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLevelSimplificationDetails_Statics::NewProp_LandscapeMaterialSettings_MetaData)) }; // 3402712007
#if WITH_METADATA
...
template<> ENGINE_API UScriptStruct* StaticStruct<FReplicatedStaticActorDestructionInfo>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Level_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_ULevel, ULevel::StaticClass, TEXT("ULevel"), &Z_Registration_Info_UClass_ULevel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULevel), 4114871120U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Level_h_1282209783(TEXT("/Script/Engine"),
