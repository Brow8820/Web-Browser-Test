...
template<> ENGINE_API UScriptStruct* StaticStruct<FPrecomputedSkyLightInstanceData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_SkyLightComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USkyLightComponent, USkyLightComponent::StaticClass, TEXT("USkyLightComponent"), &Z_Registration_Info_UClass_USkyLightComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USkyLightComponent), 3486447814U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_SkyLightComponent_h_3740116105(TEXT("/Script/Engine"),
