...
template<> ENGINE_API UScriptStruct* StaticStruct<FDebugCameraControllerSettingsViewModeIndex>()
{
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDebugCameraControllerSettings_Statics::NewProp_CycleViewModes = { "CycleViewModes", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UDebugCameraControllerSettings, CycleViewModes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UDebugCameraControllerSettings_Statics::NewProp_CycleViewModes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDebugCameraControllerSettings_Statics::NewProp_CycleViewModes_MetaData)) }; // 2780655012
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_DebugCameraControllerSettings_h_Statics::ScriptStructInfo[] = {
		{ FDebugCameraControllerSettingsViewModeIndex::StaticStruct, Z_Construct_UScriptStruct_FDebugCameraControllerSettingsViewModeIndex_Statics::NewStructOps, TEXT("DebugCameraControllerSettingsViewModeIndex"), &Z_Registration_Info_UScriptStruct_DebugCameraControllerSettingsViewModeIndex, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDebugCameraControllerSettingsViewModeIndex), 2780655012U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_DebugCameraControllerSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDebugCameraControllerSettings, UDebugCameraControllerSettings::StaticClass, TEXT("UDebugCameraControllerSettings"), &Z_Registration_Info_UClass_UDebugCameraControllerSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDebugCameraControllerSettings), 1540400219U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_DebugCameraControllerSettings_h_3818747568(TEXT("/Script/Engine"),
