...
#include "Engine/Classes/Animation/AnimNode_RelevantAssetPlayerBase.h"
...
class UScriptStruct* FAnimNode_AssetPlayerRelevancyBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_AssetPlayerRelevancyBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_AssetPlayerRelevancyBase, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNode_AssetPlayerRelevancyBase"));
	}
