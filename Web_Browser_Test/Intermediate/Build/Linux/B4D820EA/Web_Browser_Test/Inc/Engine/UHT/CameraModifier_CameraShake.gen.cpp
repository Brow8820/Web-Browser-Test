...
template<> ENGINE_API UScriptStruct* StaticStruct<FActiveCameraShakeInfo>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Camera_CameraModifier_CameraShake_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCameraModifier_CameraShake, UCameraModifier_CameraShake::StaticClass, TEXT("UCameraModifier_CameraShake"), &Z_Registration_Info_UClass_UCameraModifier_CameraShake, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCameraModifier_CameraShake), 3675936817U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Camera_CameraModifier_CameraShake_h_2574357405(TEXT("/Script/Engine"),
