...
#include "Engine/Public/CookedMetaData.h"
...
class UScriptStruct* FObjectCookedMetaDataStore::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ObjectCookedMetaDataStore.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FObjectCookedMetaDataStore, Z_Construct_UPackage__Script_Engine(), TEXT("ObjectCookedMetaDataStore"));
	}
...
class UScriptStruct* FFieldCookedMetaDataStore::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FieldCookedMetaDataStore.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFieldCookedMetaDataStore, Z_Construct_UPackage__Script_Engine(), TEXT("FieldCookedMetaDataStore"));
	}
...
class UScriptStruct* FStructCookedMetaDataStore::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_StructCookedMetaDataStore.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStructCookedMetaDataStore, Z_Construct_UPackage__Script_Engine(), TEXT("StructCookedMetaDataStore"));
	}
