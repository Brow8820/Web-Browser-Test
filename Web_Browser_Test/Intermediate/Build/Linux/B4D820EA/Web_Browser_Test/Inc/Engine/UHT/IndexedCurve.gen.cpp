...
template<> ENGINE_API UScriptStruct* StaticStruct<FIndexedCurve>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_IndexedCurve_h_Statics::ScriptStructInfo[] = {
		{ FIndexedCurve::StaticStruct, Z_Construct_UScriptStruct_FIndexedCurve_Statics::NewStructOps, TEXT("IndexedCurve"), &Z_Registration_Info_UScriptStruct_IndexedCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FIndexedCurve), 3499427119U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_IndexedCurve_h_2271711581(TEXT("/Script/Engine"),
		nullptr, 0,
