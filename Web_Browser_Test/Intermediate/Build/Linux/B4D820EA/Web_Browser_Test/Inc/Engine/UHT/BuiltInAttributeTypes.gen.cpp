...
template<> ENGINE_API UScriptStruct* StaticStruct<FTransformAnimationAttribute>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FTransformAnimationAttribute_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "Comment", "/** Attribute type supporting the legacy TVariant<FTransform> atttributes */" },
		{ "ModuleRelativePath", "Classes/Animation/BuiltInAttributeTypes.h" },
		{ "ToolTip", "Attribute type supporting the legacy TVariant<FTransform> atttributes" },
	};
#endif
...
class UScriptStruct* FVectorAnimationAttribute::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_VectorAnimationAttribute.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FVectorAnimationAttribute, Z_Construct_UPackage__Script_Engine(), TEXT("VectorAnimationAttribute"));
	}
...
class UScriptStruct* FQuaternionAnimationAttribute::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_QuaternionAnimationAttribute.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FQuaternionAnimationAttribute, Z_Construct_UPackage__Script_Engine(), TEXT("QuaternionAnimationAttribute"));
	}
...
class UScriptStruct* FNonBlendableQuaternionAnimationAttribute::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NonBlendableQuaternionAnimationAttribute.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNonBlendableQuaternionAnimationAttribute, Z_Construct_UPackage__Script_Engine(), TEXT("NonBlendableQuaternionAnimationAttribute"));
	}
...
class UScriptStruct* FNonBlendableVectorAnimationAttribute::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NonBlendableVectorAnimationAttribute.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNonBlendableVectorAnimationAttribute, Z_Construct_UPackage__Script_Engine(), TEXT("NonBlendableVectorAnimationAttribute"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FNonBlendableIntegerAnimationAttribute>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_BuiltInAttributeTypes_h_Statics::ScriptStructInfo[] = {
		...
		{ FStringAnimationAttribute::StaticStruct, Z_Construct_UScriptStruct_FStringAnimationAttribute_Statics::NewStructOps, TEXT("StringAnimationAttribute"), &Z_Registration_Info_UScriptStruct_StringAnimationAttribute, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStringAnimationAttribute), 336097254U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_BuiltInAttributeTypes_h_1507345135(TEXT("/Script/Engine"),
