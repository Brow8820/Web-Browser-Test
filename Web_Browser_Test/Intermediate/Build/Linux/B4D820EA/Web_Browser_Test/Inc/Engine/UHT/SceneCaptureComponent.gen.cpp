...
template<> ENGINE_API UScriptStruct* StaticStruct<FEngineShowFlagsSetting>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_SceneCaptureComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USceneCaptureComponent, USceneCaptureComponent::StaticClass, TEXT("USceneCaptureComponent"), &Z_Registration_Info_UClass_USceneCaptureComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USceneCaptureComponent), 373323576U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_SceneCaptureComponent_h_422082019(TEXT("/Script/Engine"),
