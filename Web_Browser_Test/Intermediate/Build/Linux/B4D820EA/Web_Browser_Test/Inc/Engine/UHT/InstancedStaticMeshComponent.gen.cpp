...
template<> ENGINE_API UScriptStruct* StaticStruct<FInstancedStaticMeshComponentInstanceData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_InstancedStaticMeshComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInstancedStaticMeshComponent, UInstancedStaticMeshComponent::StaticClass, TEXT("UInstancedStaticMeshComponent"), &Z_Registration_Info_UClass_UInstancedStaticMeshComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInstancedStaticMeshComponent), 3615241445U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_InstancedStaticMeshComponent_h_4275663062(TEXT("/Script/Engine"),
