...
template<> ENGINE_API UScriptStruct* StaticStruct<FBasedMovementInfo>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_Character_h_Statics::ScriptStructInfo[] = {
		...
		{ FBasedMovementInfo::StaticStruct, Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewStructOps, TEXT("BasedMovementInfo"), &Z_Registration_Info_UScriptStruct_BasedMovementInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBasedMovementInfo), 190042490U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_Character_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACharacter, ACharacter::StaticClass, TEXT("ACharacter"), &Z_Registration_Info_UClass_ACharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACharacter), 839939558U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_Character_h_1594078046(TEXT("/Script/Engine"),
