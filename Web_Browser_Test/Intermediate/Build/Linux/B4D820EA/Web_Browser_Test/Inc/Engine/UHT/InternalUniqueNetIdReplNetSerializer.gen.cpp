...
#include "Engine/Private/GameFramework/InternalUniqueNetIdReplNetSerializer.h"
...
class UScriptStruct* FUniqueNetIdReplNetSerializerStringStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_UniqueNetIdReplNetSerializerStringStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FUniqueNetIdReplNetSerializerStringStruct, Z_Construct_UPackage__Script_Engine(), TEXT("UniqueNetIdReplNetSerializerStringStruct"));
	}
...
class UScriptStruct* FUniqueNetIdReplNetSerializerNameStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_UniqueNetIdReplNetSerializerNameStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FUniqueNetIdReplNetSerializerNameStruct, Z_Construct_UPackage__Script_Engine(), TEXT("UniqueNetIdReplNetSerializerNameStruct"));
	}
