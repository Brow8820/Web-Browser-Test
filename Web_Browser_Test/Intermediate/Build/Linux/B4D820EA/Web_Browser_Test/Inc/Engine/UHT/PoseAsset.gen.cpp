...
template<> ENGINE_API UScriptStruct* StaticStruct<FPoseDataContainer>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPoseDataContainer_Statics::NewProp_Curves_Inner = { "Curves", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FAnimCurveBase, METADATA_PARAMS(nullptr, 0) }; // 2424301059
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_PoseAsset_h_Statics::ScriptStructInfo[] = {
		...
		{ FPoseDataContainer::StaticStruct, Z_Construct_UScriptStruct_FPoseDataContainer_Statics::NewStructOps, TEXT("PoseDataContainer"), &Z_Registration_Info_UScriptStruct_PoseDataContainer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPoseDataContainer), 549939592U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_PoseAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPoseAsset, UPoseAsset::StaticClass, TEXT("UPoseAsset"), &Z_Registration_Info_UClass_UPoseAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPoseAsset), 4222211405U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_PoseAsset_h_3064424225(TEXT("/Script/Engine"),
