...
class UScriptStruct* FDataCacheDuplicatedObjectData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DataCacheDuplicatedObjectData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDataCacheDuplicatedObjectData, Z_Construct_UPackage__Script_Engine(), TEXT("DataCacheDuplicatedObjectData"));
	}
...
class UScriptStruct* FInstanceCacheDataBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InstanceCacheDataBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInstanceCacheDataBase, Z_Construct_UPackage__Script_Engine(), TEXT("InstanceCacheDataBase"));
	}
...
class UScriptStruct* FActorComponentInstanceSourceInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ActorComponentInstanceSourceInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FActorComponentInstanceSourceInfo, Z_Construct_UPackage__Script_Engine(), TEXT("ActorComponentInstanceSourceInfo"));
	}
...
class UScriptStruct* FActorInstanceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ActorInstanceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FActorInstanceData, Z_Construct_UPackage__Script_Engine(), TEXT("ActorInstanceData"));
	}
