...
template<> ENGINE_API UScriptStruct* StaticStruct<FHLODISMComponentDesc>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHLODProxyDesc_Statics::NewProp_MaterialSettings = { "MaterialSettings", nullptr, (EPropertyFlags)0x0040000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UHLODProxyDesc, MaterialSettings), Z_Construct_UScriptStruct_FMaterialProxySettings, METADATA_PARAMS(Z_Construct_UClass_UHLODProxyDesc_Statics::NewProp_MaterialSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHLODProxyDesc_Statics::NewProp_MaterialSettings_MetaData)) }; // 3402712007
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_HLOD_HLODProxyDesc_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHLODProxyDesc, UHLODProxyDesc::StaticClass, TEXT("UHLODProxyDesc"), &Z_Registration_Info_UClass_UHLODProxyDesc, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHLODProxyDesc), 3330101740U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_HLOD_HLODProxyDesc_h_1996831151(TEXT("/Script/Engine"),
