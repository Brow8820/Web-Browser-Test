...
#include "Engine/Public/GameFramework/CharacterNetworkSerializationPackedBitsNetSerializer.h"
...
class UScriptStruct* FCharacterNetworkSerializationPackedBitsNetSerializerConfig::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CharacterNetworkSerializationPackedBitsNetSerializerConfig.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCharacterNetworkSerializationPackedBitsNetSerializerConfig, Z_Construct_UPackage__Script_Engine(), TEXT("CharacterNetworkSerializationPackedBitsNetSerializerConfig"));
	}
