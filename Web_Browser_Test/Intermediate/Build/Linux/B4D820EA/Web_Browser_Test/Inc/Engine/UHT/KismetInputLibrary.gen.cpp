...
class UScriptStruct* FSlateModifierKeysState::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SlateModifierKeysState.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSlateModifierKeysState, Z_Construct_UPackage__Script_Engine(), TEXT("SlateModifierKeysState"));
	}
