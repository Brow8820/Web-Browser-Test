...
template<> ENGINE_API UScriptStruct* StaticStruct<FMeshUVChannelInfo>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Components_h_Statics::ScriptStructInfo[] = {
		{ FMeshUVChannelInfo::StaticStruct, Z_Construct_UScriptStruct_FMeshUVChannelInfo_Statics::NewStructOps, TEXT("MeshUVChannelInfo"), &Z_Registration_Info_UScriptStruct_MeshUVChannelInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMeshUVChannelInfo), 501419958U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Components_h_4158648965(TEXT("/Script/Engine"),
		nullptr, 0,
