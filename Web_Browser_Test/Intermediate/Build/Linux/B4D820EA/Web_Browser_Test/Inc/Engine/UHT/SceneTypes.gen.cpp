...
template<> ENGINE_API UScriptStruct* StaticStruct<FCustomPrimitiveData>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_Engine_EMaterialProperty_Statics::Enum_MetaDataParams[] = {
		...
		{ "MP_BaseColor.Comment", "// used in Lightmass, not exposed to user, derived from: SpecularColor, Metallic, Specular\x09""Also used in Strata which uses Albedo/F0 parameterrization\n" },
		{ "MP_BaseColor.DisplayName", "Diffuse" },
		{ "MP_BaseColor.Name", "MP_BaseColor" },
		{ "MP_BaseColor.ToolTip", "used in Lightmass, not exposed to user, derived from: SpecularColor, Metallic, Specular        Also used in Strata which uses Albedo/F0 parameterrization" },
		...
		{ "MP_SpecularColor.Comment", "// used in Lightmass, not exposed to user, computed from: BaseColor, Metallic\x09\x09\x09\x09""Also used in Strata which uses Albedo/F0 parameterrization\n" },
		{ "MP_SpecularColor.Hidden", "" },
		{ "MP_SpecularColor.Name", "MP_SpecularColor" },
		{ "MP_SpecularColor.ToolTip", "used in Lightmass, not exposed to user, computed from: BaseColor, Metallic                             Also used in Strata which uses Albedo/F0 parameterrization" },
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_SceneTypes_h_Statics::EnumInfo[] = {
		{ EMaterialProperty_StaticEnum, TEXT("EMaterialProperty"), &Z_Registration_Info_UEnum_EMaterialProperty, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3205959542U) },
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_SceneTypes_h_3872891191(TEXT("/Script/Engine"),
		nullptr, 0,
