...
class UScriptStruct* FMaterialExpressionCollection::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MaterialExpressionCollection.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMaterialExpressionCollection, Z_Construct_UPackage__Script_Engine(), TEXT("MaterialExpressionCollection"));
	}
