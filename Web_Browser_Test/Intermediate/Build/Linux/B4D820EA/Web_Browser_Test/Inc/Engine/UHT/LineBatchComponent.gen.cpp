...
template<> ENGINE_API UScriptStruct* StaticStruct<FBatchedPoint>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_LineBatchComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULineBatchComponent, ULineBatchComponent::StaticClass, TEXT("ULineBatchComponent"), &Z_Registration_Info_UClass_ULineBatchComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULineBatchComponent), 3300653044U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_LineBatchComponent_h_3087745802(TEXT("/Script/Engine"),
