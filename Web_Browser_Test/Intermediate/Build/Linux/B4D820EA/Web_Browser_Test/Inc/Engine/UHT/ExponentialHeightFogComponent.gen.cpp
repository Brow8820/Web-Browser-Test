...
template<> ENGINE_API UScriptStruct* StaticStruct<FExponentialHeightFogData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_ExponentialHeightFogComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UExponentialHeightFogComponent, UExponentialHeightFogComponent::StaticClass, TEXT("UExponentialHeightFogComponent"), &Z_Registration_Info_UClass_UExponentialHeightFogComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UExponentialHeightFogComponent), 3117580571U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_ExponentialHeightFogComponent_h_3554388300(TEXT("/Script/Engine"),
