...
template<> ENGINE_API UScriptStruct* StaticStruct<FAudioComponentParam>()
{
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAudioComponent_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UAudioComponent_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_USoundParameterControllerInterface_NoRegister, (int32)VTABLE_OFFSET(UAudioComponent, ISoundParameterControllerInterface), false },  // 3164137531
		};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_AudioComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInitialActiveSoundParams, UInitialActiveSoundParams::StaticClass, TEXT("UInitialActiveSoundParams"), &Z_Registration_Info_UClass_UInitialActiveSoundParams, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInitialActiveSoundParams), 3299902495U) },
		{ Z_Construct_UClass_UAudioComponent, UAudioComponent::StaticClass, TEXT("UAudioComponent"), &Z_Registration_Info_UClass_UAudioComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioComponent), 1351149035U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_AudioComponent_h_510088539(TEXT("/Script/Engine"),
