...
// End Cross Module References
	...
	static UEnum* EVolumetricCloudTracingMaxDistanceMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EVolumetricCloudTracingMaxDistanceMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EVolumetricCloudTracingMaxDistanceMode, Z_Construct_UPackage__Script_Engine(), TEXT("EVolumetricCloudTracingMaxDistanceMode"));
		}
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_VolumetricCloudComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVolumetricCloudComponent, UVolumetricCloudComponent::StaticClass, TEXT("UVolumetricCloudComponent"), &Z_Registration_Info_UClass_UVolumetricCloudComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVolumetricCloudComponent), 2017927185U) },
		{ Z_Construct_UClass_AVolumetricCloud, AVolumetricCloud::StaticClass, TEXT("AVolumetricCloud"), &Z_Registration_Info_UClass_AVolumetricCloud, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AVolumetricCloud), 2794336628U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_VolumetricCloudComponent_h_3341617256(TEXT("/Script/Engine"),
