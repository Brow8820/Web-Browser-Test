...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNavCollisionBase_Statics::NewProp_bIsDynamicObstacle = { "bIsDynamicObstacle", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(uint8), sizeof(UNavCollisionBase), &Z_Construct_UClass_UNavCollisionBase_Statics::NewProp_bIsDynamicObstacle_SetBit, METADATA_PARAMS(Z_Construct_UClass_UNavCollisionBase_Statics::NewProp_bIsDynamicObstacle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNavCollisionBase_Statics::NewProp_bIsDynamicObstacle_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_AI_Navigation_NavCollisionBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNavCollisionBase, UNavCollisionBase::StaticClass, TEXT("UNavCollisionBase"), &Z_Registration_Info_UClass_UNavCollisionBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNavCollisionBase), 2505054363U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_AI_Navigation_NavCollisionBase_h_1181917066(TEXT("/Script/Engine"),
