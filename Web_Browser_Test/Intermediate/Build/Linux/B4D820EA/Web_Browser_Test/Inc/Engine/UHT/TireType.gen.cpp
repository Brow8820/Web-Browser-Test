...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UTireType_Statics::NewProp_FrictionScale = { "FrictionScale", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UTireType, FrictionScale), METADATA_PARAMS(Z_Construct_UClass_UTireType_Statics::NewProp_FrictionScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTireType_Statics::NewProp_FrictionScale_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Vehicles_TireType_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTireType, UTireType::StaticClass, TEXT("UTireType"), &Z_Registration_Info_UClass_UTireType, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTireType), 1689047888U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Vehicles_TireType_h_566824938(TEXT("/Script/Engine"),
