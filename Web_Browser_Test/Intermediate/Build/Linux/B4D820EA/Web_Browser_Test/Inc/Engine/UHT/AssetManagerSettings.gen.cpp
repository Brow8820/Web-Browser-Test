...
template<> ENGINE_API UScriptStruct* StaticStruct<FPrimaryAssetRulesCustomOverride>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAssetManagerSettings_Statics::NewProp_CustomPrimaryAssetRules_Inner = { "CustomPrimaryAssetRules", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FPrimaryAssetRulesCustomOverride, METADATA_PARAMS(nullptr, 0) }; // 2338893052
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAssetManagerSettings_Statics::NewProp_CustomPrimaryAssetRules = { "CustomPrimaryAssetRules", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UAssetManagerSettings, CustomPrimaryAssetRules), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAssetManagerSettings_Statics::NewProp_CustomPrimaryAssetRules_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAssetManagerSettings_Statics::NewProp_CustomPrimaryAssetRules_MetaData)) }; // 2338893052
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_AssetManagerSettings_h_Statics::ScriptStructInfo[] = {
		...
		{ FPrimaryAssetRulesOverride::StaticStruct, Z_Construct_UScriptStruct_FPrimaryAssetRulesOverride_Statics::NewStructOps, TEXT("PrimaryAssetRulesOverride"), &Z_Registration_Info_UScriptStruct_PrimaryAssetRulesOverride, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPrimaryAssetRulesOverride), 1118184791U) },
		{ FPrimaryAssetRulesCustomOverride::StaticStruct, Z_Construct_UScriptStruct_FPrimaryAssetRulesCustomOverride_Statics::NewStructOps, TEXT("PrimaryAssetRulesCustomOverride"), &Z_Registration_Info_UScriptStruct_PrimaryAssetRulesCustomOverride, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPrimaryAssetRulesCustomOverride), 2338893052U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_AssetManagerSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetManagerSettings, UAssetManagerSettings::StaticClass, TEXT("UAssetManagerSettings"), &Z_Registration_Info_UClass_UAssetManagerSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetManagerSettings), 703124701U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_AssetManagerSettings_h_1073008297(TEXT("/Script/Engine"),
