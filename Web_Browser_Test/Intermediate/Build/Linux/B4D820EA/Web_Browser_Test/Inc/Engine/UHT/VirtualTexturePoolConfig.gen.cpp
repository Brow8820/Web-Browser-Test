...
template<> ENGINE_API UScriptStruct* StaticStruct<FVirtualTextureSpacePoolConfig>()
{
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_Formats = { "Formats", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FVirtualTextureSpacePoolConfig, Formats), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_Formats_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_Formats_MetaData)) }; // 404292459
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_VT_VirtualTexturePoolConfig_h_Statics::ScriptStructInfo[] = {
		{ FVirtualTextureSpacePoolConfig::StaticStruct, Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewStructOps, TEXT("VirtualTextureSpacePoolConfig"), &Z_Registration_Info_UScriptStruct_VirtualTextureSpacePoolConfig, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVirtualTextureSpacePoolConfig), 599894837U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_VT_VirtualTexturePoolConfig_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVirtualTexturePoolConfig, UVirtualTexturePoolConfig::StaticClass, TEXT("UVirtualTexturePoolConfig"), &Z_Registration_Info_UClass_UVirtualTexturePoolConfig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVirtualTexturePoolConfig), 1700176309U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_VT_VirtualTexturePoolConfig_h_4064688829(TEXT("/Script/Engine"),
