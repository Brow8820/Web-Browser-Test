...
template<> ENGINE_API UScriptStruct* StaticStruct<FPrecomputedLightInstanceData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_LightComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULightComponent, ULightComponent::StaticClass, TEXT("ULightComponent"), &Z_Registration_Info_UClass_ULightComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULightComponent), 2678985506U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_LightComponent_h_3024781514(TEXT("/Script/Engine"),
