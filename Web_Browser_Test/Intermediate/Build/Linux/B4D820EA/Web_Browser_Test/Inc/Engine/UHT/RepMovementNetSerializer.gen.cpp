...
#include "Engine/Public/RepMovementNetSerializer.h"
...
class UScriptStruct* FRepMovementNetSerializerConfig::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RepMovementNetSerializerConfig.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRepMovementNetSerializerConfig, Z_Construct_UPackage__Script_Engine(), TEXT("RepMovementNetSerializerConfig"));
	}
