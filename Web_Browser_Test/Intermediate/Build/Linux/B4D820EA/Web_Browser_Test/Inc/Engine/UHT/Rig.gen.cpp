...
template<> ENGINE_API UScriptStruct* StaticStruct<FTransformBase>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URig_Statics::NewProp_TransformBases_Inner = { "TransformBases", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FTransformBase, METADATA_PARAMS(nullptr, 0) }; // 2259254681
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_Rig_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigTransformConstraint::StaticStruct, Z_Construct_UScriptStruct_FRigTransformConstraint_Statics::NewStructOps, TEXT("RigTransformConstraint"), &Z_Registration_Info_UScriptStruct_RigTransformConstraint, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigTransformConstraint), 2935479895U) },
		{ FTransformBaseConstraint::StaticStruct, Z_Construct_UScriptStruct_FTransformBaseConstraint_Statics::NewStructOps, TEXT("TransformBaseConstraint"), &Z_Registration_Info_UScriptStruct_TransformBaseConstraint, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTransformBaseConstraint), 1023885227U) },
		{ FTransformBase::StaticStruct, Z_Construct_UScriptStruct_FTransformBase_Statics::NewStructOps, TEXT("TransformBase"), &Z_Registration_Info_UScriptStruct_TransformBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTransformBase), 2259254681U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_Rig_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URig, URig::StaticClass, TEXT("URig"), &Z_Registration_Info_UClass_URig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URig), 1532956900U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_Rig_h_693662634(TEXT("/Script/Engine"),
