...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimParentNodeAssetOverride>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimBlueprint_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimBlueprint, UAnimBlueprint::StaticClass, TEXT("UAnimBlueprint"), &Z_Registration_Info_UClass_UAnimBlueprint, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimBlueprint), 4141601267U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimBlueprint_h_1795317210(TEXT("/Script/Engine"),
