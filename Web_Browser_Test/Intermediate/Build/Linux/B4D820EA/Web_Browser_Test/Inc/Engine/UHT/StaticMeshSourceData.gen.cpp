...
template<> ENGINE_API UScriptStruct* StaticStruct<FStaticMeshSourceModel>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_StaticMeshSourceData_h_Statics::ScriptStructInfo[] = {
		{ FStaticMeshSourceModel::StaticStruct, Z_Construct_UScriptStruct_FStaticMeshSourceModel_Statics::NewStructOps, TEXT("StaticMeshSourceModel"), &Z_Registration_Info_UScriptStruct_StaticMeshSourceModel, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStaticMeshSourceModel), 3459945693U) },
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_StaticMeshSourceData_h_1432416898(TEXT("/Script/Engine"),
