...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimBlueprintFunctionData>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimClassData_Statics::NewProp_BakedStateMachines_Inner = { "BakedStateMachines", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FBakedAnimationStateMachine, METADATA_PARAMS(nullptr, 0) }; // 3848825917
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimClassData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimClassData, UAnimClassData::StaticClass, TEXT("UAnimClassData"), &Z_Registration_Info_UClass_UAnimClassData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimClassData), 2204944490U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimClassData_h_1436458599(TEXT("/Script/Engine"),
