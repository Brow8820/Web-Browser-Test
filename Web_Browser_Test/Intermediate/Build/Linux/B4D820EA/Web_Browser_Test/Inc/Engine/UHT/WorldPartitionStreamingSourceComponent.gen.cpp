...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UWorldPartitionStreamingSourceComponent_Statics::NewProp_TargetGrid = { "TargetGrid", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UWorldPartitionStreamingSourceComponent, TargetGrid), METADATA_PARAMS(Z_Construct_UClass_UWorldPartitionStreamingSourceComponent_Statics::NewProp_TargetGrid_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWorldPartitionStreamingSourceComponent_Statics::NewProp_TargetGrid_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UWorldPartitionStreamingSourceComponent_Statics::NewProp_TargetHLODLayer = { "TargetHLODLayer", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UWorldPartitionStreamingSourceComponent, TargetHLODLayer), Z_Construct_UClass_UHLODLayer_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UWorldPartitionStreamingSourceComponent_Statics::NewProp_TargetHLODLayer_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWorldPartitionStreamingSourceComponent_Statics::NewProp_TargetHLODLayer_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWorldPartitionStreamingSourceComponent_Statics::NewProp_Shapes_Inner = { "Shapes", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FStreamingSourceShape, METADATA_PARAMS(nullptr, 0) }; // 344979616
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_WorldPartitionStreamingSourceComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWorldPartitionStreamingSourceComponent, UWorldPartitionStreamingSourceComponent::StaticClass, TEXT("UWorldPartitionStreamingSourceComponent"), &Z_Registration_Info_UClass_UWorldPartitionStreamingSourceComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWorldPartitionStreamingSourceComponent), 2675524147U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_WorldPartitionStreamingSourceComponent_h_692101476(TEXT("/Script/Engine"),
