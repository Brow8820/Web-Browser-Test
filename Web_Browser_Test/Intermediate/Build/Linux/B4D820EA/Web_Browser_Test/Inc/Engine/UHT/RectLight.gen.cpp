...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ARectLight_Statics::NewProp_RectLightComponent = { "RectLightComponent", nullptr, (EPropertyFlags)0x00140000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ARectLight, RectLightComponent), Z_Construct_UClass_URectLightComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ARectLight_Statics::NewProp_RectLightComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ARectLight_Statics::NewProp_RectLightComponent_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_RectLight_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ARectLight, ARectLight::StaticClass, TEXT("ARectLight"), &Z_Registration_Info_UClass_ARectLight, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARectLight), 3799136100U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_RectLight_h_2220645093(TEXT("/Script/Engine"),
