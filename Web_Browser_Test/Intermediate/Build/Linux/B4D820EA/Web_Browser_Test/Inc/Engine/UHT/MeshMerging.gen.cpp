...
template<> ENGINE_API UScriptStruct* StaticStruct<FMeshApproximationSettings>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_MeshMerging_h_Statics::ScriptStructInfo[] = {
		{ FMeshReductionSettings::StaticStruct, Z_Construct_UScriptStruct_FMeshReductionSettings_Statics::NewStructOps, TEXT("MeshReductionSettings"), &Z_Registration_Info_UScriptStruct_MeshReductionSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMeshReductionSettings), 1388562290U) },
		{ FMeshProxySettings::StaticStruct, Z_Construct_UScriptStruct_FMeshProxySettings_Statics::NewStructOps, TEXT("MeshProxySettings"), &Z_Registration_Info_UScriptStruct_MeshProxySettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMeshProxySettings), 2566970826U) },
		{ FMeshMergingSettings::StaticStruct, Z_Construct_UScriptStruct_FMeshMergingSettings_Statics::NewStructOps, TEXT("MeshMergingSettings"), &Z_Registration_Info_UScriptStruct_MeshMergingSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMeshMergingSettings), 2825069913U) },
		...
		{ FMeshApproximationSettings::StaticStruct, Z_Construct_UScriptStruct_FMeshApproximationSettings_Statics::NewStructOps, TEXT("MeshApproximationSettings"), &Z_Registration_Info_UScriptStruct_MeshApproximationSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMeshApproximationSettings), 1592109045U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_MeshMerging_h_4021440902(TEXT("/Script/Engine"),
		nullptr, 0,
