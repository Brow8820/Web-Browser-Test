...
class UScriptStruct* FActorPlacementDataLayers::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ActorPlacementDataLayers.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FActorPlacementDataLayers, Z_Construct_UPackage__Script_Engine(), TEXT("ActorPlacementDataLayers"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FActorPlacementDataLayers>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_DataLayer_WorldDataLayers_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AWorldDataLayers, AWorldDataLayers::StaticClass, TEXT("AWorldDataLayers"), &Z_Registration_Info_UClass_AWorldDataLayers, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AWorldDataLayers), 1142450114U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_DataLayer_WorldDataLayers_h_1751024887(TEXT("/Script/Engine"),
