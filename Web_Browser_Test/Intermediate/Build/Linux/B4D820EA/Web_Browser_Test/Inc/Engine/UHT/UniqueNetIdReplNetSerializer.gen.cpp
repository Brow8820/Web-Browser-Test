...
#include "Engine/Public/GameFramework/UniqueNetIdReplNetSerializer.h"
...
class UScriptStruct* FUniqueNetIdReplNetSerializerConfig::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_UniqueNetIdReplNetSerializerConfig.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FUniqueNetIdReplNetSerializerConfig, Z_Construct_UPackage__Script_Engine(), TEXT("UniqueNetIdReplNetSerializerConfig"));
	}
