...
class UScriptStruct* FMaterialCachedParameterEditorEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MaterialCachedParameterEditorEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMaterialCachedParameterEditorEntry, Z_Construct_UPackage__Script_Engine(), TEXT("MaterialCachedParameterEditorEntry"));
	}
...
class UScriptStruct* FMaterialCachedExpressionEditorOnlyData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MaterialCachedExpressionEditorOnlyData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMaterialCachedExpressionEditorOnlyData, Z_Construct_UPackage__Script_Engine(), TEXT("MaterialCachedExpressionEditorOnlyData"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FMaterialCachedExpressionData>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_MaterialCachedData_h_Statics::ScriptStructInfo[] = {
		...
		{ FMaterialCachedExpressionEditorOnlyData::StaticStruct, Z_Construct_UScriptStruct_FMaterialCachedExpressionEditorOnlyData_Statics::NewStructOps, TEXT("MaterialCachedExpressionEditorOnlyData"), &Z_Registration_Info_UScriptStruct_MaterialCachedExpressionEditorOnlyData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMaterialCachedExpressionEditorOnlyData), 3564376772U) },
		{ FMaterialCachedExpressionData::StaticStruct, Z_Construct_UScriptStruct_FMaterialCachedExpressionData_Statics::NewStructOps, TEXT("MaterialCachedExpressionData"), &Z_Registration_Info_UScriptStruct_MaterialCachedExpressionData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMaterialCachedExpressionData), 245947917U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_MaterialCachedData_h_3321879308(TEXT("/Script/Engine"),
		nullptr, 0,
