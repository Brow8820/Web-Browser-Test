...
template<> ENGINE_API UScriptStruct* StaticStruct<FEquirectProps>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_StereoLayerComponent_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UStereoLayerComponent, UStereoLayerComponent::StaticClass, TEXT("UStereoLayerComponent"), &Z_Registration_Info_UClass_UStereoLayerComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStereoLayerComponent), 2237426298U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_StereoLayerComponent_h_1350530299(TEXT("/Script/Engine"),
