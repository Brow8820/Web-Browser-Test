...
#include "Engine/Classes/Materials/MaterialExpressionIsOrthographic.h"
...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialExpressionIsOrthographic_Statics::Class_MetaDataParams[] = {
		{ "HideCategories", "Object Object" },
		{ "IncludePath", "Materials/MaterialExpressionIsOrthographic.h" },
		{ "ModuleRelativePath", "Classes/Materials/MaterialExpressionIsOrthographic.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMaterialExpressionIsOrthographic_Statics::StaticCppClassTypeInfo = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionIsOrthographic_Statics::ClassParams = {
		...
		0,
		0x000020B0u,
		METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionIsOrthographic_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionIsOrthographic_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionIsOrthographic_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionIsOrthographic_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionIsOrthographic, UMaterialExpressionIsOrthographic::StaticClass, TEXT("UMaterialExpressionIsOrthographic"), &Z_Registration_Info_UClass_UMaterialExpressionIsOrthographic, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionIsOrthographic), 715701442U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionIsOrthographic_h_2994213058(TEXT("/Script/Engine"),
		Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionIsOrthographic_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionIsOrthographic_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
