...
template<> ENGINE_API UScriptStruct* StaticStruct<FMaterialSpriteElement>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_MaterialBillboardComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialBillboardComponent, UMaterialBillboardComponent::StaticClass, TEXT("UMaterialBillboardComponent"), &Z_Registration_Info_UClass_UMaterialBillboardComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialBillboardComponent), 3301604342U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_MaterialBillboardComponent_h_2550389833(TEXT("/Script/Engine"),
