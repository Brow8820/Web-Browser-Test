...
template<> ENGINE_API UScriptStruct* StaticStruct<FActiveForceFeedbackEffect>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UForceFeedbackEffect_Statics::NewProp_ChannelDetails_Inner = { "ChannelDetails", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FForceFeedbackChannelDetails, METADATA_PARAMS(nullptr, 0) }; // 1551934653
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_ForceFeedbackEffect_h_Statics::ScriptStructInfo[] = {
		{ FForceFeedbackChannelDetails::StaticStruct, Z_Construct_UScriptStruct_FForceFeedbackChannelDetails_Statics::NewStructOps, TEXT("ForceFeedbackChannelDetails"), &Z_Registration_Info_UScriptStruct_ForceFeedbackChannelDetails, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FForceFeedbackChannelDetails), 1551934653U) },
		{ FForceFeedbackParameters::StaticStruct, Z_Construct_UScriptStruct_FForceFeedbackParameters_Statics::NewStructOps, TEXT("ForceFeedbackParameters"), &Z_Registration_Info_UScriptStruct_ForceFeedbackParameters, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FForceFeedbackParameters), 1060065127U) },
		{ FActiveForceFeedbackEffect::StaticStruct, Z_Construct_UScriptStruct_FActiveForceFeedbackEffect_Statics::NewStructOps, TEXT("ActiveForceFeedbackEffect"), &Z_Registration_Info_UScriptStruct_ActiveForceFeedbackEffect, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FActiveForceFeedbackEffect), 1883257456U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_ForceFeedbackEffect_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UForceFeedbackEffect, UForceFeedbackEffect::StaticClass, TEXT("UForceFeedbackEffect"), &Z_Registration_Info_UClass_UForceFeedbackEffect, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UForceFeedbackEffect), 1672025228U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_ForceFeedbackEffect_h_2414909853(TEXT("/Script/Engine"),
