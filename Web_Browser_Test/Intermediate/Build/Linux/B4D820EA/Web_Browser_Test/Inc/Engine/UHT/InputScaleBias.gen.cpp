...
template<> ENGINE_API UScriptStruct* StaticStruct<FInputAlphaBoolBlend>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_InputScaleBias_h_Statics::ScriptStructInfo[] = {
		...
		{ FInputAlphaBoolBlend::StaticStruct, Z_Construct_UScriptStruct_FInputAlphaBoolBlend_Statics::NewStructOps, TEXT("InputAlphaBoolBlend"), &Z_Registration_Info_UScriptStruct_InputAlphaBoolBlend, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInputAlphaBoolBlend), 3532789833U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_InputScaleBias_h_1365993466(TEXT("/Script/Engine"),
		nullptr, 0,
