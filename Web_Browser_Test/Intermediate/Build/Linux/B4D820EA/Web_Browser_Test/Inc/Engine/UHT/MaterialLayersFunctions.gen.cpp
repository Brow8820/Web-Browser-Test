...
class UScriptStruct* FMaterialLayersFunctionsEditorOnlyData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MaterialLayersFunctionsEditorOnlyData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMaterialLayersFunctionsEditorOnlyData, Z_Construct_UPackage__Script_Engine(), TEXT("MaterialLayersFunctionsEditorOnlyData"));
	}
...
class UScriptStruct* FMaterialLayersFunctionsRuntimeData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MaterialLayersFunctionsRuntimeData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMaterialLayersFunctionsRuntimeData, Z_Construct_UPackage__Script_Engine(), TEXT("MaterialLayersFunctionsRuntimeData"));
	}
