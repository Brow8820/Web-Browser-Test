...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAnimSequenceBase_Statics::NewProp_SequenceLength = { "SequenceLength", nullptr, (EPropertyFlags)0x0010010000020015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UAnimSequenceBase, SequenceLength), METADATA_PARAMS(Z_Construct_UClass_UAnimSequenceBase_Statics::NewProp_SequenceLength_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimSequenceBase_Statics::NewProp_SequenceLength_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimSequenceBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimSequenceBase, UAnimSequenceBase::StaticClass, TEXT("UAnimSequenceBase"), &Z_Registration_Info_UClass_UAnimSequenceBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimSequenceBase), 2449636225U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimSequenceBase_h_2040456523(TEXT("/Script/Engine"),
