...
#include "Engine/Classes/PhysicsEngine/LevelSetElem.h"
...
class UScriptStruct* FKLevelSetElem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_KLevelSetElem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FKLevelSetElem, Z_Construct_UPackage__Script_Engine(), TEXT("KLevelSetElem"));
	}
