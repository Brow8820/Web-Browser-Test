...
template<> ENGINE_API UScriptStruct* StaticStruct<FCurveAtlasColorAdjustments>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_CurveLinearColorAtlas_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCurveLinearColorAtlas, UCurveLinearColorAtlas::StaticClass, TEXT("UCurveLinearColorAtlas"), &Z_Registration_Info_UClass_UCurveLinearColorAtlas, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCurveLinearColorAtlas), 2855919012U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_CurveLinearColorAtlas_h_530639776(TEXT("/Script/Engine"),
