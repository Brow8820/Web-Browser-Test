...
class UScriptStruct* FMaterialOverrideNanite::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MaterialOverrideNanite.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMaterialOverrideNanite, Z_Construct_UPackage__Script_Engine(), TEXT("MaterialOverrideNanite"));
	}
