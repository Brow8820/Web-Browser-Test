...
template<> ENGINE_API UScriptStruct* StaticStruct<FCanvasIcon>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UCanvas_K2_DrawTexture_Statics::NewProp_BlendMode = { "BlendMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(Canvas_eventK2_DrawTexture_Parms, BlendMode), Z_Construct_UEnum_Engine_EBlendMode, METADATA_PARAMS(nullptr, 0) }; // 2814665215
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCanvas_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UCanvas_K2_DrawTexture, "K2_DrawTexture" }, // 530610065
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Canvas_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCanvas, UCanvas::StaticClass, TEXT("UCanvas"), &Z_Registration_Info_UClass_UCanvas, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCanvas), 3337988297U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Canvas_h_440289539(TEXT("/Script/Engine"),
