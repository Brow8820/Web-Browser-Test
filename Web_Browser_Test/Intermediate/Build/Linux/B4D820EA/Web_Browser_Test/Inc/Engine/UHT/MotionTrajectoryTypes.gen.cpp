...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTrajectorySample_Statics::NewProp_AccumulatedDistance = { "AccumulatedDistance", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FTrajectorySample, AccumulatedDistance), METADATA_PARAMS(Z_Construct_UScriptStruct_FTrajectorySample_Statics::NewProp_AccumulatedDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrajectorySample_Statics::NewProp_AccumulatedDistance_MetaData)) };
#if WITH_METADATA
...
template<> ENGINE_API UScriptStruct* StaticStruct<FTrajectorySampleRange>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTrajectorySampleRange_Statics::NewProp_Samples_Inner = { "Samples", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FTrajectorySample, METADATA_PARAMS(nullptr, 0) }; // 2629348171
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FTrajectorySampleRange_Statics::NewProp_SampleRate = { "SampleRate", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FTrajectorySampleRange, SampleRate), METADATA_PARAMS(Z_Construct_UScriptStruct_FTrajectorySampleRange_Statics::NewProp_SampleRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrajectorySampleRange_Statics::NewProp_SampleRate_MetaData)) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_MotionTrajectoryTypes_h_Statics::EnumInfo[] = {
		{ ETrajectorySampleDomain_StaticEnum, TEXT("ETrajectorySampleDomain"), &Z_Registration_Info_UEnum_ETrajectorySampleDomain, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1370225371U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_MotionTrajectoryTypes_h_Statics::ScriptStructInfo[] = {
		{ FTrajectorySample::StaticStruct, Z_Construct_UScriptStruct_FTrajectorySample_Statics::NewStructOps, TEXT("TrajectorySample"), &Z_Registration_Info_UScriptStruct_TrajectorySample, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTrajectorySample), 2629348171U) },
		{ FTrajectorySampleRange::StaticStruct, Z_Construct_UScriptStruct_FTrajectorySampleRange_Statics::NewStructOps, TEXT("TrajectorySampleRange"), &Z_Registration_Info_UScriptStruct_TrajectorySampleRange, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTrajectorySampleRange), 1744306197U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_MotionTrajectoryTypes_h_2166758958(TEXT("/Script/Engine"),
		nullptr, 0,
