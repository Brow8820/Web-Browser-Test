...
template<> ENGINE_API UScriptStruct* StaticStruct<FTentDistribution>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_SkyAtmosphereComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USkyAtmosphereComponent, USkyAtmosphereComponent::StaticClass, TEXT("USkyAtmosphereComponent"), &Z_Registration_Info_UClass_USkyAtmosphereComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USkyAtmosphereComponent), 737707015U) },
		{ Z_Construct_UClass_ASkyAtmosphere, ASkyAtmosphere::StaticClass, TEXT("ASkyAtmosphere"), &Z_Registration_Info_UClass_ASkyAtmosphere, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASkyAtmosphere), 697898342U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_SkyAtmosphereComponent_h_1768161830(TEXT("/Script/Engine"),
