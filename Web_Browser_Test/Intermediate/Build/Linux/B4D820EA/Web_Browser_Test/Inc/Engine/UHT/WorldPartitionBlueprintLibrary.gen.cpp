...
#include "Engine/Public/WorldPartition/WorldPartitionBlueprintLibrary.h"
...
class UScriptStruct* FActorDesc::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ActorDesc.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FActorDesc, Z_Construct_UPackage__Script_Engine(), TEXT("ActorDesc"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FActorDesc>()
{
	...
	DEFINE_FUNCTION(UWorldPartitionBlueprintLibrary::execUnloadActors)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		UWorldPartitionBlueprintLibrary::UnloadActors(Z_Param_Out_InActorsToLoad);
		P_NATIVE_END;
	}
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UWorldPartitionBlueprintLibrary_UnloadActors_Statics::NewProp_InActorsToLoad_Inner = { "InActorsToLoad", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UWorldPartitionBlueprintLibrary_UnloadActors_Statics::NewProp_InActorsToLoad_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UWorldPartitionBlueprintLibrary_UnloadActors_Statics::NewProp_InActorsToLoad = { "InActorsToLoad", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(WorldPartitionBlueprintLibrary_eventUnloadActors_Parms, InActorsToLoad), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_UWorldPartitionBlueprintLibrary_UnloadActors_Statics::NewProp_InActorsToLoad_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UWorldPartitionBlueprintLibrary_UnloadActors_Statics::NewProp_InActorsToLoad_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UWorldPartitionBlueprintLibrary_UnloadActors_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWorldPartitionBlueprintLibrary_UnloadActors_Statics::NewProp_InActorsToLoad_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UWorldPartitionBlueprintLibrary_UnloadActors_Statics::NewProp_InActorsToLoad,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UWorldPartitionBlueprintLibrary_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UWorldPartitionBlueprintLibrary_UnloadActors, "UnloadActors" }, // 3492641207
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionBlueprintLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWorldPartitionBlueprintLibrary, UWorldPartitionBlueprintLibrary::StaticClass, TEXT("UWorldPartitionBlueprintLibrary"), &Z_Registration_Info_UClass_UWorldPartitionBlueprintLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWorldPartitionBlueprintLibrary), 3730127763U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionBlueprintLibrary_h_499023480(TEXT("/Script/Engine"),
