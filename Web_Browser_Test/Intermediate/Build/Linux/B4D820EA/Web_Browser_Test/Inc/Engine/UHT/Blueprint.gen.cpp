...
template<> ENGINE_API UScriptStruct* StaticStruct<FBPEditorBookmarkNode>()
{
	...
	static UEnum* EShouldCookBlueprintPropertyGuids_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EShouldCookBlueprintPropertyGuids.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EShouldCookBlueprintPropertyGuids, Z_Construct_UPackage__Script_Engine(), TEXT("EShouldCookBlueprintPropertyGuids"));
		}
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Blueprint_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UBlueprint, UBlueprint::StaticClass, TEXT("UBlueprint"), &Z_Registration_Info_UClass_UBlueprint, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBlueprint), 301263170U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Blueprint_h_3368321454(TEXT("/Script/Engine"),
