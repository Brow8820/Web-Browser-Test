...
template<> ENGINE_API UScriptStruct* StaticStruct<FAssetManagerSearchRules>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_AssetManagerTypes_h_Statics::ScriptStructInfo[] = {
		{ FPrimaryAssetRules::StaticStruct, Z_Construct_UScriptStruct_FPrimaryAssetRules_Statics::NewStructOps, TEXT("PrimaryAssetRules"), &Z_Registration_Info_UScriptStruct_PrimaryAssetRules, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPrimaryAssetRules), 1641083474U) },
		{ FPrimaryAssetTypeInfo::StaticStruct, Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewStructOps, TEXT("PrimaryAssetTypeInfo"), &Z_Registration_Info_UScriptStruct_PrimaryAssetTypeInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPrimaryAssetTypeInfo), 785556378U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_AssetManagerTypes_h_3700391909(TEXT("/Script/Engine"),
		nullptr, 0,
