...
#define FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionVolume_h_14_ACCESSORS
...
public: \
	DECLARE_CLASS(ADEPRECATED_WorldPartitionVolume, AVolume, COMPILED_IN_FLAGS(0 | CLASS_Config | CLASS_Deprecated), CASTCLASS_None, TEXT("/Script/Engine"), NO_API) \
...
#define FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionVolume_h_14_STANDARD_CONSTRUCTORS \
	...
	NO_API ADEPRECATED_WorldPartitionVolume(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()); \
	DEFINE_DEFAULT_OBJECT_INITIALIZER_CONSTRUCTOR_CALL(ADEPRECATED_WorldPartitionVolume) \
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, ADEPRECATED_WorldPartitionVolume); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(ADEPRECATED_WorldPartitionVolume); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API ADEPRECATED_WorldPartitionVolume(ADEPRECATED_WorldPartitionVolume&&); \
	NO_API ADEPRECATED_WorldPartitionVolume(const ADEPRECATED_WorldPartitionVolume&); \
public: \
	NO_API virtual ~ADEPRECATED_WorldPartitionVolume();


#define FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionVolume_h_14_ENHANCED_CONSTRUCTORS \
	/** Standard constructor, called after all reflected properties have been initialized */ \
	NO_API ADEPRECATED_WorldPartitionVolume(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()) : Super(ObjectInitializer) { }; \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API ADEPRECATED_WorldPartitionVolume(ADEPRECATED_WorldPartitionVolume&&); \
	NO_API ADEPRECATED_WorldPartitionVolume(const ADEPRECATED_WorldPartitionVolume&); \
...
public: \
	...
	FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionVolume_h_14_ACCESSORS \
...
static_assert(false, "Unknown access specifier for GENERATED_BODY() macro in class WorldPartitionVolume."); \
PRAGMA_ENABLE_DEPRECATION_WARNINGS
