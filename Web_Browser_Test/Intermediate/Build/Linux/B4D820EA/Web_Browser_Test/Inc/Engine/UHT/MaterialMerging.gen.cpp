...
template<> ENGINE_API UScriptStruct* StaticStruct<FMaterialProxySettings>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMaterialProxySettings_Statics::NewProp_MeshMinDrawDistance = { "MeshMinDrawDistance", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FMaterialProxySettings, MeshMinDrawDistance), METADATA_PARAMS(Z_Construct_UScriptStruct_FMaterialProxySettings_Statics::NewProp_MeshMinDrawDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMaterialProxySettings_Statics::NewProp_MeshMinDrawDistance_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_MaterialMerging_h_Statics::ScriptStructInfo[] = {
		{ FMaterialProxySettings::StaticStruct, Z_Construct_UScriptStruct_FMaterialProxySettings_Statics::NewStructOps, TEXT("MaterialProxySettings"), &Z_Registration_Info_UScriptStruct_MaterialProxySettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMaterialProxySettings), 3402712007U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_MaterialMerging_h_1213471520(TEXT("/Script/Engine"),
		nullptr, 0,
