...
template<> ENGINE_API UScriptStruct* StaticStruct<FChaosPhysicsSettings>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bEnableEnhancedDeterminism = { "bEnableEnhancedDeterminism", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(UPhysicsSettings), &Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bEnableEnhancedDeterminism_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bEnableEnhancedDeterminism_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bEnableEnhancedDeterminism_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_PhysicsSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPhysicsSettings, UPhysicsSettings::StaticClass, TEXT("UPhysicsSettings"), &Z_Registration_Info_UClass_UPhysicsSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPhysicsSettings), 3118566488U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_PhysicsSettings_h_694749386(TEXT("/Script/Engine"),
