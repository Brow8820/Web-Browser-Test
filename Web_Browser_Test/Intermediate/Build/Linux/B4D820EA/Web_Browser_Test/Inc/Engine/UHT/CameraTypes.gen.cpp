...
template<> ENGINE_API UScriptStruct* StaticStruct<FMinimalViewInfo>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Camera_CameraTypes_h_Statics::ScriptStructInfo[] = {
		{ FMinimalViewInfo::StaticStruct, Z_Construct_UScriptStruct_FMinimalViewInfo_Statics::NewStructOps, TEXT("MinimalViewInfo"), &Z_Registration_Info_UScriptStruct_MinimalViewInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMinimalViewInfo), 597094847U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Camera_CameraTypes_h_3039213943(TEXT("/Script/Engine"),
		nullptr, 0,
