...
template<> ENGINE_API UScriptStruct* StaticStruct<FSplineMeshInstanceData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_SplineMeshComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USplineMeshComponent, USplineMeshComponent::StaticClass, TEXT("USplineMeshComponent"), &Z_Registration_Info_UClass_USplineMeshComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USplineMeshComponent), 1009403953U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_SplineMeshComponent_h_2373931307(TEXT("/Script/Engine"),
