...
class UScriptStruct* FBodyInstanceAsyncPhysicsTickHandle::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BodyInstanceAsyncPhysicsTickHandle.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBodyInstanceAsyncPhysicsTickHandle, Z_Construct_UPackage__Script_Engine(), TEXT("BodyInstanceAsyncPhysicsTickHandle"));
	}
