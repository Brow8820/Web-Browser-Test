...
class UScriptStruct* FInertializationRequest::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InertializationRequest.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInertializationRequest, Z_Construct_UPackage__Script_Engine(), TEXT("InertializationRequest"));
	}
