...
template<> ENGINE_API UScriptStruct* StaticStruct<FHardwareCursorReference>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_UserInterfaceSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUserInterfaceSettings, UUserInterfaceSettings::StaticClass, TEXT("UUserInterfaceSettings"), &Z_Registration_Info_UClass_UUserInterfaceSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUserInterfaceSettings), 610703349U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_UserInterfaceSettings_h_3773223565(TEXT("/Script/Engine"),
