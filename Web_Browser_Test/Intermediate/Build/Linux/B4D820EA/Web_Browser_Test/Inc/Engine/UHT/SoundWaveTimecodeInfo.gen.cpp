...
#include "Engine/Classes/Sound/SoundWaveTimecodeInfo.h"
...
class UScriptStruct* FSoundWaveTimecodeInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SoundWaveTimecodeInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSoundWaveTimecodeInfo, Z_Construct_UPackage__Script_Engine(), TEXT("SoundWaveTimecodeInfo"));
	}
