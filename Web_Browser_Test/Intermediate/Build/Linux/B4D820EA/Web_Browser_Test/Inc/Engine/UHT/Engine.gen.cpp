...
class UScriptStruct* FIrisNetDriverConfig::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_IrisNetDriverConfig.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FIrisNetDriverConfig, Z_Construct_UPackage__Script_Engine(), TEXT("IrisNetDriverConfig"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FPluginRedirect>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UEngine_Statics::NewProp_StreamingDistanceFactor = { "StreamingDistanceFactor", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UEngine, StreamingDistanceFactor), METADATA_PARAMS(Z_Construct_UClass_UEngine_Statics::NewProp_StreamingDistanceFactor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEngine_Statics::NewProp_StreamingDistanceFactor_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Engine_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEngine, UEngine::StaticClass, TEXT("UEngine"), &Z_Registration_Info_UClass_UEngine, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEngine), 4064910599U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Engine_h_278451477(TEXT("/Script/Engine"),
