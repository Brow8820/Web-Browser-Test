...
template<> ENGINE_API UScriptStruct* StaticStruct<FChildActorComponentInstanceData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_ChildActorComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UChildActorComponent, UChildActorComponent::StaticClass, TEXT("UChildActorComponent"), &Z_Registration_Info_UClass_UChildActorComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UChildActorComponent), 651044200U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_ChildActorComponent_h_2344756619(TEXT("/Script/Engine"),
