...
template<> ENGINE_API UScriptStruct* StaticStruct<FSceneComponentInstanceData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_SceneComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USceneComponent, USceneComponent::StaticClass, TEXT("USceneComponent"), &Z_Registration_Info_UClass_USceneComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USceneComponent), 372122025U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_SceneComponent_h_731269205(TEXT("/Script/Engine"),
