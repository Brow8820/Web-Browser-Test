...
#include "Engine/Public/WorldPartition/WorldPartitionActorContainerID.h"
...
class UScriptStruct* FWorldPartitionRuntimeCellDebugInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WorldPartitionRuntimeCellDebugInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWorldPartitionRuntimeCellDebugInfo, Z_Construct_UPackage__Script_Engine(), TEXT("WorldPartitionRuntimeCellDebugInfo"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FWorldPartitionRuntimeCellDebugInfo>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWorldPartitionRuntimeCell_Statics::NewProp_ContentBounds_MetaData[] = {
		{ "ModuleRelativePath", "Public/WorldPartition/WorldPartitionRuntimeCell.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWorldPartitionRuntimeCell_Statics::NewProp_ContentBounds = { "ContentBounds", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UWorldPartitionRuntimeCell, ContentBounds), Z_Construct_UScriptStruct_FBox, METADATA_PARAMS(Z_Construct_UClass_UWorldPartitionRuntimeCell_Statics::NewProp_ContentBounds_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWorldPartitionRuntimeCell_Statics::NewProp_ContentBounds_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UWorldPartitionRuntimeCell_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWorldPartitionRuntimeCell_Statics::NewProp_ContentBounds,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionRuntimeCell_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWorldPartitionRuntimeCell, UWorldPartitionRuntimeCell::StaticClass, TEXT("UWorldPartitionRuntimeCell"), &Z_Registration_Info_UClass_UWorldPartitionRuntimeCell, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWorldPartitionRuntimeCell), 3617377397U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionRuntimeCell_h_1870658522(TEXT("/Script/Engine"),
