...
template<> ENGINE_API UScriptStruct* StaticStruct<FTextureSourceColorSettings>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTexture_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTexture_Blueprint_GetMemorySize, "Blueprint_GetMemorySize" }, // 2224129031
	};
#if WITH_METADATA
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTexture_Statics::NewProp_bUseNewMipFilter_MetaData[] = {
		{ "Category", "Texture" },
		{ "Comment", "/** Whether to use newer & faster mip generation filter, same quality but produces slightly different results from previous implementation */" },
		{ "ModuleRelativePath", "Classes/Engine/Texture.h" },
		{ "ToolTip", "Whether to use newer & faster mip generation filter, same quality but produces slightly different results from previous implementation" },
	};
#endif
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UTexture_Statics::NewProp_Filter = { "Filter", nullptr, (EPropertyFlags)0x0010050000000005, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UTexture, Filter), Z_Construct_UEnum_Engine_TextureFilter, METADATA_PARAMS(Z_Construct_UClass_UTexture_Statics::NewProp_Filter_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTexture_Statics::NewProp_Filter_MetaData)) }; // 3285266737
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Texture_h_Statics::EnumInfo[] = {
		...
		{ ETextureCompressionQuality_StaticEnum, TEXT("ETextureCompressionQuality"), &Z_Registration_Info_UEnum_ETextureCompressionQuality, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3909141892U) },
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Texture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTexture, UTexture::StaticClass, TEXT("UTexture"), &Z_Registration_Info_UClass_UTexture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTexture), 2120163312U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Texture_h_2502632613(TEXT("/Script/Engine"),
