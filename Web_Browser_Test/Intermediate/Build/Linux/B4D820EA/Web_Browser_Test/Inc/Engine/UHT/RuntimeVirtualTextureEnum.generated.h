...
// IWYU pragma: private, include "VT/RuntimeVirtualTextureEnum.h"
...
template<> struct TIsUEnumClass<ERuntimeVirtualTextureMaterialType> { enum { Value = true }; };
...
template<> struct TIsUEnumClass<ERuntimeVirtualTextureMainPassType> { enum { Value = true }; };
