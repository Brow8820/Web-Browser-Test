...
#include "Engine/Classes/Sound/SoundTimecodeOffset.h"
...
class UScriptStruct* FSoundTimecodeOffset::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SoundTimecodeOffset.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSoundTimecodeOffset, Z_Construct_UPackage__Script_Engine(), TEXT("SoundTimecodeOffset"));
	}
