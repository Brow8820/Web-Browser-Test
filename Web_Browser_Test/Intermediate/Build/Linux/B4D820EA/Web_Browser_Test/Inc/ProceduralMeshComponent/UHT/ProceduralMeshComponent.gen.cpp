...
template<> PROCEDURALMESHCOMPONENT_API UScriptStruct* StaticStruct<FProcMeshSection>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ProceduralMeshComponent_Source_ProceduralMeshComponent_Public_ProceduralMeshComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UProceduralMeshComponent, UProceduralMeshComponent::StaticClass, TEXT("UProceduralMeshComponent"), &Z_Registration_Info_UClass_UProceduralMeshComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProceduralMeshComponent), 4241670825U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ProceduralMeshComponent_Source_ProceduralMeshComponent_Public_ProceduralMeshComponent_h_2414666884(TEXT("/Script/ProceduralMeshComponent"),
