...
static inline bool FRigVMPeformUserWorkflowDynamicDelegate_DelegateWrapper(const FScriptDelegate& RigVMPeformUserWorkflowDynamicDelegate, const URigVMUserWorkflowOptions* InOptions, UObject* InController) \
{ \
...
#define FID_Engine_Source_Runtime_RigVM_Public_RigVMCore_RigVMUserWorkflow_h_108_ENHANCED_CONSTRUCTORS \
	/** Standard constructor, called after all reflected properties have been initialized */ \
	NO_API URigVMUserWorkflowOptions(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()) : Super(ObjectInitializer) { }; \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API URigVMUserWorkflowOptions(URigVMUserWorkflowOptions&&); \
	NO_API URigVMUserWorkflowOptions(const URigVMUserWorkflowOptions&); \
