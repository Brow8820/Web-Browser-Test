...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_RigVM_ERigVMOpCode_Statics::Enum_MetaDataParams[] = {
		...
		{ "Invalid.Comment", "// invokes an entry from the entry list\n" },
		{ "Invalid.Name", "ERigVMOpCode::Invalid" },
		{ "Invalid.ToolTip", "invokes an entry from the entry list" },
		{ "InvokeEntry.Comment", "// returns the reverse of the input array (unary op, in out array)\n" },
		{ "InvokeEntry.Name", "ERigVMOpCode::InvokeEntry" },
		{ "InvokeEntry.ToolTip", "returns the reverse of the input array (unary op, in out array)" },
...
class UScriptStruct* FRigVMInvokeEntryOp::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigVMInvokeEntryOp.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigVMInvokeEntryOp, Z_Construct_UPackage__Script_RigVM(), TEXT("RigVMInvokeEntryOp"));
	}
...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMInstructionArray>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigVMInstructionArray_Statics::NewProp_Instructions_Inner = { "Instructions", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FRigVMInstruction, METADATA_PARAMS(nullptr, 0) }; // 2379818991
#if WITH_METADATA
...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMByteCode>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_RigVM_Public_RigVMCore_RigVMByteCode_h_Statics::EnumInfo[] = {
		{ ERigVMOpCode_StaticEnum, TEXT("ERigVMOpCode"), &Z_Registration_Info_UEnum_ERigVMOpCode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 459968295U) },
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_RigVM_Public_RigVMCore_RigVMByteCode_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigVMInstruction::StaticStruct, Z_Construct_UScriptStruct_FRigVMInstruction_Statics::NewStructOps, TEXT("RigVMInstruction"), &Z_Registration_Info_UScriptStruct_RigVMInstruction, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMInstruction), 2379818991U) },
		{ FRigVMInstructionArray::StaticStruct, Z_Construct_UScriptStruct_FRigVMInstructionArray_Statics::NewStructOps, TEXT("RigVMInstructionArray"), &Z_Registration_Info_UScriptStruct_RigVMInstructionArray, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMInstructionArray), 3864033602U) },
		...
		{ FRigVMByteCode::StaticStruct, Z_Construct_UScriptStruct_FRigVMByteCode_Statics::NewStructOps, TEXT("RigVMByteCode"), &Z_Registration_Info_UScriptStruct_RigVMByteCode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMByteCode), 2364262512U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_RigVM_Public_RigVMCore_RigVMByteCode_h_2331431309(TEXT("/Script/RigVM"),
		nullptr, 0,
