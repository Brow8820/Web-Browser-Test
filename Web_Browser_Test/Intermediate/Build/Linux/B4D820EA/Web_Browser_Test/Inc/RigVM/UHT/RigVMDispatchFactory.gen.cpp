...
class UScriptStruct* FRigVMDispatchFactory::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigVMDispatchFactory.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigVMDispatchFactory, Z_Construct_UPackage__Script_RigVM(), TEXT("RigVMDispatchFactory"));
	}
...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMDispatchFactory>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_RigVM_Public_RigVMCore_RigVMDispatchFactory_h_Statics::ScriptStructInfo[] = {
		{ FRigVMDispatchFactory::StaticStruct, Z_Construct_UScriptStruct_FRigVMDispatchFactory_Statics::NewStructOps, TEXT("RigVMDispatchFactory"), &Z_Registration_Info_UScriptStruct_RigVMDispatchFactory, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMDispatchFactory), 3570602076U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_RigVM_Public_RigVMCore_RigVMDispatchFactory_h_2235784139(TEXT("/Script/RigVM"),
		nullptr, 0,
