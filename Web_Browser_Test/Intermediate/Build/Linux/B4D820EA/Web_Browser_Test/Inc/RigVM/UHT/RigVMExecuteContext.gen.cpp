...
class UScriptStruct* FRigVMExtendedExecuteContext::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigVMExtendedExecuteContext.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigVMExtendedExecuteContext, Z_Construct_UPackage__Script_RigVM(), TEXT("RigVMExtendedExecuteContext"));
	}
...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMExtendedExecuteContext>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_RigVM_Public_RigVMCore_RigVMExecuteContext_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigVMExecuteContext::StaticStruct, Z_Construct_UScriptStruct_FRigVMExecuteContext_Statics::NewStructOps, TEXT("RigVMExecuteContext"), &Z_Registration_Info_UScriptStruct_RigVMExecuteContext, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMExecuteContext), 3250382500U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_RigVM_Public_RigVMCore_RigVMExecuteContext_h_439441640(TEXT("/Script/RigVM"),
		nullptr, 0,
