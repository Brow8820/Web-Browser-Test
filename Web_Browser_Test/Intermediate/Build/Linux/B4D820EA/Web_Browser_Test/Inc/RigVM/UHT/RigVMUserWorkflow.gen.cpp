...
// End Cross Module References
	...
	static UEnum* ERigVMUserWorkflowType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERigVMUserWorkflowType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_RigVM_ERigVMUserWorkflowType, Z_Construct_UPackage__Script_RigVM(), TEXT("ERigVMUserWorkflowType"));
		}
...
class UScriptStruct* FRigVMUserWorkflow::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigVMUserWorkflow.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigVMUserWorkflow, Z_Construct_UPackage__Script_RigVM(), TEXT("RigVMUserWorkflow"));
	}
