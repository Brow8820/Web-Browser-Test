...
class UScriptStruct* FRigVMTemplateArgumentType::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigVMTemplateArgumentType.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigVMTemplateArgumentType, Z_Construct_UPackage__Script_RigVM(), TEXT("RigVMTemplateArgumentType"));
	}
