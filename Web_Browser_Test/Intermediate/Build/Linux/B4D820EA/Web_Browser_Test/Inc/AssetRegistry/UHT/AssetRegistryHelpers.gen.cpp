...
template<> ASSETREGISTRY_API UScriptStruct* StaticStruct<FTagAndValue>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AssetRegistry_Public_AssetRegistry_AssetRegistryHelpers_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetRegistryHelpers, UAssetRegistryHelpers::StaticClass, TEXT("UAssetRegistryHelpers"), &Z_Registration_Info_UClass_UAssetRegistryHelpers, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetRegistryHelpers), 1440624203U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AssetRegistry_Public_AssetRegistry_AssetRegistryHelpers_h_993246899(TEXT("/Script/AssetRegistry"),
