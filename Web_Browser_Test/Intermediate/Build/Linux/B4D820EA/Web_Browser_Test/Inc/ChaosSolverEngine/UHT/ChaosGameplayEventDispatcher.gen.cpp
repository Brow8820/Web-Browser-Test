...
class UScriptStruct* FChaosCrumblingEvent::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ChaosCrumblingEvent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FChaosCrumblingEvent, Z_Construct_UPackage__Script_ChaosSolverEngine(), TEXT("ChaosCrumblingEvent"));
	}
...
class UScriptStruct* FCrumblingEventCallbackWrapper::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CrumblingEventCallbackWrapper.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCrumblingEventCallbackWrapper, Z_Construct_UPackage__Script_ChaosSolverEngine(), TEXT("CrumblingEventCallbackWrapper"));
	}
...
template<> CHAOSSOLVERENGINE_API UScriptStruct* StaticStruct<FChaosHandlerSet>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_ChaosSolverEngine_Public_Chaos_ChaosGameplayEventDispatcher_h_Statics::ScriptStructInfo[] = {
		{ FChaosBreakEvent::StaticStruct, Z_Construct_UScriptStruct_FChaosBreakEvent_Statics::NewStructOps, TEXT("ChaosBreakEvent"), &Z_Registration_Info_UScriptStruct_ChaosBreakEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FChaosBreakEvent), 3145492431U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_ChaosSolverEngine_Public_Chaos_ChaosGameplayEventDispatcher_h_1052117287(TEXT("/Script/ChaosSolverEngine"),
