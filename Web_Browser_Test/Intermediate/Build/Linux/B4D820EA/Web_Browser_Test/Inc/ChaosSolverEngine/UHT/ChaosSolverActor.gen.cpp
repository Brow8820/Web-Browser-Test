...
template<> CHAOSSOLVERENGINE_API UScriptStruct* StaticStruct<FChaosDebugSubstepControl>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_ChaosSolverEngine_Public_Chaos_ChaosSolverActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AChaosSolverActor, AChaosSolverActor::StaticClass, TEXT("AChaosSolverActor"), &Z_Registration_Info_UClass_AChaosSolverActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AChaosSolverActor), 2972327257U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_ChaosSolverEngine_Public_Chaos_ChaosSolverActor_h_4133689466(TEXT("/Script/ChaosSolverEngine"),
