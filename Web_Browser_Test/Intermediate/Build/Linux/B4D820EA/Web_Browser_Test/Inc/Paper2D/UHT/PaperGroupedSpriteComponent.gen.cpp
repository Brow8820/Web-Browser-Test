...
template<> PAPER2D_API UScriptStruct* StaticStruct<FSpriteInstanceData>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_PaperGroupedSpriteComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPaperGroupedSpriteComponent, UPaperGroupedSpriteComponent::StaticClass, TEXT("UPaperGroupedSpriteComponent"), &Z_Registration_Info_UClass_UPaperGroupedSpriteComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPaperGroupedSpriteComponent), 3720271317U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_PaperGroupedSpriteComponent_h_3450449602(TEXT("/Script/Paper2D"),
