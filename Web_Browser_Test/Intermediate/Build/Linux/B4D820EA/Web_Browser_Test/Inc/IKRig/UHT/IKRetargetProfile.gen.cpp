...
class UScriptStruct* FRetargetProfile::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RetargetProfile.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRetargetProfile, Z_Construct_UPackage__Script_IKRig(), TEXT("RetargetProfile"));
	}
...
template<> IKRIG_API UScriptStruct* StaticStruct<FRetargetProfile>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Retargeter_IKRetargetProfile_h_Statics::ScriptStructInfo[] = {
		{ FRetargetProfile::StaticStruct, Z_Construct_UScriptStruct_FRetargetProfile_Statics::NewStructOps, TEXT("RetargetProfile"), &Z_Registration_Info_UScriptStruct_RetargetProfile, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRetargetProfile), 1974770294U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Retargeter_IKRetargetProfile_h_2153278908(TEXT("/Script/IKRig"),
		nullptr, 0,
