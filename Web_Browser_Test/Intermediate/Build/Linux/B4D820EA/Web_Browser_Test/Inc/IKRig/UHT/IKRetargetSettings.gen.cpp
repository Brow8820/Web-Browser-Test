...
class UScriptStruct* FTargetChainSpeedPlantSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TargetChainSpeedPlantSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTargetChainSpeedPlantSettings, Z_Construct_UPackage__Script_IKRig(), TEXT("TargetChainSpeedPlantSettings"));
	}
...
class UScriptStruct* FTargetChainFKSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TargetChainFKSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTargetChainFKSettings, Z_Construct_UPackage__Script_IKRig(), TEXT("TargetChainFKSettings"));
	}
...
class UScriptStruct* FTargetChainIKSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TargetChainIKSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTargetChainIKSettings, Z_Construct_UPackage__Script_IKRig(), TEXT("TargetChainIKSettings"));
	}
...
class UScriptStruct* FTargetChainSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TargetChainSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTargetChainSettings, Z_Construct_UPackage__Script_IKRig(), TEXT("TargetChainSettings"));
	}
...
class UScriptStruct* FTargetRootSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TargetRootSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTargetRootSettings, Z_Construct_UPackage__Script_IKRig(), TEXT("TargetRootSettings"));
	}
...
template<> IKRIG_API UScriptStruct* StaticStruct<FTargetRootSettings>()
{
	...
	static UEnum* EBasicAxis_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EBasicAxis.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_IKRig_EBasicAxis, Z_Construct_UPackage__Script_IKRig(), TEXT("EBasicAxis"));
		}
	...
	static UEnum* EWarpingDirectionSource_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EWarpingDirectionSource.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_IKRig_EWarpingDirectionSource, Z_Construct_UPackage__Script_IKRig(), TEXT("EWarpingDirectionSource"));
		}
...
class UScriptStruct* FRetargetGlobalSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RetargetGlobalSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRetargetGlobalSettings, Z_Construct_UPackage__Script_IKRig(), TEXT("RetargetGlobalSettings"));
	}
...
template<> IKRIG_API UScriptStruct* StaticStruct<FRetargetGlobalSettings>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Retargeter_IKRetargetSettings_h_Statics::ScriptStructInfo[] = {
		{ FTargetChainSpeedPlantSettings::StaticStruct, Z_Construct_UScriptStruct_FTargetChainSpeedPlantSettings_Statics::NewStructOps, TEXT("TargetChainSpeedPlantSettings"), &Z_Registration_Info_UScriptStruct_TargetChainSpeedPlantSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTargetChainSpeedPlantSettings), 791888678U) },
		...
		{ FTargetChainIKSettings::StaticStruct, Z_Construct_UScriptStruct_FTargetChainIKSettings_Statics::NewStructOps, TEXT("TargetChainIKSettings"), &Z_Registration_Info_UScriptStruct_TargetChainIKSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTargetChainIKSettings), 1338025045U) },
		{ FTargetChainSettings::StaticStruct, Z_Construct_UScriptStruct_FTargetChainSettings_Statics::NewStructOps, TEXT("TargetChainSettings"), &Z_Registration_Info_UScriptStruct_TargetChainSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTargetChainSettings), 859079881U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Retargeter_IKRetargetSettings_h_1282140460(TEXT("/Script/IKRig"),
		nullptr, 0,
