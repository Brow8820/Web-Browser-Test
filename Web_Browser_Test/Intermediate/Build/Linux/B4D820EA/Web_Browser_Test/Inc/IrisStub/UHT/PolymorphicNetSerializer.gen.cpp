...
#include "Stub/Public/Iris/Serialization/PolymorphicNetSerializer.h"
...
// Cross Module References
	...
	IRISSTUB_API UScriptStruct* Z_Construct_UScriptStruct_FPolymorphicArrayStructNetSerializerConfig();
	IRISSTUB_API UScriptStruct* Z_Construct_UScriptStruct_FPolymorphicStructNetSerializerConfig();
...
class UScriptStruct* FPolymorphicStructNetSerializerConfig::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PolymorphicStructNetSerializerConfig.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPolymorphicStructNetSerializerConfig, Z_Construct_UPackage__Script_IrisStub(), TEXT("PolymorphicStructNetSerializerConfig"));
	}
	return Z_Registration_Info_UScriptStruct_PolymorphicStructNetSerializerConfig.OuterSingleton;
}
template<> IRISSTUB_API UScriptStruct* StaticStruct<FPolymorphicStructNetSerializerConfig>()
{
...
static_assert(std::is_polymorphic<FPolymorphicArrayStructNetSerializerConfig>() == std::is_polymorphic<FNetSerializerConfig>(), "USTRUCT FPolymorphicArrayStructNetSerializerConfig cannot be polymorphic unless super FNetSerializerConfig is polymorphic");
...
class UScriptStruct* FPolymorphicArrayStructNetSerializerConfig::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PolymorphicArrayStructNetSerializerConfig.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPolymorphicArrayStructNetSerializerConfig, Z_Construct_UPackage__Script_IrisStub(), TEXT("PolymorphicArrayStructNetSerializerConfig"));
	}
	return Z_Registration_Info_UScriptStruct_PolymorphicArrayStructNetSerializerConfig.OuterSingleton;
}
template<> IRISSTUB_API UScriptStruct* StaticStruct<FPolymorphicArrayStructNetSerializerConfig>()
{
	...
	struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Stub_Public_Iris_Serialization_PolymorphicNetSerializer_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Stub_Public_Iris_Serialization_PolymorphicNetSerializer_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Stub_Public_Iris_Serialization_PolymorphicNetSerializer_h_3445205790(TEXT("/Script/IrisStub"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Stub_Public_Iris_Serialization_PolymorphicNetSerializer_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Stub_Public_Iris_Serialization_PolymorphicNetSerializer_h_Statics::ScriptStructInfo),
		nullptr, 0);
