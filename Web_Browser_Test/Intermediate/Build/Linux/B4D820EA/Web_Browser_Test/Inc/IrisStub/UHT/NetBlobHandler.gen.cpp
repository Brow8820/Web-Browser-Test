...
#include "Stub/Public/Iris/ReplicationSystem/NetBlob/NetBlobHandler.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeNetBlobHandler() {}
// Cross Module References
	COREUOBJECT_API UClass* Z_Construct_UClass_UObject();
	IRISSTUB_API UClass* Z_Construct_UClass_UNetBlobHandler();
	IRISSTUB_API UClass* Z_Construct_UClass_UNetBlobHandler_NoRegister();
...
// End Cross Module References
	...
	template<> IRISSTUB_API UClass* StaticClass<UNetBlobHandler>()
	{
		return UNetBlobHandler::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UNetBlobHandler);
	UNetBlobHandler::~UNetBlobHandler() {}
	struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Stub_Public_Iris_ReplicationSystem_NetBlob_NetBlobHandler_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Stub_Public_Iris_ReplicationSystem_NetBlob_NetBlobHandler_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNetBlobHandler, UNetBlobHandler::StaticClass, TEXT("UNetBlobHandler"), &Z_Registration_Info_UClass_UNetBlobHandler, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNetBlobHandler), 201875711U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Stub_Public_Iris_ReplicationSystem_NetBlob_NetBlobHandler_h_3545650295(TEXT("/Script/IrisStub"),
		Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Stub_Public_Iris_ReplicationSystem_NetBlob_NetBlobHandler_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Stub_Public_Iris_ReplicationSystem_NetBlob_NetBlobHandler_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
