...
#include "Stub/Public/Iris/ReplicationSystem/ReplicationBridge.h"
...
// Cross Module References
	...
	IRISSTUB_API UClass* Z_Construct_UClass_UReplicationBridge_NoRegister();
...
// End Cross Module References
	...
	template<> IRISSTUB_API UClass* StaticClass<UReplicationBridge>()
	{
		return UReplicationBridge::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UReplicationBridge);
	UReplicationBridge::~UReplicationBridge() {}
	struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Stub_Public_Iris_ReplicationSystem_ReplicationBridge_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Stub_Public_Iris_ReplicationSystem_ReplicationBridge_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UReplicationBridge, UReplicationBridge::StaticClass, TEXT("UReplicationBridge"), &Z_Registration_Info_UClass_UReplicationBridge, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UReplicationBridge), 2284743557U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Stub_Public_Iris_ReplicationSystem_ReplicationBridge_h_1761944516(TEXT("/Script/IrisStub"),
		Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Stub_Public_Iris_ReplicationSystem_ReplicationBridge_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_Iris_Stub_Public_Iris_ReplicationSystem_ReplicationBridge_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
