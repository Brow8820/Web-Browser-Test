...
// End Cross Module References
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Private_Systems_TemplateSequenceSystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTemplateSequenceSystem, UTemplateSequenceSystem::StaticClass, TEXT("UTemplateSequenceSystem"), &Z_Registration_Info_UClass_UTemplateSequenceSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTemplateSequenceSystem), 2056249384U) },
		...
		{ Z_Construct_UClass_UTemplateSequencePropertyScalingEvaluatorSystem, UTemplateSequencePropertyScalingEvaluatorSystem::StaticClass, TEXT("UTemplateSequencePropertyScalingEvaluatorSystem"), &Z_Registration_Info_UClass_UTemplateSequencePropertyScalingEvaluatorSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTemplateSequencePropertyScalingEvaluatorSystem), 2949089670U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Private_Systems_TemplateSequenceSystem_h_840487380(TEXT("/Script/TemplateSequence"),
