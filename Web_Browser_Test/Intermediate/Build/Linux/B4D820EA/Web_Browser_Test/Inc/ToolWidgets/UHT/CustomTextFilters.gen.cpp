...
#include "ToolWidgets/Public/Filters/CustomTextFilters.h"
...
class UScriptStruct* FCustomTextFilterData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CustomTextFilterData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCustomTextFilterData, Z_Construct_UPackage__Script_ToolWidgets(), TEXT("CustomTextFilterData"));
	}
