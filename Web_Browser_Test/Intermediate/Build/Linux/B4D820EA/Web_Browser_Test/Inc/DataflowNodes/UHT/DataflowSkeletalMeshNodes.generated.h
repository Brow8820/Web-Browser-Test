...
#define FID_Engine_Plugins_Experimental_Dataflow_Source_DataflowNodes_Public_Dataflow_DataflowSkeletalMeshNodes_h_18_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FGetSkeletalMeshDataflowNode_Statics; \
	static class UScriptStruct* StaticStruct(); \
	typedef FDataflowNode Super;


template<> DATAFLOWNODES_API UScriptStruct* StaticStruct<struct FGetSkeletalMeshDataflowNode>();

#define FID_Engine_Plugins_Experimental_Dataflow_Source_DataflowNodes_Public_Dataflow_DataflowSkeletalMeshNodes_h_43_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FSkeletalMeshBoneDataflowNode_Statics; \
	static class UScriptStruct* StaticStruct(); \
	typedef FDataflowNode Super;


template<> DATAFLOWNODES_API UScriptStruct* StaticStruct<struct FSkeletalMeshBoneDataflowNode>();
