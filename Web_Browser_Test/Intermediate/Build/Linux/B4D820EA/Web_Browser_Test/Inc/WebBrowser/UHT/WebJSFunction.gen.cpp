...
#include "WebBrowser/Public/WebJSFunction.h"
...
class UScriptStruct* FWebJSCallbackBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WebJSCallbackBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWebJSCallbackBase, Z_Construct_UPackage__Script_WebBrowser(), TEXT("WebJSCallbackBase"));
	}
...
class UScriptStruct* FWebJSFunction::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WebJSFunction.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWebJSFunction, Z_Construct_UPackage__Script_WebBrowser(), TEXT("WebJSFunction"));
	}
...
class UScriptStruct* FWebJSResponse::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WebJSResponse.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWebJSResponse, Z_Construct_UPackage__Script_WebBrowser(), TEXT("WebJSResponse"));
	}
