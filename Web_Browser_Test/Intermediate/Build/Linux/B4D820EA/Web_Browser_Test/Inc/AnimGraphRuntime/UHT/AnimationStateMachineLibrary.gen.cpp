...
class UScriptStruct* FAnimationStateMachineReference::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimationStateMachineReference.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimationStateMachineReference, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimationStateMachineReference"));
	}
...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FAnimationStateMachineReference>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAnimationStateMachineLibrary_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UAnimationStateMachineLibrary_SetState, "SetState" }, // 1381812402
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimationStateMachineLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimationStateMachineLibrary, UAnimationStateMachineLibrary::StaticClass, TEXT("UAnimationStateMachineLibrary"), &Z_Registration_Info_UClass_UAnimationStateMachineLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimationStateMachineLibrary), 1452677258U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimationStateMachineLibrary_h_401599942(TEXT("/Script/AnimGraphRuntime"),
