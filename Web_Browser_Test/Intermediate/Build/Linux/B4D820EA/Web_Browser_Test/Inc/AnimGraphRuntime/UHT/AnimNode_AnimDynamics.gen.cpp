...
class UScriptStruct* FAnimPhysBodyDefinition::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimPhysBodyDefinition.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimPhysBodyDefinition, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimPhysBodyDefinition"));
	}
