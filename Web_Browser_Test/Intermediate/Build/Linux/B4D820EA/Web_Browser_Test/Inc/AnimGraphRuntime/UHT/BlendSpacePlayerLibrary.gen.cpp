...
#include "AnimGraphRuntime/Public/BlendSpacePlayerLibrary.h"
...
class UScriptStruct* FBlendSpacePlayerReference::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BlendSpacePlayerReference.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBlendSpacePlayerReference, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("BlendSpacePlayerReference"));
	}
...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FBlendSpacePlayerReference>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_BlendSpacePlayerLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBlendSpacePlayerLibrary, UBlendSpacePlayerLibrary::StaticClass, TEXT("UBlendSpacePlayerLibrary"), &Z_Registration_Info_UClass_UBlendSpacePlayerLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBlendSpacePlayerLibrary), 3851592116U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_BlendSpacePlayerLibrary_h_3644713769(TEXT("/Script/AnimGraphRuntime"),
