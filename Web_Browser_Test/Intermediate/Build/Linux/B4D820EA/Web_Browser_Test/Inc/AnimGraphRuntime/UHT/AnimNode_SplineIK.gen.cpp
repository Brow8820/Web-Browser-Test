...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FAnimNode_SplineIK>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_BoneControllers_AnimNode_SplineIK_h_Statics::ScriptStructInfo[] = {
		...
		{ FAnimNode_SplineIK::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_SplineIK_Statics::NewStructOps, TEXT("AnimNode_SplineIK"), &Z_Registration_Info_UScriptStruct_AnimNode_SplineIK, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_SplineIK), 1411194104U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_BoneControllers_AnimNode_SplineIK_h_2344165233(TEXT("/Script/AnimGraphRuntime"),
		nullptr, 0,
