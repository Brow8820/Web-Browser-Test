...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<struct FAnimNode_BlendSpacePlayerBase>();

#define FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_BlendSpacePlayer_h_119_GENERATED_BODY \
...
#define FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_BlendSpacePlayer_h_206_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FAnimNode_BlendSpacePlayer_Standalone_Statics; \
	static class UScriptStruct* StaticStruct(); \
	typedef FAnimNode_BlendSpacePlayerBase Super;


template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<struct FAnimNode_BlendSpacePlayer_Standalone>();
