...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FAnimNode_BlendListBase>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_BlendListBase_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_BlendListBase::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_BlendListBase_Statics::NewStructOps, TEXT("AnimNode_BlendListBase"), &Z_Registration_Info_UScriptStruct_AnimNode_BlendListBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_BlendListBase), 291219605U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_BlendListBase_h_2153809825(TEXT("/Script/AnimGraphRuntime"),
		nullptr, 0,
