...
class UScriptStruct* FAnimNode_BlendSpacePlayerBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_BlendSpacePlayerBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_BlendSpacePlayerBase, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_BlendSpacePlayerBase"));
	}
...
class UScriptStruct* FAnimNode_BlendSpacePlayer_Standalone::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_BlendSpacePlayer_Standalone.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_BlendSpacePlayer_Standalone, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_BlendSpacePlayer_Standalone"));
	}
