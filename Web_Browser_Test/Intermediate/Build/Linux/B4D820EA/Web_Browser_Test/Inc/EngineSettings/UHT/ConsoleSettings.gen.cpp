...
template<> ENGINESETTINGS_API UScriptStruct* StaticStruct<FAutoCompleteCommand>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_EngineSettings_Classes_ConsoleSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UConsoleSettings, UConsoleSettings::StaticClass, TEXT("UConsoleSettings"), &Z_Registration_Info_UClass_UConsoleSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UConsoleSettings), 1447764369U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_EngineSettings_Classes_ConsoleSettings_h_3269145335(TEXT("/Script/EngineSettings"),
