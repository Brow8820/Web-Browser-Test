...
// End Cross Module References
	...
	static UEnum* ETriggerState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ETriggerState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_EnhancedInput_ETriggerState, Z_Construct_UPackage__Script_EnhancedInput(), TEXT("ETriggerState"));
		}
	...
	static UEnum* ETriggerEvent_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ETriggerEvent.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_EnhancedInput_ETriggerEvent, Z_Construct_UPackage__Script_EnhancedInput(), TEXT("ETriggerEvent"));
		}
	...
	static UEnum* ETriggerType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ETriggerType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_EnhancedInput_ETriggerType, Z_Construct_UPackage__Script_EnhancedInput(), TEXT("ETriggerType"));
		}
	...
	static UEnum* ETriggerEventsSupported_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ETriggerEventsSupported.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_EnhancedInput_ETriggerEventsSupported, Z_Construct_UPackage__Script_EnhancedInput(), TEXT("ETriggerEventsSupported"));
		}
...
class UScriptStruct* FInputComboStepData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InputComboStepData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInputComboStepData, Z_Construct_UPackage__Script_EnhancedInput(), TEXT("InputComboStepData"));
	}
...
template<> ENHANCEDINPUT_API UScriptStruct* StaticStruct<FInputComboStepData>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FInputComboStepData_Statics::NewProp_ComboStepAction_MetaData[] = {
		{ "Category", "Trigger Settings" },
		{ "Comment", "// The action that must be triggering to progress the combo\n" },
		{ "DisplayThumbnail", "false" },
		{ "ModuleRelativePath", "Public/InputTriggers.h" },
		{ "NativeConstTemplateArg", "" },
		{ "ToolTip", "The action that must be triggering to progress the combo" },
	};
#endif
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FInputComboStepData_Statics::NewProp_TimeToPressKey_MetaData[] = {
		{ "Category", "Trigger Settings" },
		{ "Comment", "// Time to press the key and for it to count towards the combo\n" },
		{ "ModuleRelativePath", "Public/InputTriggers.h" },
		{ "ToolTip", "Time to press the key and for it to count towards the combo" },
	};
#endif
	...
	struct Z_Construct_UClass_UInputTriggerCombo_Statics
	{
		...
		static const UECodeGen_Private::FObjectPtrPropertyParams NewProp_CancelActions_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_CancelActions_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_CancelActions;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const FCppClassTypeInfoStatic StaticCppClassTypeInfo;
		static const UECodeGen_Private::FClassParams ClassParams;
	};
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_ComboActions_Inner = { "ComboActions", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FInputComboStepData, METADATA_PARAMS(nullptr, 0) }; // 875304767
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_ComboActions_MetaData[] = {
		{ "Category", "Trigger Settings" },
		{ "Comment", "/**\n\x09 * List of input actions that need to be completed to trigger this action.\n\x09 * Input actions must be triggered in order (starting at index 0) to count towards the completion of the combo.\n\x09 */" },
		{ "DisplayThumbnail", "false" },
		{ "ModuleRelativePath", "Public/InputTriggers.h" },
		{ "TitleProperty", "ComboStepAction" },
		{ "ToolTip", "List of input actions that need to be completed to trigger this action.\nInput actions must be triggered in order (starting at index 0) to count towards the completion of the combo." },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_ComboActions = { "ComboActions", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UInputTriggerCombo, ComboActions), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_ComboActions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_ComboActions_MetaData)) }; // 875304767
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_CancelActions_Inner = { "CancelActions", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_CancelActions_MetaData[] = {
		{ "Category", "Trigger Settings" },
		{ "Comment", "// Actions that will cancel the combo if they are triggered\n" },
		{ "DisplayThumbnail", "false" },
		{ "ModuleRelativePath", "Public/InputTriggers.h" },
		{ "ToolTip", "Actions that will cancel the combo if they are triggered" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_CancelActions = { "CancelActions", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UInputTriggerCombo, CancelActions), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_CancelActions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_CancelActions_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UInputTriggerCombo_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_CancelActions_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UInputTriggerCombo_Statics::NewProp_CancelActions,
	};
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputTriggers_h_Statics::EnumInfo[] = {
		...
		{ ETriggerEvent_StaticEnum, TEXT("ETriggerEvent"), &Z_Registration_Info_UEnum_ETriggerEvent, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 903391186U) },
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputTriggers_h_Statics::ScriptStructInfo[] = {
		{ FInputComboStepData::StaticStruct, Z_Construct_UScriptStruct_FInputComboStepData_Statics::NewStructOps, TEXT("InputComboStepData"), &Z_Registration_Info_UScriptStruct_InputComboStepData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInputComboStepData), 875304767U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputTriggers_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UInputTriggerTimedBase, UInputTriggerTimedBase::StaticClass, TEXT("UInputTriggerTimedBase"), &Z_Registration_Info_UClass_UInputTriggerTimedBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerTimedBase), 3869075508U) },
		...
		{ Z_Construct_UClass_UInputTriggerHold, UInputTriggerHold::StaticClass, TEXT("UInputTriggerHold"), &Z_Registration_Info_UClass_UInputTriggerHold, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerHold), 2028410643U) },
		{ Z_Construct_UClass_UInputTriggerHoldAndRelease, UInputTriggerHoldAndRelease::StaticClass, TEXT("UInputTriggerHoldAndRelease"), &Z_Registration_Info_UClass_UInputTriggerHoldAndRelease, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerHoldAndRelease), 1657850077U) },
		{ Z_Construct_UClass_UInputTriggerTap, UInputTriggerTap::StaticClass, TEXT("UInputTriggerTap"), &Z_Registration_Info_UClass_UInputTriggerTap, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerTap), 3054462149U) },
		{ Z_Construct_UClass_UInputTriggerPulse, UInputTriggerPulse::StaticClass, TEXT("UInputTriggerPulse"), &Z_Registration_Info_UClass_UInputTriggerPulse, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerPulse), 1759418266U) },
		...
		{ Z_Construct_UClass_UInputTriggerCombo, UInputTriggerCombo::StaticClass, TEXT("UInputTriggerCombo"), &Z_Registration_Info_UClass_UInputTriggerCombo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTriggerCombo), 4053454939U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputTriggers_h_1834810858(TEXT("/Script/EnhancedInput"),
