...
// End Cross Module References
	...
	static UEnum* EMappingQueryResult_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMappingQueryResult.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_EnhancedInput_EMappingQueryResult, Z_Construct_UPackage__Script_EnhancedInput(), TEXT("EMappingQueryResult"));
		}
	...
	static UEnum* EMappingQueryIssue_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMappingQueryIssue.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_EnhancedInput_EMappingQueryIssue, Z_Construct_UPackage__Script_EnhancedInput(), TEXT("EMappingQueryIssue"));
		}
...
class UScriptStruct* FMappingQueryIssue::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MappingQueryIssue.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMappingQueryIssue, Z_Construct_UPackage__Script_EnhancedInput(), TEXT("MappingQueryIssue"));
	}
