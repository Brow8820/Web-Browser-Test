...
// End Cross Module References
	...
	static UEnum* EInputActionValueType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EInputActionValueType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_EnhancedInput_EInputActionValueType, Z_Construct_UPackage__Script_EnhancedInput(), TEXT("EInputActionValueType"));
		}
...
class UScriptStruct* FInputActionValue::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InputActionValue.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInputActionValue, Z_Construct_UPackage__Script_EnhancedInput(), TEXT("InputActionValue"));
	}
