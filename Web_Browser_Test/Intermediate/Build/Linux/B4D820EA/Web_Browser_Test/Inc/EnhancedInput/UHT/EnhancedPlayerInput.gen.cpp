...
class UScriptStruct* FInjectedInputArray::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InjectedInputArray.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInjectedInputArray, Z_Construct_UPackage__Script_EnhancedInput(), TEXT("InjectedInputArray"));
	}
...
template<> ENHANCEDINPUT_API UScriptStruct* StaticStruct<FInjectedInputArray>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEnhancedPlayerInput_Statics::NewProp_ActionInstanceData_ValueProp = { "ActionInstanceData", nullptr, (EPropertyFlags)0x0000008000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 1, Z_Construct_UScriptStruct_FInputActionInstance, METADATA_PARAMS(nullptr, 0) }; // 530328368
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_EnhancedPlayerInput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEnhancedPlayerInput, UEnhancedPlayerInput::StaticClass, TEXT("UEnhancedPlayerInput"), &Z_Registration_Info_UClass_UEnhancedPlayerInput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnhancedPlayerInput), 4270919636U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_EnhancedPlayerInput_h_3496531775(TEXT("/Script/EnhancedInput"),
