...
template<> ENHANCEDINPUT_API UScriptStruct* StaticStruct<FInputActionInstance>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputAction_h_Statics::ScriptStructInfo[] = {
		{ FInputActionInstance::StaticStruct, Z_Construct_UScriptStruct_FInputActionInstance_Statics::NewStructOps, TEXT("InputActionInstance"), &Z_Registration_Info_UScriptStruct_InputActionInstance, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInputActionInstance), 530328368U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputAction_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInputAction, UInputAction::StaticClass, TEXT("UInputAction"), &Z_Registration_Info_UClass_UInputAction, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputAction), 1343448187U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_EnhancedInput_Source_EnhancedInput_Public_InputAction_h_240741727(TEXT("/Script/EnhancedInput"),
