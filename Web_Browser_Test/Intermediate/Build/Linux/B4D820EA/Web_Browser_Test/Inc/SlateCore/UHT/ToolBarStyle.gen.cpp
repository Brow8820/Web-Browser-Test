...
template<> SLATECORE_API UScriptStruct* StaticStruct<FToolBarStyle>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Styling_ToolBarStyle_h_Statics::ScriptStructInfo[] = {
		{ FToolBarStyle::StaticStruct, Z_Construct_UScriptStruct_FToolBarStyle_Statics::NewStructOps, TEXT("ToolBarStyle"), &Z_Registration_Info_UScriptStruct_ToolBarStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FToolBarStyle), 2602311045U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Styling_ToolBarStyle_h_2172142762(TEXT("/Script/SlateCore"),
		nullptr, 0,
