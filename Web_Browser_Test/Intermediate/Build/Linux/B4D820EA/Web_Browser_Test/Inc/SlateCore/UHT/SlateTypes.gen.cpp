...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTextBlockStyle_Statics::NewProp_ShadowOffset = { "ShadowOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FTextBlockStyle, ShadowOffset), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UScriptStruct_FTextBlockStyle_Statics::NewProp_ShadowOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTextBlockStyle_Statics::NewProp_ShadowOffset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FComboButtonStyle_Statics::NewProp_ShadowOffset = { "ShadowOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FComboButtonStyle, ShadowOffset), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UScriptStruct_FComboButtonStyle_Statics::NewProp_ShadowOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FComboButtonStyle_Statics::NewProp_ShadowOffset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHyperlinkStyle_Statics::NewProp_UnderlineStyle = { "UnderlineStyle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FHyperlinkStyle, UnderlineStyle), Z_Construct_UScriptStruct_FButtonStyle, METADATA_PARAMS(Z_Construct_UScriptStruct_FHyperlinkStyle_Statics::NewProp_UnderlineStyle_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHyperlinkStyle_Statics::NewProp_UnderlineStyle_MetaData)) }; // 2764557507
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHyperlinkStyle_Statics::NewProp_TextStyle = { "TextStyle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FHyperlinkStyle, TextStyle), Z_Construct_UScriptStruct_FTextBlockStyle, METADATA_PARAMS(Z_Construct_UScriptStruct_FHyperlinkStyle_Statics::NewProp_TextStyle_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHyperlinkStyle_Statics::NewProp_TextStyle_MetaData)) }; // 1792543659
#if WITH_METADATA
...
template<> SLATECORE_API UScriptStruct* StaticStruct<FWindowStyle>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Styling_SlateTypes_h_Statics::ScriptStructInfo[] = {
		{ FCheckBoxStyle::StaticStruct, Z_Construct_UScriptStruct_FCheckBoxStyle_Statics::NewStructOps, TEXT("CheckBoxStyle"), &Z_Registration_Info_UScriptStruct_CheckBoxStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCheckBoxStyle), 3293849988U) },
		{ FTextBlockStyle::StaticStruct, Z_Construct_UScriptStruct_FTextBlockStyle_Statics::NewStructOps, TEXT("TextBlockStyle"), &Z_Registration_Info_UScriptStruct_TextBlockStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTextBlockStyle), 1792543659U) },
		{ FButtonStyle::StaticStruct, Z_Construct_UScriptStruct_FButtonStyle_Statics::NewStructOps, TEXT("ButtonStyle"), &Z_Registration_Info_UScriptStruct_ButtonStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FButtonStyle), 2764557507U) },
		{ FComboButtonStyle::StaticStruct, Z_Construct_UScriptStruct_FComboButtonStyle_Statics::NewStructOps, TEXT("ComboButtonStyle"), &Z_Registration_Info_UScriptStruct_ComboButtonStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FComboButtonStyle), 3047976933U) },
		{ FComboBoxStyle::StaticStruct, Z_Construct_UScriptStruct_FComboBoxStyle_Statics::NewStructOps, TEXT("ComboBoxStyle"), &Z_Registration_Info_UScriptStruct_ComboBoxStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FComboBoxStyle), 1705092930U) },
		{ FHyperlinkStyle::StaticStruct, Z_Construct_UScriptStruct_FHyperlinkStyle_Statics::NewStructOps, TEXT("HyperlinkStyle"), &Z_Registration_Info_UScriptStruct_HyperlinkStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHyperlinkStyle), 1713425236U) },
		{ FEditableTextStyle::StaticStruct, Z_Construct_UScriptStruct_FEditableTextStyle_Statics::NewStructOps, TEXT("EditableTextStyle"), &Z_Registration_Info_UScriptStruct_EditableTextStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEditableTextStyle), 526313441U) },
		{ FScrollBarStyle::StaticStruct, Z_Construct_UScriptStruct_FScrollBarStyle_Statics::NewStructOps, TEXT("ScrollBarStyle"), &Z_Registration_Info_UScriptStruct_ScrollBarStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FScrollBarStyle), 2070315211U) },
		{ FEditableTextBoxStyle::StaticStruct, Z_Construct_UScriptStruct_FEditableTextBoxStyle_Statics::NewStructOps, TEXT("EditableTextBoxStyle"), &Z_Registration_Info_UScriptStruct_EditableTextBoxStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEditableTextBoxStyle), 3517087384U) },
		{ FInlineEditableTextBlockStyle::StaticStruct, Z_Construct_UScriptStruct_FInlineEditableTextBlockStyle_Statics::NewStructOps, TEXT("InlineEditableTextBlockStyle"), &Z_Registration_Info_UScriptStruct_InlineEditableTextBlockStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInlineEditableTextBlockStyle), 2907099680U) },
		{ FProgressBarStyle::StaticStruct, Z_Construct_UScriptStruct_FProgressBarStyle_Statics::NewStructOps, TEXT("ProgressBarStyle"), &Z_Registration_Info_UScriptStruct_ProgressBarStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FProgressBarStyle), 750509808U) },
		{ FExpandableAreaStyle::StaticStruct, Z_Construct_UScriptStruct_FExpandableAreaStyle_Statics::NewStructOps, TEXT("ExpandableAreaStyle"), &Z_Registration_Info_UScriptStruct_ExpandableAreaStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FExpandableAreaStyle), 1929868421U) },
		{ FSearchBoxStyle::StaticStruct, Z_Construct_UScriptStruct_FSearchBoxStyle_Statics::NewStructOps, TEXT("SearchBoxStyle"), &Z_Registration_Info_UScriptStruct_SearchBoxStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSearchBoxStyle), 1114159889U) },
		{ FSliderStyle::StaticStruct, Z_Construct_UScriptStruct_FSliderStyle_Statics::NewStructOps, TEXT("SliderStyle"), &Z_Registration_Info_UScriptStruct_SliderStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSliderStyle), 2323187875U) },
		{ FVolumeControlStyle::StaticStruct, Z_Construct_UScriptStruct_FVolumeControlStyle_Statics::NewStructOps, TEXT("VolumeControlStyle"), &Z_Registration_Info_UScriptStruct_VolumeControlStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVolumeControlStyle), 1868128182U) },
		{ FInlineTextImageStyle::StaticStruct, Z_Construct_UScriptStruct_FInlineTextImageStyle_Statics::NewStructOps, TEXT("InlineTextImageStyle"), &Z_Registration_Info_UScriptStruct_InlineTextImageStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInlineTextImageStyle), 2560267583U) },
		{ FSpinBoxStyle::StaticStruct, Z_Construct_UScriptStruct_FSpinBoxStyle_Statics::NewStructOps, TEXT("SpinBoxStyle"), &Z_Registration_Info_UScriptStruct_SpinBoxStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSpinBoxStyle), 3114720558U) },
		{ FSplitterStyle::StaticStruct, Z_Construct_UScriptStruct_FSplitterStyle_Statics::NewStructOps, TEXT("SplitterStyle"), &Z_Registration_Info_UScriptStruct_SplitterStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSplitterStyle), 3289794801U) },
		{ FTableViewStyle::StaticStruct, Z_Construct_UScriptStruct_FTableViewStyle_Statics::NewStructOps, TEXT("TableViewStyle"), &Z_Registration_Info_UScriptStruct_TableViewStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTableViewStyle), 63770848U) },
		{ FTableRowStyle::StaticStruct, Z_Construct_UScriptStruct_FTableRowStyle_Statics::NewStructOps, TEXT("TableRowStyle"), &Z_Registration_Info_UScriptStruct_TableRowStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTableRowStyle), 2166995878U) },
		{ FTableColumnHeaderStyle::StaticStruct, Z_Construct_UScriptStruct_FTableColumnHeaderStyle_Statics::NewStructOps, TEXT("TableColumnHeaderStyle"), &Z_Registration_Info_UScriptStruct_TableColumnHeaderStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTableColumnHeaderStyle), 1215062294U) },
		{ FHeaderRowStyle::StaticStruct, Z_Construct_UScriptStruct_FHeaderRowStyle_Statics::NewStructOps, TEXT("HeaderRowStyle"), &Z_Registration_Info_UScriptStruct_HeaderRowStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHeaderRowStyle), 3836273356U) },
		{ FDockTabStyle::StaticStruct, Z_Construct_UScriptStruct_FDockTabStyle_Statics::NewStructOps, TEXT("DockTabStyle"), &Z_Registration_Info_UScriptStruct_DockTabStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDockTabStyle), 92959157U) },
		{ FScrollBoxStyle::StaticStruct, Z_Construct_UScriptStruct_FScrollBoxStyle_Statics::NewStructOps, TEXT("ScrollBoxStyle"), &Z_Registration_Info_UScriptStruct_ScrollBoxStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FScrollBoxStyle), 704043862U) },
		{ FScrollBorderStyle::StaticStruct, Z_Construct_UScriptStruct_FScrollBorderStyle_Statics::NewStructOps, TEXT("ScrollBorderStyle"), &Z_Registration_Info_UScriptStruct_ScrollBorderStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FScrollBorderStyle), 920769353U) },
		{ FWindowStyle::StaticStruct, Z_Construct_UScriptStruct_FWindowStyle_Statics::NewStructOps, TEXT("WindowStyle"), &Z_Registration_Info_UScriptStruct_WindowStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWindowStyle), 2788194744U) },
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Styling_SlateTypes_h_2373313901(TEXT("/Script/SlateCore"),
