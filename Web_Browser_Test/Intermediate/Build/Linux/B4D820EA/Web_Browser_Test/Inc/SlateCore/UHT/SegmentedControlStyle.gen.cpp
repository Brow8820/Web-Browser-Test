...
template<> SLATECORE_API UScriptStruct* StaticStruct<FSegmentedControlStyle>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Styling_SegmentedControlStyle_h_Statics::ScriptStructInfo[] = {
		{ FSegmentedControlStyle::StaticStruct, Z_Construct_UScriptStruct_FSegmentedControlStyle_Statics::NewStructOps, TEXT("SegmentedControlStyle"), &Z_Registration_Info_UScriptStruct_SegmentedControlStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSegmentedControlStyle), 1317131895U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Styling_SegmentedControlStyle_h_3530717237(TEXT("/Script/SlateCore"),
		nullptr, 0,
