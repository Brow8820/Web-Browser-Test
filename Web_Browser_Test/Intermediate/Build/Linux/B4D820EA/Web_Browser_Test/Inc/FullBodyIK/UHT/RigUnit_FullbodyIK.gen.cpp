...
class UScriptStruct* FRigUnit_FullbodyIK::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_RigUnit_FullbodyIK.OuterSingleton)
	{
		...
		Arguments_FRigUnit_FullbodyIK_Execute.Emplace(TEXT("ExecuteContext"), TEXT("FControlRigExecuteContext"));
		Arguments_FRigUnit_FullbodyIK_Execute.Emplace(TEXT("Context"), TEXT("const FRigUnitContext &"));
