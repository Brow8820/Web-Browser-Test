//
// /home/apex/Documents/Unreal Projects/Web_Browser_Test/Intermediate/Build/Linux/B4D820EA/Web_Browser_Test/Development/Chaos/XPBDBendingConstraints.ispc.generated.dummy_avx512skx.h
...
extern "C" {
#endif // __cplusplus
    extern void ApplyXPBDBendingConstraints(struct FVector4f * PandInvM, const struct FIntVector4 * Constraints, const float * RestAngles, const bool * IsBuckled, float * Lambdas, const float Dt, const float MinStiffness, const float Stiffness, const float BucklingStiffness, const int32_t NumConstraints);
    extern void ApplyXPBDBendingConstraintsWithMaps(struct FVector4f * PandInvM, const struct FIntVector4 * Constraints, const float * RestAngles, const bool * IsBuckled, float * Lambdas, const float Dt, const float MinStiffness, const bool StiffnessHasMap, const uint8_t * StiffnessIndices, const float * StiffnessTable, const bool BucklingStiffnessHasMap, const uint8_t * BucklingStiffnessIndices, const float * BucklingStiffnessTable, const int32_t NumConstraints);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
