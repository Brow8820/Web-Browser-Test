#undef LINUXDEVICEPROFILESELECTOR_API
...
#define UE_MODULE_NAME "LinuxDeviceProfileSelector"
#define UE_PLUGIN_NAME "LinuxDeviceProfileSelector"
...
#define LINUXDEVICEPROFILESELECTOR_API 
